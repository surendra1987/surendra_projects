...
export default {
  ...
  computed: {
    goalData() {
      ...
      return {
        name: this.presetData.name,
        target_value: this.presetData.target_value ?? 100,
      };
    },
    ...
    rawGoalData() {
      ...
      return {
        description: this.presetData.description,
        start_date: { iso: this.presetData.start_date },
        target_date: { iso: this.presetData.target_date },
      };
    },
  },
