...
<template>
  <div class="tui-competencySelfAssignment">
    ...
    <Grid :stack-at="900" gutter-size="var(--gap-page-columns)">
      <GridItem v-if="!isViewingSelections" :units="3">
        ...
        >
          ...
          <SelectFilter
            v-model:value="filters.assignment_status"
