  ...
  <div>
    ...
    <SamplesCtl>
      ...
      <FormRow label="Chart header">
        <InputText v-model:value="props.header" />
      </FormRow>
      <FormRow label="Doughnut label">
        <InputText v-model:value="props.label" />
      </FormRow>
      <FormRow label="Doughnut percentage">
        <InputText v-model:value="props.percentage" type="number" />
      </FormRow>
      <FormRow label="Show percentage">
        <Checkbox v-model:checked="props.showPercentage" />
      </FormRow>
      <FormRow label="Doughnut color">
        <InputText v-model:value="props.color" />
      </FormRow>
      <FormRow label="Doughnut label color">
        <InputText v-model:value="props.labelColor" />
      </FormRow>
      <FormRow label="Doughnut label font size">
        <InputText v-model:value="props.labelFontSize" type="number" />
      </FormRow>
      <FormRow label="Doughnut percentage font size">
        <InputText v-model:value="props.percentageFontSize" type="number" />
      </FormRow>
      <FormRow label="Doughnut background color">
        <InputText v-model:value="props.backgroundColor" />
      </FormRow>
      <FormRow label="Doughnut cutout">
        <InputText v-model:value="props.cutout" type="number" />
      </FormRow>
      <FormRow label="Square doughnut (cuts empty space around the doughnut)">
        <Checkbox v-model:checked="props.square" />
      </FormRow>
      <FormRow>
