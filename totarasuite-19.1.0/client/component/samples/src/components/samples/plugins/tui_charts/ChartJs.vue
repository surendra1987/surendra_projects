  ...
  <div>
    ...
    <SamplesCtl>
      ...
      <FormRow label="Chart type">
        <InputText v-model:value="props.type" />
      </FormRow>
      <FormRow label="Chart header">
        <InputText v-model:value="props.header" />
      </FormRow>
      <FormRow label="Chart data object">
        <Textarea v-model:value="props.data" :cols="120" :rows="20" />
      </FormRow>
      <FormRow label="Chart options object">
        <Textarea v-model:value="props.options" :cols="120" :rows="15" />
      </FormRow>
      <FormRow label="Chart options object">
        <Textarea
          v-model:value="props.canvasAttributes"
          :cols="120"
          :rows="10"
        />
      </FormRow>
