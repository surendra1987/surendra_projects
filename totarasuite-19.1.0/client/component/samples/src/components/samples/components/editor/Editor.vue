...
<template>
  ...
  <div v-if="draftId" class="tui-sampleEditor">
    <SamplesExample>
      ...
      <pre class="tui-sampleEditor__source" v-text="source" />
    </SamplesExample>
    <SamplesCtl>
      <Uniform :initial-values="values" @change="v => (values = v)">
        ...
        <FormRow
          ...
          label="v-model:value"
          required
          helpmsg="String. The two-way binding value of the editor."
        >
          <pre class="tui-sampleEditor__field-value">{{ content }}</pre>
        ...
        <FormRow label="Default format">
          ...
          <FormRowDetails
            ><code>defaultFormat: Format</code> *Format is imported from
            tui/editor</FormRowDetails
          >
          <FormRowDetails>
          ...
          <FormRowDetails>
            ...
            to make this take effect, as editing produces an EditorContent with
            a set format.
          </FormRowDetails>
        </FormRow>
        <FormRow label="Variant">
          ...
          <FormRowDetails
            ><code
              >variant: 'full'|'standard'|'basic'|'simple'|Array</code
            ></FormRowDetails
          >
          <FormRowDefaults>standard</FormRowDefaults>
        </FormRow>
        <FormRow label="Disabled">
          <FormToggleSwitch name="disabled" text="Disabled" toggle-first />
          <FormRowDetails><code>disabled: boolean</code></FormRowDetails>
        </FormRow>
        <FormRow label="Compact">
          <FormToggleSwitch name="compact" text="Compact" toggle-first />
          <FormRowDetails><code>compact: boolean</code></FormRowDetails>
        </FormRow>
        <FormRow label="Sticky toolbar">
          <FormToggleSwitch
            ...
            toggle-first
          />
          <FormRowDetails><code>stickyToolbar: boolean</code></FormRowDetails>
        </FormRow>
        <FormRow label="Loading">
          <FormToggleSwitch name="loading" text="Loading" toggle-first />
          <FormRowDetails><code>loading: boolean</code></FormRowDetails>
        </FormRow>
        <FormRow label="Context ID">
          <FormSelect name="contextId" :options="contextIdOptions" />
          <FormRowDetails><code>contextId: number</code></FormRowDetails>
        </FormRow>
        <FormRow label="Usage Identifier">
          <FormSelect name="identifier" :options="identifierOptions" />
          <FormRowDetails><code>usageIdentifier: Object</code></FormRowDetails>
          <FormRowDetails>
            The entry that is being edited. Passed to extensions so that they
            can alter their configuration based off what they are editing, e.g.
            only allowing mentions of users that can view the identifier.
          </FormRowDetails>
          <FormRowDetails>
            This does not need to be unique per editor, you can have multiple
            editors with the exact same identifier prop editing different
            fields.
          </FormRowDetails>
        </FormRow>
    ...
    <SamplesCtl label="Emit options">
      <FormRow label="input">
        Triggered when the input changed on an editor.
        <FormRowDetails>
...
export default {
  ...
  data() {
    return {
      ...
      variantOptions: ['full', 'standard', 'basic', 'simple'],
      contextIdOptions: [
        { id: null, label: 'None' },
