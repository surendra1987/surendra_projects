...
<template>
  <div class="tui-grid-example">
    ...
    <SamplesCtl>
      <FormRow v-slot="{ id }" label="Max GridItem units before wrapping">
      ...
      <FormRow v-slot="{ id }" label="Use a horizontal gap">
      ...
      <FormRow v-slot="{ id }" label="Use a vertical gap">
      ...
      <FormRow v-slot="{ id }" label="Become stacked at width (px)">
      ...
      <FormRow v-slot="{ id }" label="Gutter between horizontal GridItems">
        <Range v-model:value="gutterSizeHorizontal" :min="5" :max="50" />
        <FormRowDetails :id="id">
          gutterSizeHorizontal
        </FormRowDetails>
      </FormRow>
      <FormRow v-slot="{ id }" label="Gutter between vertical GridItems">
