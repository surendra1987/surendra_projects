...
<template>
  <div>
    <SamplesExample>
      <Basket :items="items" :bulk-actions="bulkActions" :wide-gap="wideGap">
    ...
    <SamplesCtl>
      <FormRow v-slot="{ id }" label="Items" required>
        <RadioGroup v-model:value="selectedItems" :horizontal="true">
      ...
      <FormRow v-slot="{ id }" label="Bulk actions">
        <RadioGroup v-model:value="bulkActions" :horizontal="true">
      ...
      <FormRow v-slot="{ id }" label="Wide gap">
        <RadioGroup v-model:value="wideGap" :horizontal="true">
