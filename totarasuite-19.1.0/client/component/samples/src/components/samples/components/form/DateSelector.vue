...
<template>
  <div>
    ...
    <SamplesCtl>
      ...
      <hr />
      <FormRow v-slot="{ id }" label="Has timezone">
      ...
      <hr />
      <FormRow v-slot="{ id }" label="Set to custom date">
      ...
      <FormRow
        v-slot="{ id }"
        label="Set to current date (Overwritten by Custom date)"
      >
      ...
      <hr />
      <FormRow v-slot="{ id }" label="Response type">
