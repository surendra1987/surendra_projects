...
<template>
  <div class="tui-radioWithInput">
    ...
    <slot
      :disabled-radio="disabled || !checked"
      :label-partials="labelPartials"
      :name-label="name"
      :set-accessible-label="setAccessibleLabel"
      :update="update"
      :value="controlValue"
    />
  </div>
...
export default {
  ...
  emits: ['select', 'input', 'update:controlValue'],
  ...
  methods: {
     ...
     */
    update(value) {
      this.$emit('update:controlValue', value);
