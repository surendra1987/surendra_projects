...
export default {
  ...
  emits: ['scrolltop', 'scrollbottom', 'scroll'],
  ...
  mounted() {
    ...
    this.virtualUtil.setDocumentPosition(this.rootElPosition);
  ...
  beforeUnmount() {
    ...
    // It appears that this._resizeObserver isn't always initialised
  ...
  methods: {
    ...
    onItemResized(id, offsetHeight) {
      this.virtualUtil.saveSize(id, offsetHeight);
    },
  ...
  render() {
    ...
    return h(
      'div',
      {
        ...
        role: this.useRole ? 'feed' : null,
        'aria-label': this.ariaLabel,
        'aria-busy': this.isLoading ? 'true' : null,
        onScrollPassive: !this.pageMode && this.onScroll,
        onKeydown: this.onKeyDown,
      },
      [
        this.pageMode
          ? this.getRenderingItems()
          : h(
              'div',
              {
                ref: 'itemsWrapper',
        ...
        this.$slots.footer
          ? h(VirtualItemMeasurer, { onResize: this.onFooterResized }, () =>
              this.$slots.footer()
            )
          : null,
