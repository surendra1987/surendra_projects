...
<template>
  <div class="tui-engagelayoutOneColumnContentWithSidepanel">
    <Responsive
      :breakpoints="[
    ...
    >
      <Grid
        ...
        class="tui-engagelayoutOneColumnContentWithSidepanel__grid"
      >
        <GridItem v-if="gridUnitsLeft > 0" :units="gridUnitsLeft">
          <ResourceNavigationBar
            ...
            class="tui-engagelayoutOneColumnContentWithSidepanel__toolbar tui-engagelayoutOneColumnContentWithSidepanel__toolbar--content"
        ...
        <GridItem :units="gridUnitsRight">
          <div
            class="tui-engagelayoutOneColumnContentWithSidepanel__sidebar"
            :class="{
              'tui-engagelayoutOneColumnContentWithSidepanel__sidebar--expanded':
                gridUnitsRight == 12,
            }"
          >
            <ResourceNavigationBar
          ...
          <SidePanel
            :id="sidePanelId"
            ref="sidepanel"
            class="tui-engagelayoutOneColumnContentWithSidepanel__sidePanel"
            :class="{
              'tui-engagelayoutOneColumnContentWithSidepanel__sidePanel--wide':
                gridUnitsRight == 12,
            }"
            direction="rtl"
