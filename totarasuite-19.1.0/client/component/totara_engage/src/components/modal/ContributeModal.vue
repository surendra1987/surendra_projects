    ...
    >
      ...
      >
        ...
        <div class="tui-engageContributeModal__content">
          ...
          <div
            v-if="!$apollo.loading && displayTab"
          ...
          >
            ...
            <component
              ...
              :id="$id(`${selectedTab}-tabpanel`)"
              :aria-labelledby="displayTab ? $id(selectedTab) : undefined"
              :container="container"
              :show-notification="showNotification"
              :can-share="getCanShare(selectedTab)"
              :role="displayTab ? 'tabpanel' : undefined"
...
export default {
  ...
  computed: {
    tabs() {
      return this.modals.map(({ id, label }) => ({
        id,
        name: label,
        htmlId: this.$id(id),
      }));
    ...
    displayTab() {
      return !this.hideTabs && this.showTab && this.modals.length > 0;
    },
  },
