...
echo $OUTPUT->heading('Standard moodle tables (class "generaltable")', 2);

echo $OUTPUT->heading('Simplest way to make a table', 3);
...
echo $OUTPUT->heading('Column headings spanning multiple columns', 3);
...
echo $OUTPUT->heading('With fine-grained control over cells', 3);
...
echo $OUTPUT->heading('Applying classes and ids to every element in a table', 3);
...
echo $OUTPUT->heading('Applying more specific ids/classes to any element', 3);
...
echo $OUTPUT->heading('Example of a table with headings in row instead of column', 3);
...
echo $OUTPUT->heading('Turning off the default "generaltable" classes is not very easy, you have to override the class attribute on the table element. Note that setting any class, will by default remove the generaltable class', 3);
...
echo $OUTPUT->heading('If you need a plain table, you can either build it yourself using html_writer:', 3);
...
echo $OUTPUT->heading('Or use the "invisible" or "invisiblepadded" classes which override all table border styles', 3);
...
echo $OUTPUT->heading('A "flexible table" moodle table (class "flexible"). Useful if you want pagination, sorting etc.', 2);
...
echo $OUTPUT->heading('By default tables are as small as possible given the content. Use the fullwidth class if you want the table to span all available horizontal space', 3);
...
echo $OUTPUT->heading('By default tables are left aligned. Use the boxaligncenter class if you want the table to be centred instead', 3);
...
echo $OUTPUT->heading('You can specify \'divider\' to get a dividing line that spans all columns. This also splits the table to create an extra tbody tag.', 3);
