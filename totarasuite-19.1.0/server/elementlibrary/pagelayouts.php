...
$layouts = array(
    ...
    'dashboard' => array(
        'name' => 'Dashboard',
        'description' => 'This layout is used on Totara dashboard pages. It is unusual in that it has an extra "main" block region for putting blocks.',
    ),
    'mypublic' => array(
        'name' => 'My public',
    ...
    'legacynolayout' => array(
        ...
        'description' => 'Layout with no page padding. Avoid using this unless it is neccesary.',
    ),
    'external' => array(
        'name' => 'External',
        'description' => 'The layout for users who are external',
    ),
);
...
if ($layout) {
    // display each layout
    echo $OUTPUT->container(html_writer::tag('p', $layouts[$layout]['description']));
    ...
    echo $OUTPUT->heading('Developer info', 2);
