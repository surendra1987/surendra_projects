...
class totara_hierarchy_lib_test extends \core_phpunit\testcase {
    ...
    private $type_field_data2, $type_data_data2;
    ...
    protected function tearDown(): void {
        ...
        $this->type_field_data2 = null;
        $this->type_data_data = null;
        $this->type_data_data2 = null;
    ...
    public function test_individual_competency_warnings(): void {
        ...
        $all_fields = 'hier.id,hier.shortname,hier.description,hier.idnumber,hier.frameworkid,hier.path,hier.parentid,hier.visible,hier.timecreated,hier.timemodified,hier.usermodified,hier.fullname,hier.depthlevel,hier.typeid,hier.sortthread,hier.aggregationmethod,hier.proficiencyexpected,hier.evidencecount,hier.copy_op_id';
        $this->assertNotEquals($all_fields, $fields);
        ...
        advanced_feature::disable('competency_assignment');
        $fields = $this->competency->get_item_select_fields();
        $this->assertEquals($all_fields, $fields);
    ...
    public function test_hierarchy_delete_hierarchy_item(): void {
        ...
        $this->assertContains(
            pre_delete_item_check::class,
            $hooks_triggered,
            "delete_hierarchy_item method needs to trigger the pre_delete_item_check hook"
        );
    ...
    public function test_hierarchy_delete_framework(): void {
        ...
        $this->assertContains(
            pre_delete_framework_check::class,
            $hooks_triggered,
            "delete_framework method needs to trigger the pre_delete_framework_check hook"
        );
