...
/**
 * Tests the totara hierarchy organisation_framework type resolver
 */
class totara_hierarchy_webapi_resolver_type_organisation_type_test extends \core_phpunit\testcase {

    use webapi_phpunit_helper;

    private function resolve($field, $pos, array $args = []) {
        return $this->resolve_graphql_type('totara_hierarchy_organisation_type', $field, (object) $pos, $args);
    }
