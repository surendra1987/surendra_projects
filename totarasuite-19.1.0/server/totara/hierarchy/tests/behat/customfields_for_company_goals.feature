@totara @totara_hierarchy @javascript @totara_customfield @totara_hierarchy_goals
Feature: Test I can manage custom fields for company goal types
  ...
  Scenario: Test I can create and sort company goal type custom fields
    ...
    And I should see "Create a new \"Text input\" custom field"
    And I set the following fields to these values:
      | Full name                   | Development team |
      | Short name (must be unique) | Devteam          |
    And I press "Save changes"
    ...
    And I set the following fields to these values:
      ...
      | Short name (must be unique) | Devlead               |
    And I press "Save changes"
    Then I should see "Development team"
    ...
    And I set the following fields to these values:
      ...
      | Short name (must be unique) | Managerslead         |
    And I press "Save changes"
    Then I should see "Management team"
