@totara @totara_hierarchy @totara_hierarchy_goals @_file_upload @totara_customfield
Feature: Test use of images in goals and goal custom fields
  ...
  Scenario: Images in goal and custom goal fields and descriptions
    ...
    When I navigate to "Manage company goal types" node in "Site administration > Legacy goals"
    ...
    When I navigate to "Manage personal goal types" node in "Site administration > Legacy goals"
    ...
    When I navigate to "Manage legacy goals" node in "Site administration > Legacy goals"
