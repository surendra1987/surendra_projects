...
// Set up the heading.
$heading = settings_helper::is_perform_goals_transition_mode_enabled()
    ? get_string('legacy_personal_goal', 'totara_hierarchy')
    : get_string('personalgoal', 'totara_hierarchy');
echo $OUTPUT->page_main_heading($heading . $edit_button);
