...
// Update data
    ...
    if (is_null($valuenew->numericscore) || !strlen($valuenew->numericscore)) {
...
if ($id == 0) {
    echo $OUTPUT->page_main_heading(get_string('addnewscalevalue', 'totara_hierarchy'));
} else {
    echo $OUTPUT->page_main_heading(get_string('editscalevalue', 'totara_hierarchy'));
}
