...
class hierarchy_organisation_webapi_resolver_frameworks_test extends \core_phpunit\testcase {
     ...
     * @return void
     */
    public function test_capability_by_tenant_domain_manager(): void {
