...
class hierarchy_organisation_webapi_resolver_types_test extends \core_phpunit\testcase {
    ...
    public function test_types() {
        ...
        // Test via graphql.
        $result = $this->resolve_graphql_query('totara_hierarchy_organisation_types');
        $this->assertIsArray($result);
        $this->assertEquals(10, sizeof($result));
    }
