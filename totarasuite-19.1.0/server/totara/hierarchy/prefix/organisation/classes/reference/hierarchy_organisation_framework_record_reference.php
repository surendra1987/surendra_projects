...
/**
 * Organisation Framework record reference. Used to find one record by provided parameters
 */
class hierarchy_organisation_framework_record_reference extends base_record_reference {
    /**
     * @inheritDoc
     */
    ...
    protected function get_table_name(): string {
        return organisation_framework::TABLE;
    }
