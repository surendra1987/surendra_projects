...
$checkreportaccess = optional_param('checkaccess', true, PARAM_BOOL);
...
$dialog = new totara_dialog_content_hierarchy_multi('organisation', $frameworkid, false, false, $reportid, $checkreportaccess);
