...
/**
 * Populates a GraphQL totara_hierarchy_personal_goal type.
 */
class personal_goal extends type_resolver {
    /**
     * Default formats.
     */
    ...
    public static function resolve(string $field, $source, array $args, execution_context $ec) {
        if (!$source instanceof personal_goal_entity) {
            throw new coding_exception(__METHOD__ . ' requires a personal_goal entity');
        }
        ...
        $formatter = new personal_goal_formatter($source, $context);
