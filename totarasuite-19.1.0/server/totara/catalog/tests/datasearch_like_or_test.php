 ...
 */
class totara_catalog_datasearch_like_or_test extends \core_phpunit\testcase {

    public static function validate_current_data_data_provider() {
        return [
            [null, false],
            [[], false],
            [[123], false],
    ...
    public static function make_compare_data_provider() {
        return [
            [null, false],
            [[], false],
            [[123], true],
