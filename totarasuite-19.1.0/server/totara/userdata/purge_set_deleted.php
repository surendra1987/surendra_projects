...
if (!$loadconfirmform) {
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading(get_string('purgesetautomatic', 'totara_userdata'));
    echo $form->render();
    echo $OUTPUT->footer();
    die;
}
...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading(get_string('setpurgetypeconfirm', 'totara_userdata'));
