...
/**
 * Tests the suspended purge task class.
 */
class totara_userdata_task_purge_suspended_test extends \core_phpunit\testcase {
    public function test_adhoc() {
        ...
        $extra->suspendedpurgetypeid = $type->id;
        ...
        $task = new totara_userdata\task\purge_suspended();
        ...
        $extra = util::get_user_extras($user->id);
        $this->assertTimeCurrent($extra->timesuspendedpurged);
    }
}