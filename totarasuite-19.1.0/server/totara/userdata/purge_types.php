...
if (has_capability('totara/userdata:config', context_system::instance())) {
    $addurl = new moodle_url('/totara/userdata/purge_type_add.php');
    $buttons[] = $OUTPUT->single_button($addurl, get_string('purgetypeadd', 'totara_userdata'), 'post');
}
...
echo $debughtml;
echo $output->page_main_heading(get_string('sourcetitle', 'rb_source_userdata_purge_types'));
