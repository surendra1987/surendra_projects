...
if ($context->contextlevel == CONTEXT_SYSTEM) {
    ...
    admin_externalpage_setup($adminpage, '', ['id' => $id], '/totara/reportbuilder/clone.php');
} else {
    require_capability('totara/reportbuilder:managereports', $context);
    $PAGE->set_url('/totara/reportbuilder/clone.php');
...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading(get_string('clonereport', 'totara_reportbuilder'));
