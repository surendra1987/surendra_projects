...
if ($context->contextlevel == CONTEXT_SYSTEM) {
    admin_externalpage_setup('rbmanagereports', '', ['id' => $id], '/totara/reportbuilder/access.php');
} else {
    require_capability('totara/reportbuilder:managereports', $context);
    $PAGE->set_url('/totara/reportbuilder/access.php');
...
function reportbuilder_update_access($reportid, $fromform) {
    ...
    $plugins = reportbuilder::get_enabled_access_plugins($reportid);
