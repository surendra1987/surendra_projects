 ...
 */
class totara_reportbuilder_rb_source_course_completion_test extends \core_phpunit\testcase {
    ...
    public function test_report() {
        ...
        $this->assertArrayHasKey('course_completion_status', $record);
        $this->assertSame('3', $record['user_institution']);
        $this->assertArrayHasKey('visibility_id', $record);
        $this->assertArrayHasKey('visibility_visible', $record);
        $this->assertArrayHasKey('visibility_audiencevisible', $record);
        $this->assertArrayHasKey('ctx_id', $record);
