...
$context = empty($rawreport->tenantid)
    ? context_system::instance()
    : \core\record\tenant::fetch($rawreport->tenantid)->category_context;
...
if ($fromform = $mform->get_data()) {
    ...
    $mrcapability = has_capability('totara/reportbuilder:managereports', $report->get_context());
...
echo $OUTPUT->header();
if ($data->sid) {
    echo $OUTPUT->page_main_heading(get_string('editingsavedsearch', 'totara_reportbuilder'));
} else {
    echo $OUTPUT->page_main_heading(get_string('createasavedsearch', 'totara_reportbuilder'));
}
