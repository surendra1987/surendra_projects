...
$string['accessbytenant'] = 'Access restricted by tenant';
...
$string['all_site_reports'] = 'All site reports';
$string['alldata'] = 'All data';
$string['allembeddedreports'] = 'Manage embedded reports';
...
$string['alluserreports'] = 'Manage user reports';
$string['and'] = ' and ';
...
$string['availability_help'] = 'Sharing this saved search will make it available as a saved search viewing option to everyone who has access to the report. Only you can edit or remove it.';
$string['availablesearcheslabel'] = 'Available searches';
$string['back_to_manage_embedded_reports'] = '« Back to manage embedded reports';
...
$string['cache_not_available'] = 'Report caching is not available due the following reason(s):';
...
$string['caching_reports_with_aggregation'] = 'Column aggregation will not work properly when caching is enabled';
$string['caching_reports_with_create_table_from_select'] = 'Database does not support create table from select';
$string['caching_reports_with_multitenancy'] = 'Multitenancy is enabled';
$string['cannotviewembedded'] = 'Embedded reports can only be accessed through their embedded url';
$string['category'] = 'Category';
$string['certification_visibility'] = 'Enforce sitewide visibility restrictions';
$string['certification_visibility_checkbox'] = 'Show records based on audience and certification visibility restrictions';
$string['certification_visibility_help'] = 'When enabled, sitewide visibility restrictions, like audience-based visibility and certification visibility, will be used to filter this report in context of the user currently viewing it.';
...
$string['choosetenants'] = 'Choose Tenants';
$string['clearform'] = 'Clear';
$string['clone'] = 'Clone';
$string['clone_embedded_not_allowed'] = 'The "{$a}" embedded report can\'t be cloned.';
...
$string['clonereportaccesswarning'] = 'Report content and access controls may change when copying an embedded report as content or access controls that are applied by the embedded page will be lost.';
...
$string['column_advancedheading'] = 'Column {$a} Aggregation or grouping';
$string['column_customheading'] = 'Custom heading for Column {$a}';
$string['column_customiseheading'] = 'Customise heading for Column {$a}';
$string['column_deleted'] = 'Column deleted';
$string['column_index'] = 'Column {$a}';
$string['column_moved'] = 'Column moved';
$string['column_rowheader'] = 'Row header';
...
$string['compress_file'] = 'Compress file';
$string['compress_file_help'] = 'Files over {$a}MB cannot be sent. Compressing will reduce file size to help meet the limit.';
...
$string['count_columns_used_summary'] = 'A list of columns used in reports on the site, and for each a count of the number of times that they have been used.';
$string['count_filters_used_summary'] = 'A list of filters used in reports on the site, and for each a count of the number of times that they have been used.';
$string['count_reports_by_source_summary'] ='A list of report sources used on this site, and for each a count of reports using that source.';
$string['course_completion'] = 'Course Completion';
$string['course_enddate'] = 'Course End date';
$string['course_visibility'] = 'Enforce sitewide visibility restrictions';
$string['course_visibility_checkbox'] = 'Show records based on audience, course and workspace visibility restrictions';
$string['course_visibility_help'] = 'When enabled, sitewide visibility restrictions, like audience-based visibility and course visibility, will be used to filter this report in context of the user currently viewing it.';
...
$string['courseexcludefromcatalogue'] = "Exclude from catalogue";
...
$string['defaultgraphcolors'] = 'Default graph colours';
$string['defaultgraphcolorsdescription'] = 'The default colour scheme for all graphs in a comma separated list of valid CSS colours (This can be a HEX value or one of the 145 named colours). This can be overridden at report level using the \'Custom settings\' setting when defining the graph.';
$string['defaultreportviewgrid'] = 'Tiles';
$string['defaultreportviewlist'] = 'List';
$string['defaultreportviewsetting'] = 'Reports default view';
$string['defaultreportviewsetting_desc'] = 'The default format for lists of reports to be displayed in';
$string['defaultsortcolumn'] = 'Default column';
$string['defaultsortorder'] = 'Default order';
$string['defaultview'] = 'Default view';
$string['defaultview_help'] = 'This saved search will be the default view when anyone accesses the report. Individual viewers are able to remove the default setting or override with a default view of their choice.';
...
$string['disable_hardcoded_visibility_warning'] = 'This report has visibility restrictions enforced. To report on all records, disable the enforced visibility check on the general tab.';
$string['disabled'] = 'Disabled?';
$string['disablehardcodedvisibility'] = 'Disable enforced visibility checks';
$string['disablehardcodedvisibility_help'] = 'To protect the privacy of the report, this report applies standard visibility checks that cannot be disabled by default, and content restrictions may not be possible. By enabling this setting, these standard checks are disabled, and the content of the report is entirely controlled by content restrictions. Caching is not possible for reports with content restrictions enabled.';
...
$string['emptyscheduledreportfullmenssage'] = 'The scheduled report "{$a}" was due to be sent but has not been generated as it contained no data';
$string['emptyscheduledreportsubject'] = 'Scheduled report "{$a}" does not contain data';
...
$string['enableuser_reports'] = 'Enable creation of reports';
$string['enableuser_reports_desc'] = 'When enabled, users with the appropriate capability will be able to create reports.';
$string['enrol'] = 'Enrol';
...
$string['error:missingfilteringmissing'] = 'Following filters are required to be applied in order to run this report: {$a}';
...
$string['event_scheduled_report_task_failed'] = 'Scheduled report task failed';
...
$string['execution_lock_warning'] = "You're currently running a report. Please wait until it has finished before running another one.";
...
$string['filesizelimit'] = 'Maximum scheduled report file size (MB)';
$string['filesizelimitdescription'] = 'This setting allows administrators to adjust the maximum scheduled report file size for email attachments, in megabytes. Changing this limit is recommended only if you know or have control over the file size restrictions of the receiving mail server. If an attachment exceeds the set limit, the system will prevent sending and notify the report owner.';
...
$string['filter_reports'] = 'Filter reports';
...
$string['filtering_advanced'] = 'Mark search field {$a} as advanced';
$string['filtering_customise_field'] = 'Customise field {$a} Name';
$string['filtering_customise_name'] = 'Customise name for {$a}';
$string['filtering_search_field'] = 'Search field {$a}';
$string['filteringrequired'] = 'Filtering required';
$string['filteringrequired_field'] = 'Filtering required for field {$a}';
$string['filteringrequired_missing'] = 'Please apply all required filters to view this report';
...
$string['globalsettingaudiencedescription'] = "The audience selected above will appear as the default audience-based content restriction settings for all new user reports. It can be overridden on individual reports by report creators. Please be aware this does not apply to tenant reports.";
$string['globalsettingaudiencename'] = "Set a default audience-based content restriction for all new system user reports";
...
$string['graphcustomsettings'] = 'Custom settings';
$string['graphcustomsettings_help'] = 'Advanced Graph settings in the JSON file format. See <a href="https://help.totaralearning.com/display/DEV/Advanced+settings" target="_blank">our help document</a> for more information.';
$string['graphlegend'] = 'Legend';
$string['graphlibchartjs'] = 'ChartJS';
$string['graphlibsetting'] = 'Graph Library';
$string['graphlibsetting_desc'] = 'Change the graphing library Totara uses to render graphs for reports and report blocks.';
$string['graphlibsvggraph'] = 'SVGGraph';
$string['graphmaxrecords'] = 'Maximum number of used records';
$string['graphnocategory'] = 'Numbered';
$string['graphnorecordsinreport'] = 'Graph cannot be displayed – there are no records in this report';
...
$string['graphtypedonut'] = 'Donut';
$string['graphtypeline'] = 'Line';
$string['graphtypepie'] = 'Pie';
$string['graphtypeprogressdonut'] = 'Progress Donut';
...
$string['manageuserreportheading'] = 'Manage users: {$a}';
$string['manageuserreports'] = 'Manage user reports';
$string['manageuserreportsin'] = '{$a}: Manage user reports';
$string['manageusers'] = 'Manage users';
$string['manageyoursavedsearches'] = 'Manage your saved searches';
...
$string['new_tenant_report'] = 'New tenant report';
...
$string['no_tenant_restriction'] = 'All tenant users can view this report';
...
$string['program_visibility'] = 'Enforce sitewide visibility restrictions';
$string['program_visibility_checkbox'] = 'Show records based on audience and program visibility restrictions';
$string['program_visibility_help'] = 'When enabled, sitewide visibility restrictions, like audience-based visibility and program visibility, will be used to filter this report in context of the user currently viewing it.';
...
$string['reportbuilderhidden'] = 'Hide on user reports list';
$string['reportbuilderhidden_help'] = 'When checked, this report will not appear in the reports list for logged in users. Note that it can still appear in blocks and dashboards. Users with the correct access permissions can see it via the URL address.';
...
$string['reportbuildertenantfilter'] = 'Tenant concatenated filter';
$string['reportbuildertenantfilter_help'] = 'This filter allows you to filter information based on created tenants. The filter has the following options:

*   **is any value**: This option disables the filter (i.e. all information will be accepted by this filter).
*   **Any of the selected**: This option will show tenant members who belong in any of the selected tenants.
*   **None of the selected**: This option will show tenant members who are not in any of the selected tenants.';
...
$string['reportcachingincompatiblecontentrestrictions'] = 'Content restrictions are enabled';
...
$string['reportsourcepill'] = 'Report source';
$string['reportsources'] = 'Report sources';
$string['reportsummary'] = 'Abstract';
$string['reportsummary_help'] = 'This short introduction is shown with the report title in the user reports list. Recommended length is less than 250 characters.';
...
$string['saved_search_not_found'] = 'The saved search is no longer publicly accessible or has been deleted. Choose a different saved search';
...
$string['scheduled_report_not_sent_message'] = 'Your requested report \'{$a->reportname}\' failed to send as the attached file exceeds the maximum email attachment limit of {$a->limit}MB.

You can resolve this issue using one of the following options:

    * Compress the file: Try reducing the file size by adjusting report settings or choosing the option to compress the file when scheduling the report.
    * Refine report filters: If applicable, refine the report parameters to generate a smaller dataset.
    * Save instead of emailing: Use the “Save scheduled report to file system only” option to store the file in your account and access it later.

If you need further assistance, please contact your site administrator.';
$string['scheduled_report_not_sent_subject'] = 'Your report could not be sent';
...
$string['searchbyrequired'] = 'Required search';
...
$string['setasyourdefaultview'] = 'Set as your default view';
...
$string['showdescription'] = 'Show report abstract';
$string['showdescription_desc'] = 'Show report abstract in the report list view';
...
$string['site_report'] = 'Site report';
...
$string['tenant_report'] = 'Tenant report';
...
$string['type_facetoface_facilitator'] = 'Facilitator Custom Fields';
...
$string['user_visibility'] = 'Enforce user visibility restrictions';
$string['user_visibility_checkbox'] = 'Show records based on user visibility rules';
$string['user_visibility_help'] = 'When enabled, user visibility (ie "deleted" status) and tenant user visibility will be used to filter this report in context of the user currently viewing it.';
...
$string['userlinkcheck'] = 'Check Visibility Of User Profile Links';
$string['userlinkcheck_heading'] = 'Columns Performance Settings';
$string['userlinkcheck_help'] = 'Check the user’s profile is visible to the viewer before linking to it. Disabling this check improves performance.';
...
$string['value'] = 'Value';
$string['view'] = 'view';
$string['view_toggle_label'] = 'View';
$string['viewallcolumns'] = 'view all available columns';
...
$string['with_tenant_restriction'] = 'Only certain tenant users can view this report';
...
$string['xrecord_title'] = 'Results - {$a} record';
$string['xrecords'] = '{$a} records shown';
$string['xrecords_title'] = 'Results - {$a} records';
...
$string['messageprovider:empty_scheduled_report'] = 'Empty scheduled report';
