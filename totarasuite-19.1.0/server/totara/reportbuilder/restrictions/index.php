...
if ($action === 'delete' && !$confirm) {
    ...
    echo $output->page_main_heading(get_string('confirmdeleterestrictionheader', 'totara_reportbuilder', $restriction->name));
    ...
    echo $output->page_main_heading(get_string('globalrestrictions', 'totara_reportbuilder'));
