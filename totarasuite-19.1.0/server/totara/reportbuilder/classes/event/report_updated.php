...
class report_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        $values = [$this->userid, $area, $this->objectid, $shortname];
        $description = "The user with id '%s' updated (%s) the report '%s' (%s).";

        if (!empty($this->other['tenantid'])) {
            $description = "The user with id '%s' updated (%s) the report '%s' (%s) in the tenant with id '%s'.";
