...
class report_deleted extends \core\event\base {
    ...
    public function get_description() {
        ...
        $values = [$this->userid, $type, $this->objectid, $shortname];
        $description = "The user with id '%s' %s the report '%s' (%s).";

        if (!empty($this->other['tenantid'])) {
            $description = "The user with id '%s' %s the report '%s' (%s) in the tenant with id '%s'.";
