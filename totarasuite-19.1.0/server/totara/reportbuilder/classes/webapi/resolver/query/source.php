...
/**
 * Query to return a report builder source.
 */
class source extends query_resolver {

    use helper;

    /**
     * Returns a report builder source.
     *
     * @param array $args
    ...
    public static function resolve(array $args, execution_context $ec) {
        $tenantid = !empty($args['tenantid'])
            ? $args['tenantid']
            : null;
        if (!self::user_can_edit_report($tenantid)) {
        ...
        return \reportbuilder::get_source_object($args['key']);
    }
