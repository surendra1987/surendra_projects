...
$string['task_description'] = 'Listed below are all the tasks you\'ve received. You can click links in the task title to view more detail or dismiss a task by clicking the dismiss icon to the right of the list. You may also choose to filter which tasks are shown in the list by making use of the "Search by" functionality.';
$string['tasks'] = 'Tasks';
