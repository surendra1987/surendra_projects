...
$PAGE->set_url('/totara/playlist/reporting/playlist_report.php');
...
$PAGE->navbar->add(get_string('playlistengagement', 'totara_playlist'));

$config = (new rb_config())->set_sid($sid);
$report = reportbuilder::create_embedded('playlistengagement', $config);

$PAGE->set_button($report->edit_button() . $PAGE->button);

$heading = get_string('playlistengagement', 'totara_playlist');
...
echo $output->heading(get_string('playlistengagement', 'totara_playlist'));
