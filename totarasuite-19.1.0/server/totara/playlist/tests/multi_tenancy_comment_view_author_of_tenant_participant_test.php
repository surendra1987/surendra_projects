...
class totara_playlist_multi_tenancy_comment_view_author_of_tenant_participant_test extends \core_phpunit\testcase {
    /**
     * @var stdClass|null
     */
    private $tenant_user;
    ...
    public function test_check_can_view_author_of_tenant_member_without_isolation(): void {
        $playlist_article = $this->get_playlist_generator();
        $playlist = $playlist_article->create_public_playlist(['userid' => $this->tenant_participant->id]);
        ...
        static::assertDebuggingCalled(
            "totara_comment\interactor\comment_interactor::can_view_author has been deprecated, please use access controller instead",
            DEBUG_DEVELOPER
        );
    }
    ...
    public function test_check_can_view_author_of_system_user_without_isolation(): void {
        $playlist_generator = $this->get_playlist_generator();
        $playlist = $playlist_generator->create_public_playlist(['userid' => $this->tenant_participant->id]);
