...
class totara_playlist_multi_tenancy_contribution_loader_of_tenant_participant_test extends \core_phpunit\testcase {
    /***
     * @var stdClass|null
     */
    private $system_user;
     ...
     * @return void
     */
    public function test_loading_shared_playlists_by_system_user_without_isolation(): void {
        $playlist_generator = $this->get_playlist_generator();
        $public_playlist = $playlist_generator->create_public_playlist(['userid' => $this->system_user->id]);

        $playlist_generator->share_playlist($public_playlist, [new user($this->tenant_participant->id)]);
     ...
     * @return void
     */
    public function test_loading_shared_playlists_by_system_user_with_isolation(): void {
        $playlist_generator = $this->get_playlist_generator();
        $public_playlist = $playlist_generator->create_public_playlist(['userid' => $this->system_user->id]);
     ...
     * @return void
     */
    public function test_loading_shared_playlists_by_tenant_member_without_isolation(): void {
        $playlist_generator = $this->get_playlist_generator();
     ...
     * @return void
     */
    public function test_loading_shared_playlists_by_tenant_member_with_isolation(): void {
        $playlist_generator = $this->get_playlist_generator();
        $public_playlist = $playlist_generator->create_public_playlist(['userid' => $this->tenant_user->id]);
