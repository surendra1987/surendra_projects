...
class add_resources extends mutation_resolver {
    /**
     * @param array             $args
    ...
    public static function resolve(array $args, execution_context $ec): bool {
        ...
        foreach ($args['resources'] as $resource_id) {
            $playlist->add_resource(resource_factory::create_instance_from_id($resource_id));
        }
