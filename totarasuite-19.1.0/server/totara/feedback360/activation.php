...
switch ($action) {
    case 'activate':
        // Disable the function of activate feedback when read only enable
        feedback360::read_only_debugging('Feedback 360 activation');
...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading($feedback360->name);
