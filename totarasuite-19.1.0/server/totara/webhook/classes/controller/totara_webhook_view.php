...
/**
* Admin controller for Webhook view page.
*/
class totara_webhook_view extends admin_controller {
    /**
    * @var string
    */
    ...
    */
    public function action(): tui_view {
        ...
        return tui_view::create(
            'totara_webhook/pages/View',
            [
                'id' => $id,
                'data' => $data,
                'canRotate' => has_capability('totara/webhook:managetotara_webhooks', $this->setup_context()),
