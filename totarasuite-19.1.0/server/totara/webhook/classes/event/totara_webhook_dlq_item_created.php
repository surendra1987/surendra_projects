...
class totara_webhook_dlq_item_created extends base {
    ...
    public static function get_name(): string {
        return get_string('event_totara_webhook_dlq_item_created', 'totara_webhook');
    }
    ...
    public function get_description(): string {
        return get_string('event_totara_webhook_dlq_item_created_description', 'totara_webhook', [
            'id' => $this->objectid,
            'userid' => $this->userid,
        ]);
    }
