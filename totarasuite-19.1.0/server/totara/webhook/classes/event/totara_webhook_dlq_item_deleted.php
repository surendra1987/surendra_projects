...
class totara_webhook_dlq_item_deleted extends base {
    ...
    public static function get_name(): string {
        return get_string('event_totara_webhook_dlq_item_deleted', 'totara_webhook');
    }
    ...
    public function get_description(): string {
        return get_string('event_totara_webhook_dlq_item_deleted_description', 'totara_webhook', [
            'id' => $this->objectid,
            'userid' => $this->userid,
        ]);
    }
