...
class totara_webhook_event_subscription_created extends base {
    ...
    public static function get_name(): string {
        return get_string('event_totara_webhook_event_subscription_created', 'totara_webhook');
    }
    ...
    public function get_description(): string {
        return get_string('event_totara_webhook_event_subscription_created_description', 'totara_webhook', [
            'id' => $this->objectid,
            'userid' => $this->userid,
        ]);
    }
