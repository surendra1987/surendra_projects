...
if (version_specific_feature::is_disabled('totara_19_1_totara_dashboard_report')) {
    echo $OUTPUT->page_main_heading(get_string('managedashboards', 'totara_dashboard'));
    ...
    echo $OUTPUT->page_main_heading(get_string('managedashboards', 'totara_dashboard'), $output->create_dashboard_button());

    $report = $output->dashboard_manage_report();
    echo $report['debug_html'];
    $report['report']->display_search();
    echo $report['count_html'];
