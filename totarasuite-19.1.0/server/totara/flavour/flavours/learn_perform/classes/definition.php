...
use totara_flavour\flavour_with_perform;
 ...
 */
class definition extends flavour_with_perform {
    ...
    protected function load_default_settings() {
        return [
            '' => [
                ...
                'enableperform_goals' => advanced_feature::ENABLED,
                'enablecompetency_assignment' => advanced_feature::ENABLED,
                // Disable legacy Perform features
