 ...
 */
class totara_flavour_helper_test extends \core_phpunit\testcase {
    ...
    public function test_expected_defaults() {
        ...
        $this->assertObjectNotHasProperty('forceflavour', $CFG);
        $this->assertObjectNotHasProperty('showflavours', $CFG);
        $this->assertObjectNotHasProperty('currentflavour', $CFG);
    ...
    public function test_is_table_belong_to_flavour(): void {
        try {
            helper::is_table_belong_to_flavour('totara_playlist', 'engage_not_exist');
        } catch (coding_exception $ex) {
            $this->assertInstanceOf('coding_exception', $ex);
            self::assertEquals('Coding error detected, it must be fixed by a programmer: Invalid flavour.' , $ex->getMessage());
        }

        try {
            helper::is_table_belong_to_flavour('invalid_table_name', 'engage');
        } catch (coding_exception $ex) {
            $this->assertInstanceOf('coding_exception', $ex);
            self::assertEquals('Coding error detected, it must be fixed by a programmer: This table does not exsit.' , $ex->getMessage());
        }

        self::assertFalse(helper::is_table_belong_to_flavour('files', 'perform_engage'));
        self::assertTrue(helper::is_table_belong_to_flavour('perform', 'perform_engage'));
        self::assertTrue(helper::is_table_belong_to_flavour('totara_msteams_bot', 'perform_engage'));
        self::assertFalse(helper::is_table_belong_to_flavour('perform_element', 'engage'));
        self::assertTrue(helper::is_table_belong_to_flavour('course', 'learn_engage'));
        self::assertFalse(helper::is_table_belong_to_flavour('perform_element', 'engage'));
        self::assertFalse(helper::is_table_belong_to_flavour('playlist', 'perform'));
        self::assertTrue(helper::is_table_belong_to_flavour('playlist', 'learn_engage'));
        self::assertFalse(helper::is_table_belong_to_flavour('perform_element', 'learn_engage'));
        self::assertFalse(helper::is_table_belong_to_flavour('playlist', 'learn_perform'));
        self::assertTrue(helper::is_table_belong_to_flavour('perform_element', 'learn_perform'));
        self::assertTrue(helper::is_table_belong_to_flavour('perform_element', 'learn_perform_engage'));
        self::assertTrue(helper::is_table_belong_to_flavour('playlist', 'learn_perform_engage'));
        self::assertTrue(helper::is_table_belong_to_flavour('course', 'learn_perform_engage'));
    }

    public function test_is_allowed(): void {
        $feature = 'perform_goals';
        self::assertFalse(helper::is_allowed(new learn_definition(), $feature));
        self::assertTrue(helper::is_allowed(new perform_definition(), $feature));
    }
}
