...
$string['assignments_per_user_summary'] = 'The number of job assignments, and how many users on the site have that many job assignments.';
...
$string['configuration_count_summary'] = 'A list of job properties, and a count of how many job assignments have those properties set.';
...
$string['managers_manager'] = 'Manager\'s manager';
$string['managers_manager_plural'] = 'Manager\'s managers';
...
$string['pluginname'] = 'Job assignments';
...
$string['setting:allowmultiplejobs'] = 'Enable multiple job assignments';
$string['setting:allowmultiplejobs_description'] = 'When enabled, users have more than one job assignment';
