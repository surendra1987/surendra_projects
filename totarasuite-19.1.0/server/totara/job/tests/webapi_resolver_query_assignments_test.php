 ...
 */
class totara_job_webapi_resolver_query_assignments_test extends \core_phpunit\testcase {
    ...
    public function test_ajax_query() {
        ...
        $this->assertEquals(
            'Variable "$userid" got invalid value "apples"; Expected type "core_id".',
        ...
        $this->assertEquals(
            ...
            $result->toArray(DebugFlag::INCLUDE_DEBUG_MESSAGE)['errors'][0]['message']
        );
    }
}