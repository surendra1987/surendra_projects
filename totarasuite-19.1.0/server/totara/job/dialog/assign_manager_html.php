...
$given_user_context = $userid == 0 ? context_system::instance() : context_user::instance($userid);
$PAGE->set_context($given_user_context);

$dialog = new totara_job_dialog_assign_manager($userid, $managerid);
$current_user_context = isloggedin() ? context_user::instance($USER->id) : context_system::instance();
$dialog->set_context($current_user_context);
