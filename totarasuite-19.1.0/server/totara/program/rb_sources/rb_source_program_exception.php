...
class rb_source_program_exception extends rb_base_source {
    ...
    public static function get_exception_options() {
        $options = [
            exception_manager::EXCEPTIONTYPE_TIME_ALLOWANCE          => get_string('timeallowance', 'totara_program'),
            exception_manager::EXCEPTIONTYPE_ALREADY_ASSIGNED        => get_string('exceptiontypealreadyassigned', 'totara_program'),
            exception_manager::EXCEPTIONTYPE_COMPLETION_TIME_UNKNOWN => get_string('completiontimeunknown', 'totara_program'),
            exception_manager::EXCEPTIONTYPE_UNKNOWN                 => get_string('unknown', 'totara_program'),
        ];
