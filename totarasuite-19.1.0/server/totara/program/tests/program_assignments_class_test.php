 ...
 */
class totara_program_program_assignments_class_test extends \core_phpunit\testcase {
    ...
    public function test_remove_outdated_assignments() {
        ...
        $this->program_generator->assign_to_program($program1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $user1->id, null, true);
        $this->program_generator->assign_to_program($program2->id, assignments::ASSIGNTYPE_INDIVIDUAL, $user1->id, null, true);
        $this->program_generator->assign_to_program($program1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $user2->id, null, true);
        $this->program_generator->assign_to_program($program2->id, assignments::ASSIGNTYPE_INDIVIDUAL, $user2->id, null, true);
        $this->program_generator->assign_to_program($program1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $user3->id, null, true);
        $this->program_generator->assign_to_program($program1->id, assignments::ASSIGNTYPE_COHORT, $cohort1->id, null, true);
        $this->program_generator->assign_to_program($program3->id, assignments::ASSIGNTYPE_COHORT, $cohort2->id, null, true);
