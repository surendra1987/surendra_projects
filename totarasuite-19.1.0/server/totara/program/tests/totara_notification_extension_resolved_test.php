...
use totara_program\totara_notification\resolver\extension_resolved as extension_resolved_resolver;
 ...
 */
class totara_program_totara_notification_extension_resolved_test extends totara_program_totara_notification_base {
    ...
    public function test_resolver() {
        ...
        $preference = $notification_generator->create_notification_preference(
            ...
            [
                ...
                'additional_criteria' => '{"extensionRequestTriggers":["request_granted", "request_denied"]}',
            ]
        );
