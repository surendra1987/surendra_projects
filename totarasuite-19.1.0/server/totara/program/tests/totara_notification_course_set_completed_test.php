 ...
 */
class totara_program_totara_notification_course_set_completed_test extends totara_program_totara_notification_base {
    ...
    public function test_get_scheduled_events(): void {
        ...
        $set_compl1->status = program::STATUS_COURSESET_COMPLETE;
        ...
        $set_compl2->status = program::STATUS_COURSESET_COMPLETE;
