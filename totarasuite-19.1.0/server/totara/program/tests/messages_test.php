 ...
 * vendor/bin/phpunit totara_program_messages_test
 */
class totara_program_messages_test extends reportcache_advanced_testcase {
    ...
    public function test_program_enrolment_and_unenrollment_messages() {
        ...
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_UNENROLMENT);
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_ENROLMENT);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->program1->id, true); // Causes static cache to be reset.

        $enrolmentmessage = $DB->get_record('prog_message', array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_ENROLMENT));
        $unenrolmentmessage = $DB->get_record('prog_message', array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_UNENROLMENT));
    ...
    public function test_program_completed_messages() {
        ...
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_COMPLETED));
    ...
    public function test_program_due_messages() {
        ...
        $duemessage = $DB->get_record('prog_message', array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_DUE));
        // Some quick edits to the enrolment message content.
    ...
    public function test_program_overdue_messages() {
        ...
        message_manager::get_program_messages_manager($this->program1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_OVERDUE));
    ...
    public function test_courseset_completed_messages() {
        ...
        message_manager::get_program_messages_manager($this->program1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_COURSESET_COMPLETED));
    ...
    public function test_courseset_due_messages() {
        ...
        message_manager::get_program_messages_manager($this->program1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_COURSESET_DUE));
        ...
        $params = array(
            ...
            'statuscoursesetincomplete' => program::STATUS_COURSESET_INCOMPLETE
        );
    ...
    public function test_courseset_overdue_messages() {
        ...
        message_manager::get_program_messages_manager($this->program1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_COURSESET_OVERDUE));
        // Hack the message record to be triggered 10 days after overdue.
        $DB->set_field('prog_message', 'triggertime', DAYSECS * 10, array('id' => $messageid));
    ...
    public function test_program_learner_followup() {
        ...
        message_manager::get_program_messages_manager($this->program1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_LEARNER_FOLLOWUP));
    ...
    public function test_prevent_resend_on_schedule_change(): void {
        ...
        $due_message = $DB->get_record('prog_message', ['programid' => $this->program1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_DUE]);
