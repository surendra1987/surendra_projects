...
class totara_program_program_user_assignment_repository_test extends testcase {
    ...
    public function test_find_by_program_id(): void {
        ...
        // Use repository to get the user assignment.
        $rows = program_user_assignment::repository()
