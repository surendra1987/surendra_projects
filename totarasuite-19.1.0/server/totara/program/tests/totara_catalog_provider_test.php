 ...
 */
class totara_program_totara_catalog_provider_test extends \core_phpunit\testcase {
    ...
    public function test_get_name() {
        $this->assertSame(get_string('program', 'totara_program'), $this->provider->get_name());
    }
