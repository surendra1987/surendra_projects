...
Feature: Managing group program assignments
  Admin needs to be able to manage group program assignments
  ...
  Background:
    ...
    And I click on "Test program" "link"
    And I click on "Edit program details" "button"
    And I click on "Assignments" "link"

  Scenario: Admin can manage a program assignment with type Group
    ...
    And I press "Ok"
    Then I should see "'Test grp' has been added to the program"
    ...
    When I set the following fields to these values:
      ...
      | can_self_unenrol | 0                   |
    And I press "Ok"
    Then I should see "'Another group' has been added to the program"
  ...
  Scenario: Admin can delete a program assignment of type Group
    When I set the field "Add a new" to "Group"
    And I set the field "Name" to "Test group"
    And I press "Ok"
    And I click on "Add users to" "link" in the "Test group" "table_row"
    And I click on "Learner One (learner1@example.com)" "link" in the "add-group-users-dialog" "totaradialogue"
    And I click on "Learner Two (learner2@example.com)" "link" in the "add-group-users-dialog" "totaradialogue"
    And I click on "Ok" "button" in the "add-group-users-dialog" "totaradialogue"
    Then I should see "2 learner(s) assigned: 2 active, 0 exception(s)"
    ...
    When I press "Remove"
    Then I should see "'Test group' has been removed from the program"
