...
Feature: Users completion of programs and coursesets
  ...
  # Test the program completion problems page
  @javascript
  Scenario: Test program completion problem checker
    ...
    And I click on "Check completions for problems" "link"
    Then I should see "Total records: 3"
    Then I should see "Problem records: 0"
  ...
  Scenario: Test program completion with courseset "AND"
    ...
    When I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 1')]" "xpath_element"
    And I click on "Complete course" "link"
    And I click on "Yes" "button"
    And I click on "Required Learning" in the totara menu
    Then I should see "33%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
    And I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 1')]" "xpath_element"

    When I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 2')]" "xpath_element"
    And I click on "Complete course" "link"
    And I click on "Yes" "button"
    And I click on "Required Learning" in the totara menu
    Then I should see "66%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
    And I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 1')]" "xpath_element"
    And I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 2')]" "xpath_element"

    When I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 3')]" "xpath_element"
    And I click on "Complete course" "link"
    And I click on "Yes" "button"
    ...
    And I click on "Completion Program Tests" "link"
    Then I should see "100%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
    ...
    And I navigate to "Manage programs" node in "Site administration > Programs"
    And I click on "Miscellaneous" "link"
    And I click on "Manage assignments for Completion Program Tests" "link"
  ...
  Scenario: Test program completion with courseset "XofY"
    ...
    And I click on "Required Learning" in the totara menu
    Then I should see "Completion Program Tests"
    And I should see "50%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
  ...
  Scenario: Test program completion with courseset "optional"
    ...
    When I log out
    And I run the scheduled task "\totara_program\task\completions_task"
    And I log in as "user001"
    Then I should not see "Required Learning" in the totara menu
  ...
  Scenario: Test program completion with complex courseset containing "optional"
    ...
    When I click on "Learn" in the totara menu
    And I click on "Completion Program Tests" "link"
    Then I should see "0%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
    ...
    And I click on "Yes" "button"
    And I click on "Required Learning" in the totara menu
    Then I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 1')]" "xpath_element"

    When I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 2')]" "xpath_element"
    And I click on "Complete course" "link"
    And I click on "Yes" "button"
    And I click on "Required Learning" in the totara menu
    Then I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 2')]" "xpath_element"
  ...
  Scenario: Test program completion with courseset "some 0" and minimum score
    ...
    And I should see "Course 1"
    And I should see "Course 2"
    And I should see "0%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
    ...
    And I click on "Required Learning" in the totara menu
    Then I should see "Completion Program Tests"
    And I should see "66%" in the ".tui-totara_program-programHeader__programStatus" "css_element"
