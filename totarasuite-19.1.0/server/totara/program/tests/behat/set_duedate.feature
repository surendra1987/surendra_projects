...
Feature: Set due date for program assignments
  ...
  Background:
    ...
    And the following "users" exist:
      ...
      | user3    | Jane      | Doe      | user3@example.com | America/New_York |
  ...
  Scenario: Relative due dates can be set for individuals
    ...
    And I click on "John Smith (user1@example.com)" "link" in the "Add individuals to program" "totaradialogue"
    And I click on "Mary Jones (user2@example.com)" "link" in the "Add individuals to program" "totaradialogue"
    And I click on "Jane Doe (user3@example.com)" "link" in the "Add individuals to program" "totaradialogue"
    And I click on "Ok" "button" in the "Add individuals to program" "totaradialogue"
    And I wait "1" seconds
    And I click on "Set due date" "link" in the "John Smith" "table_row"
    And I set the following fields to these values:
    ...
    And I click on "Set time relative to event" "button" in the "Completion criteria" "totaradialogue"
    And I wait "1" seconds
    And I click on "Set due date" "link" in the "Jane Doe" "table_row"
    And I set the following fields to these values:
      | timeamount | 0           |
      | timeperiod | Day(s)      |
      | eventtype  | First login |
    ...
    And  I should see "Complete within 0 Day(s) of First login" in the "Jane Doe" "table_row"
  ...
  @javascript
  Scenario: Relative due date related objects can have zero as value
    Given I am on a totara site
    ...
    And I set the following fields to these values:
      | profile_field_startdate[enabled] | 1       |
      | profile_field_startdate[day]     | 21      |
      | profile_field_startdate[month]   | October |
      | profile_field_startdate[year]    | ## + 1 year ## Y ## |
    And I press "Save and go back"
    ...
    And I click on "Jane Doe (user3@example.com)" "link" in the "Add individuals to program" "totaradialogue"
    And I click on "Ok" "button" in the "Add individuals to program" "totaradialogue"
    Then I should see "'Jane Doe' has been added to the program"
    When I click on "Set due date" "link" in the "Jane Doe" "table_row"
    And I set the following fields to these values:
      | timeamount | 0                  |
      | timeperiod | Day(s)             |
      | eventtype  | Profile field date |
    And I wait "1" seconds
    Then I should see "startdate" in the "Choose item" "totaradialogue"
    And I click on "startdate" "link" in the "Choose item" "totaradialogue"
    And I click on "Ok" "button" in the "Choose item" "totaradialogue"
    When I click on "Set time relative to event" "button" in the "Completion criteria" "totaradialogue"
    Then  I should see "21 Oct" in the "Jane Doe" "table_row"
