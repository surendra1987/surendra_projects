...
Feature: Allow learners to self-enrol into programs
  As a learner, I can self-enrol into a program that allows it
  ...
  Background:
    ...
    And the following "programs" exist in "totara_program" plugin:
      | fullname       | shortname   |
      | Open program   | prog-open   |
    And I log in as "admin"
    And I go to edit the program "prog-open"
  ...
  Scenario: Learner can self enrol into a simple program
    Given I log in as "user1"
    And I am on "Open program" program homepage
    Then I should see "Enrol"
    When I press "Enrol"
    Then I should see "Are you sure you want to enrol with Open enrolment in Open program?" in the ".tui-totara_program-enrolment-confirmation" "css_element"
    ...
    And I should see "31 December 2050"
    When I press "Actions for Open program"
    ...
    And I am on "Open program" program homepage
    And I press "Actions for Open program"
    ...
    Then I should see "Are you sure you want to withdraw from Open enrolment in Open program?"
    And I should see "You will be removed from this program, but your progress and completion records won't be affected." in the ".tui-totara_program-enrolment-confirmation" "css_element"
    When I click on "Withdraw" "text" in the ".tui-btn--variant-primary" "css_element"
    Then I should not see "Actions for Open program"
  ...
  Scenario: Learner can self enrol into a program with multiple options
    ...
    Then I should see "Are you sure you want to enrol with Second open enrolment in Open program?" in the ".tui-totara_program-enrolment-confirmation" "css_element"
    ...
    Then I should see "Are you sure you want to add Open enrolment to your enrolment in Open program?" in the ".tui-totara_program-enrolment-confirmation" "css_element"
    When I click on "Enrol" "text" in the ".tui-modalContent .tui-btn--variant-primary" "css_element"
    And I press "Actions for Open program"
    And I click on "Enrolment details" "link"
    And I click on "Withdraw" "button" in the ".tui-totara_program-enrolment-options .tui-card--clickable" "css_element"
    Then I should see "Your other enrolments in this program won’t be affected and you will remain in this program." in the ".tui-totara_program-enrolment-confirmation" "css_element"

  Scenario: Learner can't withdraw from programs with non groups enrolments
  ...
  Scenario: Learner can't self enrol into programs if there are no groups allowing it
    Given the following "programs" exist in "totara_program" plugin:
      | fullname       | shortname   |
      | Closed program | prog-closed |
    ...
    And I am on "Open program" program homepage
    Then I should not see "Enrol"
    And I am on "Closed program" program homepage
    Then I should not see "Enrol"
