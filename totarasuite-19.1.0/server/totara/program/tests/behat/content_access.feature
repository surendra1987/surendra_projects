...
Feature: Access programs content as a learner
  ...
  Scenario: Access a new course added to a completed program via program assignments without duedates
    ...
    And I click on "Program Access Tests" "link"
    And I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 1')]" "xpath_element"
    ...
    And I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Course 2')]" "xpath_element"
