...
$capabilities = array(
    ...
    'totara/program:cloneprogram' => array(
        'riskbitmask' => RISK_XSS | RISK_CONFIG,
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSECAT,
        'archetypes' => array(
    ...
    // Ability to audit program messages
    'totara/program:auditmessages' => array(
        'riskbitmask' => RISK_PERSONAL,
        'captype' => 'read',
        'contextlevel' => CONTEXT_PROGRAM,
        'archetypes' => array(
        ...
        'clonepermissionsfrom' => 'totara/program:configuremessages'
    ),
