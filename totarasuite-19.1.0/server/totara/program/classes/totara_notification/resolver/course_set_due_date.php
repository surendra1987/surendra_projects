...
class course_set_due_date extends notifiable_event_resolver implements scheduled_event_resolver, permission_resolver, audit_resolver {

    /**
     * @inheritDoc
     */
    public static function get_notification_title(): string {
        return get_string('notification_course_set_due_date_resolver_title', 'totara_program');
    }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        $courseset = course_set::from_id($this->get_event_data()['course_set_id']);
        $params['courseset'] = $courseset->do_get('label');

        return [
            'key' => 'notification_log_course_set_due_date_resolver',
