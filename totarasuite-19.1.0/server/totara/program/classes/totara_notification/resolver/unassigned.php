...
class unassigned extends notifiable_event_resolver implements permission_resolver, audit_resolver {
    /**
     * @inheritDoc
     */
    public static function get_notification_title(): string {
        return get_string('notification_unassigned_resolver_title', 'totara_program');
    }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_unassigned_resolver',
