...
class extension_requested extends notifiable_event_resolver implements permission_resolver, audit_resolver {

    /**
     * @inheritDoc
     */
    public static function get_notification_title(): string {
        return get_string('notification_extension_request_title', 'totara_program');
    }
