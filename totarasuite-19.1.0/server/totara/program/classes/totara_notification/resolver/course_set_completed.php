...
class course_set_completed extends notifiable_event_resolver implements scheduled_event_resolver, permission_resolver, audit_resolver {
    ...
    public static function get_scheduled_events(int $min_time, int $max_time): moodle_recordset {
        return builder::table('prog_completion')
            ...
            ->where('status', program_class::STATUS_COURSESET_COMPLETE)
            ->where('coursesetid', '>', 0)
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_course_set_completed_resolver',
