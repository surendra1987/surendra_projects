...
final class assigned_for_subject extends built_in_notification {
    ...
    public static function get_title(): string {
        return get_string('notification_assigned_for_subject_title', 'totara_program');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_assigned_for_subject_body', 'totara_program');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_assigned_for_subject_subject', 'totara_program');
    }
