...
final class new_exception_for_site_admin extends built_in_notification {
    ...
    public static function get_title(): string {
        return get_string('notification_new_exception_for_site_admin_title', 'totara_program');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_new_exception_for_site_admin_body', 'totara_program');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_new_exception_for_site_admin_subject', 'totara_program');
    }
