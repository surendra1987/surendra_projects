...
use totara_program\totara_notification\resolver\extension_requested;

final class extension_request_for_managers extends built_in_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return extension_requested::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification_extension_request_for_managers_title', 'totara_program');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_extension_request_for_managers_body', 'totara_program');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_extension_request_for_managers_subject', 'totara_program');
    }
