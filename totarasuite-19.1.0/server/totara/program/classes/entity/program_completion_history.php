 ...
 * @property int $recurringcourseid
 ...
 *
 * @method static program_completion_history_repository repository()
 */
class program_completion_history extends entity {

    /**
     * @var string
     */
    public const TABLE = 'prog_completion_history';
