...
/**
 * Position assigned date completion event.
 */
class position_assigned_date extends completion_event {
    ...
    public function get_id(): int {
        return assignments::COMPLETION_EVENT_POSITION_ASSIGNED_DATE;
    }
