...
/**
 * Display class intended for user program extension link
 *
 * @author Simon Player <simon.player@totaralearning.com>
 * @package totara_program
 */
class program_extension_link extends base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        ...
        if (isset($extrafields->user_id)) {
            $url = new \moodle_url('/totara/program/manageextensions.php', array('userid' => $extrafields->user_id));
