 ...
 */
class self_assignable_competency extends type_resolver {

    /**
     * Resolves fields for an organisation
     *
     * @param string $field
     * @param competency_model $competency
     * @param array $args
     * @param execution_context $ec
     * @return mixed
     */
    public static function resolve(string $field, $competency, array $args, execution_context $ec) {
        if (!$competency instanceof competency_model) {
            throw new \coding_exception('Accepting only competency models.');
        }
