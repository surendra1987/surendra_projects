...
/**
 * Does GDPR related processing for competency ratings given by a participant in
 * a perform activity.
 */
class perform_rating_other extends perform_rating {
    /**
     * {@inheritdoc}
     */
