 ...
 */
final class totara_cloudfiledir_azure_store_test extends totara_cloudfiledir_store_testcase {
    protected function prepare_store_config(array $config): array {
        ...
        $config['options'] = \totara_cloudfiledir_azure_provider_test::get_provider_options();
        $config['bucket'] = \totara_cloudfiledir_azure_provider_test::get_provider_bucket();
