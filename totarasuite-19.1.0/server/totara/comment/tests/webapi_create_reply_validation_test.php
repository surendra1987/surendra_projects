...
class totara_comment_webapi_create_reply_validation_test extends \core_phpunit\testcase {
    use webapi_phpunit_helper;

    /**
     * @return void
     */
    public function test_create_reply_with_content_format_different_from_json_editor(): void {
     ...
     * @return void
     */
    public function test_create_reply_with_content_as_empty_document(): void {
        global $CFG;
