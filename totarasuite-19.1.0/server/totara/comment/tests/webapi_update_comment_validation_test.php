...
class totara_comment_webapi_update_comment_validation_test extends \core_phpunit\testcase {
    use webapi_phpunit_helper;

    /**
     * @return void
     */
    public function test_update_comment_with_different_content_format_from_json_editor(): void {
     ...
     * @return void
     */
    public function test_update_comment_with_description_as_empty_document(): void {
        global $CFG;
        ...
        // Use the user's context instead of default context system.
        ...
        $this->expectExceptionMessage(get_string('error:update', 'totara_comment'));
