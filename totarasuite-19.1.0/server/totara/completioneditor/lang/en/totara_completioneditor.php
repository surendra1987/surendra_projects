...
$string['coursecompletionduedate'] = 'Due date (calculated)';
...
$string['coursecompletiongrademax'] = 'Maximum grade';
$string['coursecompletiongrademin'] = 'Minimum grade';
...
$string['helpmaxmingrades'] = '<p><strong> Max grade:</strong> {$a->maxgrade} - <strong> Min grade:</strong> {$a->mingrade}. Please use these values as a guide to fill Maximum grade and Minimum grade fields below</p>';
