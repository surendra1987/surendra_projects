...
use totara_webapi\webapi\resolver\middleware\test_group;
use totara_webapi\webapi\resolver\middleware\test_request_2;
use totara_webapi\webapi\resolver\middleware\test_result_2;

defined('MOODLE_INTERNAL') || die();

class test_middleware_query_resolver_with_group extends query_resolver {
    ...
    public static function get_middleware(): array {
        global $CFG;
        require_once $CFG->dirroot.'/totara/webapi/tests/fixtures/resolver/middleware/test_group.php';
