...
class test_middleware_query_resolver_with_broken_middleware extends query_resolver {
    ...
    public static function get_middleware(): array {
        ...
        require_once $CFG->dirroot.'/totara/webapi/tests/fixtures/resolver/middleware/test_request_2_broken.php';
