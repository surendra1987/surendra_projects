...
class engage_survey_multi_tenancy_contribution_loader_of_tenant_member_test extends \core_phpunit\testcase {
    /***
     * @var stdClass|null
     */
    private $system_user;
    ...
    public function test_loading_shared_surveys_by_system_user_without_isolation(): void {
        ...
        $survey_generator->share_survey($public_survey, [new user($this->tenant_user->id)]);
