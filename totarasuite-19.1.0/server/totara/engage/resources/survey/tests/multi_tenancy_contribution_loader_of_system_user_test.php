...
class engage_survey_multi_tenancy_contribution_loader_of_system_user_test extends \core_phpunit\testcase {
    /**
     ...
     * @return void
     */
    public function test_loading_shared_surveys_by_tenant_user_without_isolation(): void {
        ...
        $survey_generator->share_survey($public_survey, [new user($this->system_user->id)]);
     ...
     * @return void
     */
    public function test_loading_shared_surveys_by_tenant_user_with_isolation(): void {
        $survey_generator = $this->get_survey_generator();
     ...
     * @return void
     */
    public function test_loading_shared_surveys_by_tenant_participant_without_isolation(): void {
        $survey_generator = $this->get_survey_generator();
     ...
     * @return void
     */
    public function test_loading_shared_surveys_by_tenant_participant_with_isolation(): void {
        $survey_generator = $this->get_survey_generator();
