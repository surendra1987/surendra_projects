...
/**
 * Get IDs of courses added to playlist.
 */
class ids_added_to_playlist extends query_resolver {
    /** @inheritDoc */
    public static function resolve(array $args, execution_context $ec): array {
        ...
        return $loader->fetch_added_instance_ids_by_component('engage_course');
    }
