...
class engage_course_multi_tenancy_access_test extends testcase {
    /**
     * @return void
     */
    public function test_system_level_user_access_tenant_course(): void {
        ...
        /** @var \engage_course\testing\generator $course_generator */
        $course_generator = $generator->get_plugin_generator('engage_course');
        $course = $course_generator->create_course_resource();

        // Log in as system user to see if the system user is able to access the article or not.
        $this->setUser($user_one);
        self::assertTrue(access_manager::can_access($course, $user_one->id));
        ...
        self::assertFalse(access_manager::can_access($course, $user_one->id));
    }

    /**
     * @return void
     */
    public function test_tenant_member_can_access_system_level_course(): void {
        $generator = $this->getDataGenerator();
     ...
     * @return void
     */
    public function test_participant_member_can_access_tenant_course(): void {
        $generator = $this->getDataGenerator();
     ...
     * @return void
     */
    public function test_tenant_member_access_participant_course(): void {
        $generator = $this->getDataGenerator();
     ...
     * @return void
     */
    public function test_tenant_member_cannot_see_different_tenant_course(): void {
        $generator = $this->getDataGenerator();
        ...
        $this->setUser($user_two);
        self::assertFalse(access_manager::can_access($course, $user_two->id));
