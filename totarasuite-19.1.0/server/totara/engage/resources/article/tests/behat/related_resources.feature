@totara @totara_engage @engage_article @engage @javascript @ml_recommender @ml_service
Feature: Confirm related resources are displayed
  ...
  Background:
    ...
    And the following "articles" exist in "engage_article" plugin:
      ...
      | Test Article 1 | user1    | Test Article 1 | FORMAT_PLAIN | PUBLIC | Topic 1 |
      | Test Article 2 | user1    | Test Article 2 | FORMAT_PLAIN | PUBLIC | Topic 1 |
