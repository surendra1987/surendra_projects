...
class engage_article_availability_test extends \core_phpunit\testcase {
    /**
     * @return void
     */
    ...
    public function test_fetch_for_catalog_when_user_is_suspended(): void {
        ...
        self::assertObjectHasProperty('objects', $before_suspended_result);
        ...
        self::assertObjectHasProperty('objects', $after_suspended_result);
