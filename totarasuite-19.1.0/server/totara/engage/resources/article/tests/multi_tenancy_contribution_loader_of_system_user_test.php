...
class engage_article_multi_tenancy_contribution_loader_of_system_user_test extends \core_phpunit\testcase {
    /**
     ...
     * @return void
     */
    public function test_loading_shared_resources_by_tenant_user_without_isolation(): void {
        ...
        $article_generator->share_article($public_article, [new user($this->system_user->id)]);
     ...
     * @return void
     */
    public function test_loading_shared_resources_by_tenant_user_with_isolation(): void {
        $article_generator = $this->get_article_generator();
        $public_article = $article_generator->create_public_article(['userid' => $this->tenant_user->id]);
