...
class engage_article_webapi_create_article_test extends \core_phpunit\testcase {
     ...
     * @return void
     */
    public function test_article_content_is_cleaned_on_create_when_format_is_not_provided(): void {
        $generator = $this->getDataGenerator();
        $user_one = $generator->create_user();
        ...
        $this->assertEquals('Hello world', $article->get_name());
        $this->assertStringNotContainsString('javascript:alert(1)', $article->get_content());
    }
