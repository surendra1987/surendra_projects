...
use engage_article\watcher\editor_weka_watcher;
use totara_comment\comment;
use totara_core\advanced_feature as advanced_feature;
use totara_engage\access\access;

class engage_article_editor_weka_search_users_comment_test extends \core_phpunit\testcase {
    ...
    public function test_search_for_users() {
        ...
        $comment2 = $comment_generator->create_comment(
            $private_article->get_id(),
            $private_article::get_resource_type(),
            'comment'
        );
    ...
    public function test_search_for_users_with_multitenancy(): void {
        ...
        $hook->set_instance_id($tenant1_article_comment1->get_id());
        ...
        $hook->set_instance_id($tenant2_article_comment1->get_id());
