...
class engage_article_multi_tenancy_comment_view_author_of_system_user_test extends \core_phpunit\testcase {
    /**
     * @var stdClass|null
     */
    private $tenant_user;
    ...
    public function test_check_can_view_author_of_tenant_member_without_isolation(): void {
        ...
        $article = $article_generator->create_public_article(['userid' => $this->system_user->id]);
