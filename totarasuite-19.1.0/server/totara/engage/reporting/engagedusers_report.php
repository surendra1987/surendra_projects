...
$PAGE->set_url('/totara/engage/reporting/engagedusers_report.php');
...
$PAGE->navbar->add(get_string('sourcetitle', 'rb_source_engagedusers'));

$config = (new rb_config())->set_sid($sid);
$report = reportbuilder::create_embedded('engagedusers', $config);

$PAGE->set_button($report->edit_button() . $PAGE->button);

$heading = get_string('sourcetitle', 'rb_source_engagedusers');
...
echo $output->heading(get_string('sourcetitle', 'rb_source_engagedusers'));
