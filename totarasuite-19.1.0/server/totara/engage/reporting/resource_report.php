...
$PAGE->set_url('/totara/engage/reporting/resource_report.php');
...
$PAGE->navbar->add(get_string('sourcetitle', 'rb_source_engagecontent'));

$config = (new rb_config())->set_sid($sid);
$report = reportbuilder::create_embedded('engagecontent', $config);

$PAGE->set_button($report->edit_button() . $PAGE->button);

$heading = get_string('sourcetitle', 'rb_source_engagecontent');
...
echo $output->page_main_heading(get_string('sourcetitle', 'rb_source_engagecontent'));
