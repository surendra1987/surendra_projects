...
class totara_reportedcontent_approve_review_test extends \core_phpunit\testcase {
    /**
     * @return void
     */
    public function test_approve_review(): void {
        ...
        $ec = execution_context::create('ajax', 'totara_reportedcontent_approve_review');
        ...
        $this->assertSame(review::DECISION_APPROVE, (int) $record->status);
