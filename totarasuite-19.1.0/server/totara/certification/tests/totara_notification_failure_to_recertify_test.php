...
use totara_certification\totara_notification\resolver\failure_to_recertify as failure_to_recertify_resolver;
use totara_certification\event\failure_to_recertify as failure_to_recertify_event;
 ...
 */
class totara_certification_totara_notification_failure_to_recertify_test extends totara_certification_totara_notification_base {
    ...
    public function test_completed() {
        ...
        $preference = $notification_generator->create_notification_preference(
            failure_to_recertify_resolver::class,
            $event_context,
            [
                'schedule_offset' => 0,
        ...
        $event = failure_to_recertify_event::create_from_user_program($data->user1->id, $data->program1->id);
        $event->trigger();
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => failure_to_recertify_resolver::class,
                ...
                'event_name' => get_string('notification_log_failure_to_recertify_resolver', 'totara_certification', [
                    'resolver_title' => failure_to_recertify_resolver::get_notification_title(),
