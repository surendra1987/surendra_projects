 ...
 */
class totara_certification_totara_notification_course_set_due_date_test extends totara_certification_totara_notification_base {
    ...
    public function test_resolver() {
        ...
        self::verify_notification_logs([
            [
                ...
                'event_name' => get_string('notification_log_course_set_due_date_resolver', 'totara_certification', [
                    'resolver_title' => course_set_due_date_resolver::get_notification_title(),
