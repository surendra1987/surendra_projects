 ...
 */
class totara_certification_totara_catalog_provider_test extends \core_phpunit\testcase {
    ...
    public function test_get_name() {
        $this->assertSame(get_string('certification', 'totara_certification'), $this->provider->get_name());
    }
