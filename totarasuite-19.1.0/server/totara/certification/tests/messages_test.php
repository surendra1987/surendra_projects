...
use totara_program\message\eventbased\program_due_message;
 ...
 * vendor/bin/phpunit totara_certification_messages_test
 *
 */
class totara_certification_messages_test extends reportcache_advanced_testcase {
    ...
    public function test_certification_completed_messages() {
        ...
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_PROGRAM_COMPLETED);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_COMPLETED));
    ...
    public function test_certification_due_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_PROGRAM_DUE);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_DUE));
    ...
    public function test_certification_overdue_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_PROGRAM_OVERDUE);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_OVERDUE));
    ...
    public function test_certification_courseset_completed_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_COURSESET_COMPLETED);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_COURSESET_COMPLETED));
    ...
    public function test_certification_courseset_due_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_COURSESET_DUE);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_COURSESET_DUE));
    ...
    public function test_certification_courseset_overdue_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_COURSESET_OVERDUE);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_COURSESET_OVERDUE));
        // Hack the message record to be triggered 10 days after overdue.
        $DB->set_field('prog_message', 'triggertime', DAYSECS * 10, array('id' => $messageid));
    ...
    public function test_recertification_window_open_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_RECERT_WINDOWOPEN);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_RECERT_WINDOWOPEN));
    ...
    public function test_recertification_window_due_to_close_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_RECERT_WINDOWDUECLOSE);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_RECERT_WINDOWDUECLOSE));
        // Hack the message record to be triggered 100 days before due.
        $DB->set_field('prog_message', 'triggertime', DAYSECS * 100, array('id' => $messageid));
    ...
    public function test_recertification_failure_to_recertify_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_RECERT_FAILRECERT);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_RECERT_FAILRECERT));
    ...
    public function test_certification_learner_followup_messages() {
        ...
        $programmessagemanager = $this->cert1->get_messagesmanager();
        $programmessagemanager->delete();
        $programmessagemanager->add_message(message_manager::MESSAGETYPE_LEARNER_FOLLOWUP);
        $programmessagemanager->save_messages();
        message_manager::get_program_messages_manager($this->cert1->id, true); // Causes static cache to be reset.
        $messageid = $DB->get_field('prog_message', 'id',
            array('programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_LEARNER_FOLLOWUP));
    ...
    public function test_prevent_resend_on_schedule_change(): void {
        ...
        // Set up the due message for cert1.
        $message_manager = $this->cert1->get_messagesmanager();
        $message_manager->delete();
        $message_manager->add_message(message_manager::MESSAGETYPE_PROGRAM_DUE);
        $message_manager->save_messages();

        // Adjust the message content.
        $due_message = $DB->get_record('prog_message', ['programid' => $this->cert1->id, 'messagetype' => message_manager::MESSAGETYPE_PROGRAM_DUE]);
        ...
        // Assign users to certification.
        $this->programgenerator->assign_program($this->cert1->id, [$this->user1->id]);

        // Adjust the due date, 10 days from now.
        $duedate = time() + DAYSECS * 10;
        $progcompl1 = prog_load_completion($this->cert1->id, $this->user1->id);
        $progcompl1->timedue = $duedate;
        ...
        $due_message_obj = new program_due_message($due_message->id, $due_message);
