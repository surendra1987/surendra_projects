 ...
 * vendor/bin/phpunit --verbose totara_certification_certification_completion_test totara/certification/tests/certification_completion_test.php
 */
class totara_certification_certification_completion_test extends reportcache_advanced_testcase {
     ...
     */
    public static function data_certif_get_completion_state() {
        return array(
     ...
     */
    public static function data_certif_get_completion_errors_for_current() {
        return array(
            ...
            array('cert status not set',
                ...
                array('status' => program::STATUS_PROGRAM_COMPLETE),
            ...
            array('prog completion status courseset status complete',
                ...
                array('status' => program::STATUS_COURSESET_COMPLETE, // 1, 2: Should be STATUS_PROGRAM_INCOMPLETE.
                    'timecompleted' => 0,
                    'timedue' => 1001),
            ...
            array('prog completion status courseset status incomplete',
                array('status' => CERTIFSTATUS_ASSIGNED,
                    ...
                    'timeexpires' => 0,
                    'baselinetimeexpires' => 0),
                array('status' => program::STATUS_COURSESET_INCOMPLETE, // 1, 2: Should be STATUS_PROGRAM_INCOMPLETE.
                    'timecompleted' => 0,
                    'timedue' => 1001),
                array('error:stateassigned-progstatusincorrect' => 'progstatus', // 1.
                    'error:progstatusinvalid' => 'progstatus') // 2.
            ...
            array('assigned problems #1',
                ...
                array('status' => program::STATUS_PROGRAM_COMPLETE, // 7: Should be STATUS_PROGRAM_INCOMPLETE.
                    'timecompleted' => 1004, // 8: Should be 0.
                    'timedue' => assignments::COMPLETION_TIME_UNKNOWN), // 9: Should be anything else.
            ...
            array('assigned problems #2',
                ...
                array('status' => program::STATUS_PROGRAM_INCOMPLETE,
            ...
            array('certified not due problems #1',
                ...
                array('status' => program::STATUS_PROGRAM_INCOMPLETE, // 7: Should be STATUS_PROGRAM_COMPLETE.
                    'timecompleted' => 0, // 8: Should be > 0.
                    'timedue' => assignments::COMPLETION_TIME_UNKNOWN), // 9: Should be > 0.
            ...
            array('certified not due problems #2',
                ...
                array('status' => program::STATUS_PROGRAM_COMPLETE,
                    'timecompleted' => -1, // 6: Should be > 0.
                    'timedue' => assignments::COMPLETION_TIME_NOT_SET), // 7: Should be > 0.
            ...
            array('expired problems #2',
                ...
                array('status' => program::STATUS_PROGRAM_INCOMPLETE,
                    'timecompleted' => -1, // 6: Should be 0.
                    'timedue' => assignments::COMPLETION_TIME_NOT_SET), // 8: Should be > 0.
                array('error:stateexpired-renewalstatusincorrect' => 'renewalstatus', // 1.
     ...
     */
    public static function data_certif_get_completion_errors_for_history() {
        return array(
    ...
    public function test_certif_fix_completions_only_specified_state() {
        ...
        $params = array('status' => program::STATUS_PROGRAM_INCOMPLETE, 'timecompleted' => 0, 'programid' => $windowopenprog->id,
    ...
    public function test_certif_fix_completions_known_unfixed_problems() {
        ...
        $sql = "UPDATE {prog_completion}
                 ...
                 WHERE coursesetid = 0";
        $params = array('status' => program::STATUS_PROGRAM_INCOMPLETE, 'timecompleted' => 0);
        $DB->execute($sql, $params);
        $sql = "UPDATE {certif_completion}
                   SET renewalstatus = :renewalstatus";
        ...
        $sql = "UPDATE {prog_completion}
                 ...
                 WHERE programid = :programid OR userid = :userid AND coursesetid = 0";
        $params = array('status' => program::STATUS_PROGRAM_COMPLETE, 'timecompleted' => $timecompleted,
    ...
    public function test_certif_write_completion_exceptions() {
        ...
        try {
            ...
            $this->assertStringContainsString(get_string('error:updatinginvalidcompletionrecords', 'totara_certification'), $e->getMessage());
        }
    ...
    public function test_certif_write_completion() {
        ...
        $progcompletioncertifiedtemplate->status = program::STATUS_PROGRAM_COMPLETE;
        ...
        $progcompletion->status = program::STATUS_PROGRAM_INCOMPLETE; // Invalid.
    ...
    public function test_certif_write_completion_validation_failure() {
        ...
        $progcompletion->status = program::STATUS_PROGRAM_INCOMPLETE; // Invalid due to timecompleted.
    ...
    public function test_certif_write_completion_history_exceptions() {
        ...
        try {
            ...
            $this->assertStringContainsString(get_string('error:updatinginvalidcompletionhistoryrecord', 'totara_certification'), $e->getMessage());
        }
    ...
    public function test_certif_fix_completion_expiry_to_due_date() {
        ...
        $expectedprogcompletion->status = program::STATUS_PROGRAM_COMPLETE;
    ...
    public function test_certif_fix_cert_completion_date() {
        ...
        $testprogcompletion->status = program::STATUS_PROGRAM_COMPLETE;
    ...
    /**
     * Test certif_fix_prog_timedue. Set the program due date to \totara_program\assignments\assignments::COMPLETION_TIME_NOT_SET.
     */
    public function test_certif_fix_prog_timedue() {
        ...
        // Check that the record was changed as expected (back to \totara_program\assignments\assignments::COMPLETION_TIME_NOT_SET).
        $this->assertEquals($expectedcertcompletion, $certcompletion);
        $this->assertEquals($expectedprogcompletion, $progcompletion);
    }
    ...
    public function test_certif_load_completion() {
        ...
        try {
            ...
            $this->assertStringContainsString(s(get_string('error:cannotloadcompletionrecords', 'totara_certification', $a)), $e->getMessage());
        }
    }
