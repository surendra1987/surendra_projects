...
class rb_source_certification_overview extends rb_base_source {
    ...
    protected function define_joinlist() {
        ...
        $this->add_totara_certification_assignment_tables($joinlist, 'base', 'programid', 'base', 'userid', 'INNER');
    ...
    protected function define_columnoptions() {
        ...
        */
        ...
        $concat = $DB->sql_group_concat(utils::get_ordered_course_column_field_definition(
        ...
        $concat = $DB->sql_group_concat(
            utils::get_ordered_course_column_field_definition(
