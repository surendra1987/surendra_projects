...
$string['add_group_users_notes'] = 'Selected users will be enrolled in the certification. Other users may enrol themselves if allowed.';
...
$string['assignmentedited'] = '\'{$a}\' has been updated.';
...
$string['certification_assignment_summary'] = 'The statistics of certification assignments.';
$string['certification_courseset_summary'] = 'The statistics of certification coursesets.';
$string['certification_recertification_summary'] = 'The statistics of recertification.';
$string['certification_summary'] = 'The basic statistics of certifications.';
...
$string['certificationid'] = 'Certification internal ID';
$string['certificationlive'] = 'This certification is live. Any changes you make may affect learners progress and completion records.';
...
$string['clonecertification'] = 'Clone certification';
$string['clonecertificationwarning'] = 'You can\'t copy certification assignments and completion records.';
...
$string['deletecertification'] = 'Delete certification {$a}';
...
$string['editcertificationsettings'] = 'Edit certification {$a} settings';
...
$string['hidecertification'] = 'Hide certification {$a}';
$string['image'] = 'Image';
...
$string['manageassignments'] = 'Manage assignments for {$a}';
...
$string['movecertificationdown'] = 'Move certification {$a} down';
$string['movecertificationup'] = 'Move certification {$a} up';
...
$string['notification_completion_placeholder_group'] = 'Certification Completion {$a}';
...
$string['notification_extension_request_denied_for_subject_body'] = 'Your extension request was refused by [resolver:full_name].
Reason: [extension_request:reason_for_decision]
Certification: [certification:full_name_link]';
$string['notification_extension_request_denied_for_subject_subject_line'] = 'Extension denied for [certification:full_name]';
$string['notification_extension_request_denied_for_subject_title'] = 'Extension denied';
$string['notification_extension_request_for_managers_body'] = 'Your team member [subject:full_name] is requesting an extension for certification [certification:full_name].
Requested date: [extension_request:extension_date].
[extension_request:extension_reason]
To respond to this request, go to [extension_request:manage_extensions_url]';
$string['notification_extension_request_for_managers_subject'] = '[subject:full_name] has requested an extension for [certification:full_name]';
$string['notification_extension_request_for_managers_title'] = 'Learner requesting extension';
$string['notification_extension_request_granted_for_subject_body'] = 'You have been granted an extension until [extension_request:extension_date] by [resolver:full_name].
Reason: [extension_request:reason_for_decision]
Certification: [certification:full_name_link]';
$string['notification_extension_request_granted_for_subject_subject_line'] = 'Extension granted for [certification:full_name]';
$string['notification_extension_request_granted_for_subject_title'] = 'Extension granted';
$string['notification_extension_request_placeholder_group'] = 'Extension Request {$a}';
$string['notification_extension_request_response_type_selector'] = 'Send when request is';
$string['notification_extension_request_title'] = 'Extension requested';
...
$string['notification_log_assigned_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}"';
$string['notification_log_completed_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}"';
$string['notification_log_course_set_completed_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}", course set "{$a->courseset}"';
$string['notification_log_course_set_due_date_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}", course set "{$a->courseset}"';
$string['notification_log_due_date_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}"';
$string['notification_log_expiry_date_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}';
$string['notification_log_extension_request_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}"';
$string['notification_log_failure_to_recertify_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}"';
$string['notification_log_new_exception_resolver'] = '{$a->resolver_title}: Certification "{$a->cert}"';
$string['notification_log_unassigned_resolver'] = '{$a->resolver_title}: Learner "{$a->user}", certification "{$a->cert}"';
$string['notification_log_window_open_date_resolver'] = '{$a->resolver_title}: Certification "{$a->cert}"';
...
$string['notification_response_to_extension_request_title'] = 'Extension resolved';
...
$string['process_while_user_suspended'] = 'Process certification state changes for suspended users';
$string['process_while_user_suspended_help'] = 'If enabled, users\' certifications will continue to progress through the
normal process of recertification window opening and expiring, even if the user is suspended. If disabled, the completion
data of suspended users will not be processed, leading to users\' certifications being permanently fixed in the state
they were in when they became suspended. When disabled, if a suspended user becomes active again, then their certification
will be updated to the correct state given the time that has passed since they became suspended.';
...
$string['showcertification'] = 'Show certification {$a}';
