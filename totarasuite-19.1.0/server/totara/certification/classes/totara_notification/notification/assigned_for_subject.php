...
final class assigned_for_subject extends built_in_notification {
    /**
     * @return string
     */
    ...
    public static function get_title(): string {
        return get_string('notification_assigned_for_subject_title', 'totara_certification');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_assigned_for_subject_body', 'totara_certification');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_assigned_for_subject_subject', 'totara_certification');
    }
