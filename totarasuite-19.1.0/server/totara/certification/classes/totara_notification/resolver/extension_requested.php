...
use totara_program\totara_notification\resolver\extension_requested as program_extension_requested;

class extension_requested extends program_extension_requested {

    /**
     * @inheritDoc
     */
    public static function get_notification_title(): string {
        return get_string('notification_extension_request_title', 'totara_certification');
    }
    ...
    public static function get_notification_available_placeholder_options(): array {
        return [
            ...
            placeholder_option::create(
                'completion',
                assignment::class,
                new lang_string('notification_completion_placeholder_group', 'totara_certification'),
            ...
            placeholder_option::create(
                ...
                new lang_string('notification_extension_request_placeholder_group', 'totara_certification'),
