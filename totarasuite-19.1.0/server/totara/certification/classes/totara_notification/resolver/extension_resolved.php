...
use totara_program\totara_notification\resolver\extension_resolved as program_extension_resolved;

class extension_resolved extends program_extension_resolved {
    ...
    public static function get_notification_title(): string {
        return get_string(
            'notification_response_to_extension_request_title', 'totara_certification'
        );
    }
