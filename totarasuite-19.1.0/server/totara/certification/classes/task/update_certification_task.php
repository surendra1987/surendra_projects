...
class update_certification_task extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        try {
            ...
            mtrace(
                "!WARNING! Ignoring failure during checking for missing certif_completion records: "
                . $e->getMessage()
            );
        }
        ...
        try {
            ...
            mtrace(
                "!WARNING! Ignoring failure during checking for recertify_window_opens_stage: "
                . $e->getMessage()
            );
        }
        ...
        try {
            ...
            mtrace(
                "!WARNING! Ignoring failure during checking for recertify_window_abouttoclose_stage: "
                . $e->getMessage()
            );
        }
        ...
        try {
            ...
            mtrace(
                "!WARNING! Ignoring failure during checking for recertify_expires_stage: "
                . $e->getMessage()
            );
        }
    }
