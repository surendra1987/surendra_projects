...
trait decimal_report_trait {

    /**
     * Adds decimal custom field table to the $joinlist array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     * @param array     $joinlist
     */
    protected function add_totara_customfield_decimal_tables(\stdClass $cf_info, array &$joinlist) {
    ...
    /**
     * Adds decimal custom field to the $columnoptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     * @param array     $columnoptions
     */
    protected function add_totara_customfield_decimal_columns(\stdClass $cf_info, array &$columnoptions) {
        global $DB;
        $joinname = "{$cf_info->area_prefix}_{$cf_info->id}{$cf_info->suffix}";
        $name = $cf_info->fullname ?? $cf_info->name;
        ...
        if ($cf_info->defaultdata !== '' && $cf_info->defaultdata !== null) {
            $fieldjoin = $joinname . '_fielddefault';
            $columnsql = "COALESCE(".
                $DB->sql_cast_char2float($columnsql).
                ", ".
                $DB->sql_cast_char2float($fieldjoin.".defaultdata").
                ")";
    ...
    /**
     * Adds text custom field to the $filteroptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     * @param array     $filteroptions
     */
    protected function add_totara_customfield_decimal_filters(\stdClass $cf_info, array &$filteroptions) {
        $name = $cf_info->fullname ?? $cf_info->name;
