...
trait text_report_trait {

    /**
     * Adds text custom field table to the $joinlist array
     *
    ...
    /**
     * Adds text custom field to the $columnoptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     ...
     */
    protected function add_totara_customfield_text_filters(\stdClass $cf_info, array &$filteroptions) {
        $name = isset($cf_info->fullname) ? $cf_info->fullname : $cf_info->name;
