...
trait date_report_trait {

    /**
     * Adds date custom field table to the $joinlist array
     *
    ...
    /**
     * Adds date custom field to the $columnoptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     * @param array     $columnoptions
     */
    protected function add_totara_customfield_date_columns(\stdClass $cf_info, array &$columnoptions) {
        global $DB;
        ...
        $columnoptions[] = new \rb_column_option(
            ...
            [
                'joins'       => $joinname,
                'displayfunc' => 'nice_date_no_timezone',
    ...
    /**
     * Adds date custom field to the $filteroptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
