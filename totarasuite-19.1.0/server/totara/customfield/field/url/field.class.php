...
class customfield_url extends customfield_base {
    ...
    public function edit_field_add(&$mform) {
        ...
        $urlgrp[] = $mform->createElement('static', uniqid("{$this->inputname}_urllabel_"), null, $urllabel)->set_allow_xss(true);
        ...
        $urlgrp[] = $mform->createElement('static', uniqid("{$this->inputname}_textlabel_"), null, $textlabel)->set_allow_xss(true);
