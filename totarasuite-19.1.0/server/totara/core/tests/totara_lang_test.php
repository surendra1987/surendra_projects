 ...
 */
class totara_core_totara_lang_test extends \core_phpunit\testcase {
    ...
    protected function verify_file($component, $file, $exceptions) {
        ...
        foreach ($string as $k => $v) {
            ...
            // No need to use Unicode stuff here, Moodle is not translated to Unicode. We put exception for capabilities
            if (stripos($v, 'moodle') !== false && !preg_match('/moodle\/[a-z]+:[a-z]+/', $v)) {
