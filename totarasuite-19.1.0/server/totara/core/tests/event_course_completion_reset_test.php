...
class totara_core_event_course_completion_reset_test extends \core_phpunit\testcase {
    public function test_event() {

        $course = $this->getDataGenerator()->create_course();

        $event = \totara_core\event\course_completion_reset::create_from_course($course);
        $event->trigger();
