...
Feature: Test tree select element
  ...
  Scenario: The tree select element should behave correctly
    ...
    # "Test tree list title 2 single level" is an accessibility label
    And I should see "Test tree list title 2 single level" in the "#title_testtreelist2.sr-only" "css_element"
