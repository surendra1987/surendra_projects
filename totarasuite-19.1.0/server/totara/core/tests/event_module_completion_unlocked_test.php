...
class totara_core_event_module_completion_unlocked_test extends \core_phpunit\testcase {
    ...
    public function test_event() {
        ...
        $event = \totara_core\event\module_completion_unlocked::create_from_module($modinfo);
        $event->trigger();
