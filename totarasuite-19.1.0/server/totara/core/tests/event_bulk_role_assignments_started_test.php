...
class totara_core_event_bulk_role_assignments_started_test extends \core_phpunit\testcase {
    public function test_event() {

        $course = $this->getDataGenerator()->create_course();
        $context = context_course::instance($course->id);

        $event = \totara_core\event\bulk_role_assignments_started::create_from_context($context);
        $event->trigger();
