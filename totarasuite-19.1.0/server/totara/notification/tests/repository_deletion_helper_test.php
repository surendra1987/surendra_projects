...
use totara_notification\repository\deletion_helper;
use totara_notification\testing\generator;
use totara_notification_mock_recipient as mock_recipient;

class totara_notification_repository_deletion_helper_test extends testcase {

    /**
     * @return void
     */
    public function test_delete_entries_from_notifiable_event_queue(): void {
        // Note: This is almost a duplicate of the test in \totara_notification_notifiable_event_queue_repository_testcase.
        // Despite the indirect coverage it can be useful to have the direct coverage of this method as well
        // as the methods in the repositories could potentially change
        ...
        deletion_helper::delete($repository, extended_context::make_with_context($category_context1));
