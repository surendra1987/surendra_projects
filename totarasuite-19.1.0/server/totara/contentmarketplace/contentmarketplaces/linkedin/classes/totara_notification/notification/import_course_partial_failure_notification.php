...
use contentmarketplace_linkedin\totara_notification\resolver\import_course_partial_failure;
use lang_string;
use totara_notification\notification\built_in_notification;
use totara_notification\schedule\schedule_on_event;

/**
 * Built in notification for event when import course is failure.
 */
class import_course_partial_failure_notification extends built_in_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return import_course_partial_failure::class;
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('import_course_partial_failure_body', 'contentmarketplace_linkedin');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('import_course_partial_failure_subject', 'contentmarketplace_linkedin');
    }
