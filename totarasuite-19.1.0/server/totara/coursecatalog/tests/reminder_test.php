...
class totara_coursecatalog_reminder_test extends \core_phpunit\testcase {
    /**
    ...
    public function test_reminder_email_substitutions() {
        ...
        $this->assertStringContainsString("Course URL: <a href='https://www.example.com/moodle/course/view.php?id={$course->id}'>https://www.example.com/moodle/course/view.php?id={$course->id}</a>", $newcontent);
