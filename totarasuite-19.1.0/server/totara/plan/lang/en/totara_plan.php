...
$string['backtoallcompetencies'] = 'All competencies';
$string['backtoallcourses'] = 'All courses';
$string['backtoallobjectives'] = 'All objectives';
$string['backtoallprograms'] = 'All programs';
...
$string['configenablelearningplans'] = 'When enabled, all links, menus, tabs and options related to learning plans will be accessible.';
...
$string['enablerecordoflearninginfo'] = 'When enabled, all features related to Record of Learning will be visible and accessible';
...
$string['invalidevidence'] = 'Invalid evidence';
$string['invalidevidence_with_name'] = 'Invalid evidence ({$a})';
...
$string['norecords'] = 'There are no records to display.';
...
$string['recordoflearning_inspire'] = 'Learn';
$string['remove'] = 'Select Linked {$a}';
$string['removea'] = 'Remove {$a}';
...
$string['userdrivenworkflowdesc'] = 'The user has control over their learning plan and can perform most actions themselves. The manager can also view and make changes to the plan.';
