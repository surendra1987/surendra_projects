...
$button = $OUTPUT->single_button('/totara/plan/objectivescales/index.php', get_string('allobjectivescales', 'totara_plan'), 'get');

// Display info about scale

echo $OUTPUT->page_main_heading(get_string('objectivescalex', 'totara_plan', format_string($objective->name)), $button);
