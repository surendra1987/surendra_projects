...
class development_plan {
    ...
    public array $description_editor;
    ...
    function load_roles() {
        ...
        foreach ($DP_AVAILABLE_ROLES as $role) {
            ...
            $this->rolenames[$rolename] = new $class($this);
        }
    ...
    function load_components() {
        ...
        foreach ($DP_AVAILABLE_COMPONENTS as $component) {
            ...
            // create an instance and save as a property for easy access
            $this->componentnames[$componentname] = new $class($this);
        }
    }
    ...
    public function get_component($component) {
        $componentname = "component_$component";
        return $this->componentnames[$componentname];
    }
    ...
    public function get_components() {
        ...
        foreach ($active_components as $component) {
            ...
            $components[$component->component] = $this->componentnames[$componentname];
        }
...
//                DP_APPROVAL_APPROVED,
     ...
     * @return true
     */
    function delete(bool $trigger_notification = false) {
        ...
        if ($trigger_notification) {
            if ($this->userid == $USER->id) {
                ...
                $this->send_alert_to_managers($learner, 'learningplan-remove','plan-remove-manager-short','plan-remove-manager-long', $a);
            } else {
                ...
                $this->send_alert_to_learner($manager, 'learningplan-remove', 'plan-remove-learner-short', 'plan-remove-learner-long', $a);
            }
        }
