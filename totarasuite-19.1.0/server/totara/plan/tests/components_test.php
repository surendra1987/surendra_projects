 ...
 */
class totara_plan_components_test extends \core_phpunit\testcase {
    ...
    public function test_get_assigned_competencies_linked() {
        ...
        $this->assertObjectNotHasProperty('linkedcourses', $assignedcompetency);
        $this->assertObjectNotHasProperty('linkedevidence', $assignedcompetency);
        ...
        $assignedcompetency = reset($assignedcomps);
        $this->assertObjectHasProperty('linkedcourses', $assignedcompetency);
        $this->assertEquals(2, $assignedcompetency->linkedcourses);
        $this->assertObjectHasProperty('linkedevidence', $assignedcompetency);
    ...
    public function test_get_assigned_courses_linked() {
        ...
        $this->assertObjectNotHasProperty('linkedcompetencies', $assignedcourse);
        $this->assertObjectNotHasProperty('linkedevidence', $assignedcourse);
        ...
        $assignedcourse = reset($assignedcourses);
        $this->assertObjectHasProperty('linkedcompetencies', $assignedcourse);
        $this->assertEquals(2, $assignedcourse->linkedcompetencies);

        // Check linked evidence count.
        $this->assertObjectHasProperty('linkedevidence', $assignedcourse);
    ...
    public function test_get_assigned_objectives_linked() {
        ...
        $this->assertObjectNotHasProperty('linkedcourses', $assignedobjective);
        $this->assertObjectNotHasProperty('linkedevidence', $assignedobjective);

        // Check linked course count.
        $assignedobjectives = $objectivecomponent->get_assigned_items(null, '', '', '', true);
        $assignedobjective = reset($assignedobjectives);
        $this->assertObjectHasProperty('linkedcourses', $assignedobjective);
        $this->assertEquals(3, $assignedobjective->linkedcourses);

        // Check linked evidence count.
        $this->assertObjectHasProperty('linkedevidence', $assignedobjective);
    ...
    public function test_get_assigned_programs_linked() {
        ...
        $this->assertObjectNotHasProperty('linkedevidence', $assignedprogram);

        // Get assigned items again with linked counts.
        $assignedprograms = $programcomponent->get_assigned_items(null, '', '', '', true);
        $assignedprogram = reset($assignedprograms);
        $this->assertObjectHasProperty('linkedevidence', $assignedprogram);
     ...
     *
     * The user's time due should be set to \totara_program\assignments\assignments::COMPLETION_TIME_NOT_SET.
     *
    ...
    public function test_dp_component_program_assign_new_item_existing_completion() {
        ...
        $this->program_generator->assign_to_program($program1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $user->id, null, true);
