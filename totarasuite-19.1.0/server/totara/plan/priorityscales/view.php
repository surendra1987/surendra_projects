...
$button = $OUTPUT->single_button(new moodle_url('/totara/plan/priorityscales/index.php'), get_string('allpriorityscales', 'totara_plan'), 'get');

// Display info about scale
echo $OUTPUT->page_main_heading(get_string('priorityscalex', 'totara_plan', format_string($priority->name)), $button);
