...
class dp_priority_scale_value_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('text', 'name', get_string('priorityscalevaluename', 'totara_plan'), 'maxlength="100"');
        ...
        $mform->addElement('text', 'idnumber', get_string('priorityscalevalueidnumber', 'totara_plan'), 'maxlength="100"');
        $mform->addHelpButton('idnumber', 'priorityscalevalueidnumber', 'totara_plan', '', true);
        $mform->setType('idnumber', PARAM_TEXT);

        $mform->addElement('text', 'numericscore', get_string('priorityscalevaluenumeric', 'totara_plan'), 'maxlength="100"');
