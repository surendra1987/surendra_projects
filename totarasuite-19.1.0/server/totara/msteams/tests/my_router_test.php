...
class totara_msteams_my_router_test extends botfw_jwks_base_testcase {
    /** @var stdClass */
    private $user;
    /** @var my_router */
    private $router;
    ...
    public static function data_send_message(): array {
        return [
            '??? personal' => [
                '???',
                false,
    ...
    public static function data_messaging_extension_initial_run(): array {
        return [
            [false],
            [true]
        ];
    ...
    public static function data_messaging_extension_search(): array {
        return [
    ...
    public function test_messaging_extension_search(bool $group, bool $forcelogin, bool $publishimage, bool $hasimage) {
        ...
        $this->assertEquals('Course', $json->composeExtension->attachments[0]->content->subtitle);
    ...
    public static function data_dispatcher_classes(): array {
        return [
