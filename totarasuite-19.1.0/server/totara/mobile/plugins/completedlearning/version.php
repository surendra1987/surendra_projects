...
$plugin->requires  = 2025070800;    // Requires this platform version.
$plugin->component = 'mobile_completedlearning'; // To check on upgrade, that module sits in correct place.
