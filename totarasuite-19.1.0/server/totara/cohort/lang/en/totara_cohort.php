...
$string['affectedarea'] = 'Affected area';
...
$string['areasaffectedbyaudiencedeletion'] = 'Areas affected by audience deletion';
...
$string['audiencedeletionnote'] = 'Note: course activities using this audience to restrict access will also be affected.';
...
$string['cannotdeletecohort'] = "Looks like you can't delete this audience.";
...
$string['cchdescall'] = 'User has completed all of the archived courses in this list:';
$string['cchdescany'] = 'User has completed any of the archived courses in this list:';
$string['cchdescnotall'] = 'User has not completed all of the archived courses in this list:';
$string['cchdescnotany'] = 'User has not completed any of the archived courses in this list:';
$string['certifoptionsselectone'] = 'Please select one or more options';
$string['changestomembers'] = 'Changes to audience members';
...
$string['completionarchivedrecords'] = 'Historic (archived) records:';
...
$string['completionusercompletedbeforeafter_history'] = 'User completed history:';
...
$string['copy'] = 'Copy';
$string['count_of_memberships_summary'] = 'A list of audience types, and a count of the number of audiences for each type.';
$string['count_of_rules_summary'] = 'A count of the number of rules per audience, organised into groups.';
$string['count_of_type_summary'] = 'A list of audience types, and a count of the number of audiences for each type.';
...
$string['crsenroldescall'] = 'User is enrolled to all of the courses in this list:';
$string['crsenroldescany'] = 'User is enrolled to any of the courses in this list:';
$string['crsenroldescnotall'] = 'User isn\'t enrolled to all of the courses in this list:';
$string['crsenroldescnotany'] = 'User isn\'t enrolled to any of the courses in this list:';
...
$string['datemenufixeddateafterandon'] = 'on or after';
$string['datemenufixeddatebefore'] = 'before';
$string['datemenufixeddatebeforeandon'] = 'before or on';
$string['delcohort'] = 'Delete audience';
$string['delconfirm'] = 'Do you really want to delete audience \'{$a}\'?';
$string['deleteaudience'] = 'Delete audience: {$a->name} ({$a->idnumber})';
$string['deletechangesdelete'] = 'Removed';
$string['deletechangeshidecerts'] = 'Hide certifications';
$string['deletechangeshidecourses'] = 'Hide courses';
$string['deletechangeshideprogs'] = 'Hide programs';
$string['deletechangessuspend'] = 'Suspend enrolment';
$string['deletechangessuspendenrolment'] = 'Suspend enrollment';
$string['deletechangesunassign'] = 'Unassign';
$string['deletechangesunassigndelete'] = 'Unassign and delete user data';
$string['deletechangesunassignsuspend'] = 'Unassign (and suspend in enrolled courses)';
$string['deletechangesunenroldelete'] = 'Unenrol and delete user data';
$string['deletecohort'] = 'Delete \'{$a}\'';
$string['deletecohortexplaination'] = 'By deleting this audience, all assignments, visibility, and access provided to audience members will be affected as shown below.';
...
$string['enrolmentmenuall'] = 'is enrolled to all';
$string['enrolmentmenuallpgm'] = 'is assigned to all';
$string['enrolmentmenuany'] = 'is enrolled to any';
$string['enrolmentmenuanypgm'] = 'is assigned to any';
$string['enrolmentmenunotall'] = 'is NOT enrolled to all';
$string['enrolmentmenunotallpgm'] = 'is NOT assigned to all';
$string['enrolmentmenunotany'] = 'is NOT enrolled to any';
$string['enrolmentmenunotanypgm'] = 'is NOT assigned to any';
...
$string['error:mustspecifyvalue'] = 'You must specify one valid number';
...
$string['manageaudincevisibilitya'] = 'Manage audience-based visibility for {$a}';
$string['max'] = 'No more than';
...
$string['msg:missing_tenant'] = 'Missing tenant';
...
$string['pgmenroldescall'] = 'User is assigned to all of the programs in this list:';
$string['pgmenroldescany'] = 'User is assigned to any of the programs in this list:';
$string['pgmenroldescnotall'] = 'User is not assigned to all of the programs in this list:';
$string['pgmenroldescnotany'] = 'User is not assigned to any of the programs in this list:';
...
$string['role'] = 'Role';
$string['rule_selector_all'] = 'All selected';
$string['rule_selector_any'] = 'Any selected';
$string['rule_selector_failure'] = 'Please select one or more options';
$string['rule_selector_is'] = 'Is';
$string['rule_selector_not'] = 'Is not';
...
$string['ruledesc-alljobassign-hasappraisees'] = 'User has appraisees in any of their job assignments.';
...
$string['ruledesc-learning-coursecompletionhistorydate'] = 'User\'s course completion history date';
$string['ruledesc-learning-coursecompletionhistorylist'] = 'User\'s historic course completion(s)';
$string['ruledesc-learning-coursecompletionlist'] = 'User\'s course completion(s)';
$string['ruledesc-learning-courseenrolmentlist'] = 'User\'s course enrolment(s)';
...
$string['ruledesc-learning-programenrolmentlist'] = 'User\'s program assignment(s)';
...
$string['ruledesc-user-tenantmember'] = 'User\'s tenant membership';
$string['ruledesc-user-timecreated'] = 'User\'s time created date';
$string['ruledesc-user-username'] = 'User\'s username';
$string['ruledialogdesc'] = 'based on {$a}';
...
$string['ruleformat-descjoin-isall'] = 'is all of the selected';
$string['ruleformat-descjoin-isany'] = 'is any of the selected';
$string['ruleformat-descjoin-notall'] = 'is not all of the selected';
$string['ruleformat-descjoin-notany'] = 'is not any of the selected';
...
$string['rulehelp-job-idnumber'] = 'Separate multiple IDs by commas e.g. "00101,00102"';
...
$string['rulelegend-alljobassign-hasappraisees'] = 'Total number of appraisees:';
...
$string['rulename-alljobassign-hasappraisees'] = 'Has appraisees';
...
$string['rulename-learning-coursecompletionhistorydate'] = 'Historic course completion date';
$string['rulename-learning-coursecompletionhistorylist'] = 'Historic course completion';
$string['rulename-learning-coursecompletionlist'] = 'Course completion';
$string['rulename-learning-courseenrolmentlist'] = 'Course enrolment';
...
$string['rulename-learning-programenrolmentlist'] = 'Program assignment';
...
$string['rulename-user-tenantmember'] = 'Tenant membership';
$string['rulename-user-timecreated'] = 'Time created date';
$string['rulename-user-username'] = 'Username';
$string['ruleneedsnoconfiguration'] = 'This rule needs no configuration.';
$string['rules'] = 'Rules';
$string['rules_used_summary'] = 'A list of audience rules used by dynamic audiences, and for each the number of times the rule has been used.';
...
$string['taskupdatecohortroles'] = 'Update audience\'s roles';
$string['text'] = 'Text';
...
If Audience-based visibility is set to anything other than “No users”, you can also exclude the course from the catalogue.';
...
/**
 * @deprecated Since Totara 20.0.0
 */
