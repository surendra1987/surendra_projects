 ...
 * vendor/bin/phpunit totara_cohort_course_completion_rules_test
 *
 */
class totara_cohort_course_completion_rules_test extends reportcache_advanced_testcase {
    ...
    */
     ...
     */
    public static function data_course_completion_date() {
        $data = array(
     ...
     */
    public static function data_course_completion_duration() {
        $data = array(
     ...
     */
    public static function data_course_completion_list() {
        $data = array(
