 ...
 */
class totara_cohort_user_custom_profile_field_checkbox_test extends \core_phpunit\testcase {
     ...
     */
    public static function data_checkbox_isequalto() {
        $data = array(
            array(array(1), 10),
            array(array(0), 44)
        );
     ...
     * Data provider for the checkbox profile field rule.
     */
    public static function data_checkbox_notequalto() {
        $data = array(
            array(array(1), 44),
            array(array(0), 10)
        );
