 ...
 *
 */
class totara_cohort_program_audiencevisibility_test extends \core_phpunit\testcase {
    ...
    protected function create_programs_with_availability() {
        ...
        $DB->set_field('prog', 'available', program::AVAILABILITY_TO_STUDENTS, array('id' => $this->program8->id));
