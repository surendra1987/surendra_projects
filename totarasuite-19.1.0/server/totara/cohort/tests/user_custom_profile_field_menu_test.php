 ...
 */
class totara_cohort_user_custom_profile_field_menu_test extends \core_phpunit\testcase {
     ...
     */
    public static function data_menu_isequalto() {
        $data = array(
     ...
     * Data provider for the menu profile field rule.
     */
    public static function data_menu_notequalto() {
        $data = array(
