@totara @totara_cohort @totara_hierarchy_goals
Feature: User with moodle/cohort:view can view but not manage audience details
  ...
  Background:
    ...
    And I switch to "Legacy goals" tab
    ...
    # Check that a notification about a task to be processed displays.
    And I should see "An update request is being processed, and changes will be applied by the system as soon as possible." in the "//div[@class='alert-message']" "xpath_element"
  ...
  Scenario: View audience management tabs with moodle/cohort:view capability in category context
    ...
    When I switch to "Legacy goals" tab
  ...
  Scenario: View audience management tabs with moodle/cohort:view capability in system context
    ...
    And I should see "Legacy goals" in the ".tabtree" "css_element"
    And I should not see "Edit details"
    And I should not see "Edit members"
    And I should not see "Learning Plan"
    And I should not see "Assign Roles"
