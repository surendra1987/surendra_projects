...
class totara_cohort_course_completion_history_rules_test extends reportcache_advanced_testcase {
    ...
    */
     ...
     */
    public static function data_history_course_completion_list() {
        $data = array(
     ...
     */
    public static function data_history_course_completion_date() {
        $data = array(
