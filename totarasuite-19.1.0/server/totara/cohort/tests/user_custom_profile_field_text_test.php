 ...
 */
class totara_cohort_user_custom_profile_field_text_test extends \core_phpunit\testcase {
     ...
     */
    public static function data_text_isequalto() {
        $data = array(
     ...
     * Data provider for the text profile field rule.
     */
    public static function data_text_notequalto() {
        $data = array(
     ...
     * Data provider for the text profile field rule.
     */
    public static function data_text_startswith() {
        $data = array(
            array(array('pot'), 10),
            array(array('bru'), 9),
            array(array('car'), 0),
     ...
     * Data provider for the text profile field rule.
     */
    public static function data_text_endswith() {
        // The following is what we expect:
        //     10 users with 'potato'
        //      9 users with 'brussels sprout'
        //      5 users with ''
     ...
     * Data provider for the text profile field rule.
     */
    public static function data_text_contains() {
        $data = array(
            array(array('potato'), 10),
            array(array('brussels sprout'), 9),
            array(array('carrot'), 0),
     ...
     * Data provider for the text profile field rule.
     */
    public static function data_text_notcontains() {
        $data = array(
            array(array('potato'), 44),
            array(array('brussels sprout'), 45),
            array(array('carrot'), 54),
