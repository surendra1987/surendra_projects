 ...
 * vendor/bin/phpunit totara_cohort_user_rules_test
 *
 */
class totara_cohort_user_rules_test extends reportcache_advanced_testcase {
     ...
     */
    public static function data_id_number() {
        $data = array(
     ...
     */
    public static function data_username() {
        $data = array(
            array(array('equal' => COHORT_RULES_OP_IN_STARTSWITH), array('user'), 53),
     ...
     */
    public static function data_email() {
        $data = array(
     ...
     */
    public static function data_firstname() {
        $data = array(
     ...
     */
    public static function data_lastname() {
        $data = array(
     ...
     */
    public static function data_city() {
        $data = array(
     ...
     */
    public static function data_institution() {
        $data = array(
     ...
     */
    public static function data_department() {
        $data = array(
     ...
     */
    public static function data_time_created() {
        $data = array(
