 ...
 * Tests util class.
 */
class totara_connect_util_test extends \core_phpunit\testcase {
    ...
    public function test_prepare_user_for_client() {
        ...
        $this->assertObjectNotHasProperty('picture', $result);
        $this->assertObjectNotHasProperty('pictures', $result);
        $this->assertObjectNotHasProperty('jobs', $result);
        ...
        $this->assertObjectNotHasProperty('secret', $result);
        $this->assertObjectHasProperty('picture', $result);
        ...
        $this->assertObjectHasProperty('jobs', $result);
        $this->assertCount(2, $result->jobs);

        $this->assertObjectNotHasProperty('managerjaid', $result->jobs[0]);
        $this->assertObjectNotHasProperty('managerjapath', $result->jobs[0]);
        $this->assertObjectNotHasProperty('tempmanagerjaid', $result->jobs[0]);
        $this->assertObjectNotHasProperty('tempmanagerexpirydate', $result->jobs[0]);
        $this->assertSame($ja1a->id, $result->jobs[0]->id);
        $this->assertSame($ja1a->idnumber, $result->jobs[0]->idnumber);

        $this->assertObjectNotHasProperty('managerjaid', $result->jobs[1]);
        $this->assertObjectNotHasProperty('managerjapath', $result->jobs[1]);
        $this->assertObjectNotHasProperty('tempmanagerjaid', $result->jobs[1]);
        $this->assertObjectNotHasProperty('tempmanagerexpirydate', $result->jobs[1]);
    ...
    public function test_prepare_user_for_client_icons() {
        ...
        $this->assertObjectNotHasProperty('picture', $user);
        $this->assertObjectNotHasProperty('pictures', $user);
    }
}
