 ...
 */
class totara_connect_sep_services_test extends \core_phpunit\testcase {
    ...
    public function test_get_users() {
        ...
        foreach ($result['data']['users'] as $k => $u) {
            ...
            $this->assertObjectNotHasProperty('secret', $u);
            $this->assertObjectNotHasProperty('picture', $u);
            $this->assertObjectNotHasProperty('pictures', $u);
            $this->assertObjectNotHasProperty('jobs', $u);
            if ($u->deleted) {
                $this->assertNull($u->description);
                $this->assertNull($u->descriptionformat);
            } else {
                $this->assertObjectHasProperty('description', $u);
                $this->assertObjectHasProperty('descriptionformat', $u);
            }
        }
        ...
        foreach ($result['data']['users'] as $k => $u) {
            if ($u->deleted) {
                $this->assertObjectNotHasProperty('jobs', $u);
                $this->assertObjectNotHasProperty('profile_fields', $u);
            } else {
    ...
    public function test_get_sso_user() {
        ...
        $this->assertSame('success', $result['status']);
        $this->assertCount(50, (array)$result['data']);
        ...
        $this->assertObjectNotHasProperty('secret', $user);
