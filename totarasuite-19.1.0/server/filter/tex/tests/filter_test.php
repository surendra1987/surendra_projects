 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class filter_tex_filter_test extends \core_phpunit\testcase {
    ...
    private function run_with_delimiters($start, $end, $filtershouldrun) {
        $pre = 'Some pre text';
        $post = 'Some post text';
        $equation = ' \sum{a^b} ';
    ...
    public function test_delimiters() {
