...
function(Y, $, log) {
    var notificationModule = {
        ...
        // Totara: Added method to clear notifications
        clearNotifications: function() {
            document.getElementById(notificationModule.fieldName).innerHTML = '';
        },
    ...
    return /** @alias module:core/notification */{
        ...
        /**
         * This clears all notifications from the page, it only affects visible notifications on the frontend
         *
