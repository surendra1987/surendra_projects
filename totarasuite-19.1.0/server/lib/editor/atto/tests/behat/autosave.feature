...
Feature: Atto Autosave
  ...
  Scenario: Undo draft restore
    ...
    Then ".editor_atto_notification" "css_element" should exist
    Then I should see "A draft version of this text was automatically restored. Select Undo to revert to the original version." in the ".editor_atto_notification" "css_element"
