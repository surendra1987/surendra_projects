...
$string['textrecoveredwithundo'] = 'A draft version of this text was automatically restored. Select Undo to revert to the original version.';
...
$string['userdataitemeditor_atto'] = 'Atto editor autosave';
$string['warningstatus'] = 'Warning';

/**
 * @deprecated since Totara 19
 */
$string['textrecoveredalert'] = 'Draft content has been automatically restored on this page. Further details are displayed next to each draft.';
