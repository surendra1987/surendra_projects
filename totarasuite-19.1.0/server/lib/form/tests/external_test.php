 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_form_external_test extends \core_phpunit\testcase {
    ...
    public function test_get_filetypes_browser_data() {
        ...
        $data = core_form\external::get_filetypes_browser_data('', true, '');
        $data = external_api::clean_returnvalue(core_form\external::get_filetypes_browser_data_returns(), $data);
