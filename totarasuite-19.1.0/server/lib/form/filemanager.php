...
class MoodleQuickForm_filemanager extends HTML_QuickForm_element implements templatable {
    ...
    function toHtml() {
        ...
        // Write the input tag, including context.
        $html .= html_writer::empty_tag('input', array('value' => $draftitemid, 'name' => $elname, 'type' => 'hidden', 'data-options-contextid' => $contextid));
