...
class core_ddl_ddl_test extends \core_phpunit\database_driver_testcase {
    ...
    public function test_for_reserved_words() {
        ...
        // Fields that were defined using a reserved word before the word became reserved
        $pre_reserved_words = [
            'chat_messages' => ['system'],
            'chat_messages_current' => ['system'],
            'cohort_plan_history' => ['manual'],
            'comp_record' => ['manual'],
            'dp_plan_course_assign' => ['manual'],
            'dp_plan_competency_assign' => ['manual'],
            'dp_plan_objective' => ['manual'],
            'dp_plan_program_assign' => ['manual'],
            'dp_plan_competency_value' => ['manual'],
        ];
        ...
        foreach ($tables as $table) {
            ...
            foreach ($fields as $field) {
                ...
                if (isset($pre_reserved_words[$tablename]) && in_array(strtolower($fieldname), $pre_reserved_words[$tablename], true)) {
                    // Totara: Skip reserved words introduced later
                    continue;
                }
     ...
     */
    public static function provider_enc_quoted() {
        return array(
