...
Y.extend(CONFIRM, M.core.notification.info, {
    ...
    initializer: function() {
        ...
        this._yesButton = Y.Node.create('<input type="button" class="btn btn-primary mr-3" id="id_yuiconfirmyes-' +
                                        this.get('COUNT') + '" value="' + this.get(CONFIRMYES) + '" />');
        this._noButton = Y.Node.create('<input type="button" class="btn btn-secondary mr-3" id="id_yuiconfirmno-' +
        ...
        this.setStdModContent(Y.WidgetStdMod.HEADER,
                '<h2 id="moodle-dialogue-' + this.get('COUNT') + '-header-text">' + this.get(TITLE) + '</h2>',
