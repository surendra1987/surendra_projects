...
$definitions = array(
    ...
    // Cache for file counts per context/filepath. Used by the file_info_stored
    // class.
    'files_context_filepath_count' => array(
        'mode' => cache_store::MODE_APPLICATION,
        'ttl' => 60 * 5, // 5 mins
        'simpledata' => true,

        // The filepath forms part of the key. However since the filepath can
        // have slashes, colons and dashes, the key can no longer be considered
        // as 'simple' according to server/cache/README.md
        'simplekeys' => false
    ),

    // Used to store the IDs of container course categories
    // @deprecated as of Totara 18
    'container_coursecat_ids' => array(
        'mode' => cache_store::MODE_APPLICATION,
        'simplekeys' => true,
        'simpledata' => true,
    ),

    // Used to store which models support encrypted entities
    'core_cipher_encrypted_models' => array(
        'mode' => cache_store::MODE_APPLICATION,
        'simplekeys' => true,
        'simpledata' => false, // Data is an array
    ),

    // Used to store user profile custom field definitions to avoid repetitive DB queries during HR import.
    'user_profile_custom_fields' => array(
        'mode' => cache_store::MODE_REQUEST,
        'simplekeys' => true,
        'simpledata' => true,
    ),
