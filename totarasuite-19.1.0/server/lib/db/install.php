...
function xmldb_main_install() {
    ...
    set_role_contextlevels($workspacecreatorrole, get_default_contextlevels('workspacecreator'));
    set_role_contextlevels($workspaceownerrole, get_default_contextlevels('workspaceowner'));
