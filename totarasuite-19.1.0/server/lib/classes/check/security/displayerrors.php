...
class displayerrors extends check {
    ...
    public function get_name(): string {
        return get_string('check_displayerrors_name', 'admin');
    }
    ...
    public function get_result(): result {
        $details = get_string('check_displayerrors_details', 'admin');

        if (defined('WARN_DISPLAY_ERRORS_ENABLED')) {
            $status = result::WARNING;
            $summary = get_string('check_displayerrors_error', 'admin');
        } else {
            $status = result::OK;
            $summary = get_string('check_displayerrors_ok', 'admin');
        }
