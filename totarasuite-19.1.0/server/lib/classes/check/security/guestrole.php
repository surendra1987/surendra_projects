...
class guestrole extends check {
    ...
    public function get_name(): string {
        return get_string('check_guestrole_name', 'admin');
    }
    ...
    public function get_action_link(): ?\action_link {
        return new \action_link(
            new \moodle_url('/admin/settings.php?section=userpolicies#admin-guestroleid'),
    ...
    public function get_result(): result {
        ...
        if (!$guestrole = $DB->get_record('role', ['id' => $CFG->guestroleid])) {
            ...
            $summary = get_string('check_guestrole_notset', 'admin');
        ...
        if ($riskycount or !$legacyok) {
            ...
            $summary = get_string('check_guestrole_error', 'admin', format_string($guestrole->name));

        } else {
            $status  = result::OK;
            $summary = get_string('check_guestrole_ok', 'admin');
        }

        $details = get_string('check_guestrole_details', 'admin');
