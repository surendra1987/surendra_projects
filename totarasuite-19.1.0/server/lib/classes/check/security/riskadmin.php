...
class riskadmin extends check {
    ...
    public function get_name(): string {
        return get_string('check_riskadmin_name', 'admin');
    }
    ...
    public function get_result(): result {
        ...
        $status  = result::INFO;
        $summary = get_string('check_riskadmin_ok', 'admin', $admincount);
        $details = get_string('check_riskadmin_detailsok', 'admin', $admins);
