...
class openprofiles extends check {
    ...
    public function get_name(): string {
        return get_string('check_openprofiles_name', 'admin');
    }
    ...
    public function get_result(): result {
        global $CFG;
        $details = get_string('check_openprofiles_details', 'admin');
        if (empty($CFG->forcelogin) and empty($CFG->forceloginforprofiles)) {
            $status = result::WARNING;
            $summary = get_string('check_openprofiles_error', 'admin');
        } else {
            $status = result::OK;
            $summary = get_string('check_openprofiles_ok', 'admin');
        }
