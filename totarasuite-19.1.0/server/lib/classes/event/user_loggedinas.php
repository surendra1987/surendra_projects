...
class user_loggedinas extends base {
    ...
    public function get_description() {
        $tenant_detail = '';
        if (!empty($this->other['tenant_id'])) {
            $tenant_id = $this->other['tenant_id'];
            $tenant_detail = " within the tenant of id '$tenant_id'";
        }
        return "The user with id '$this->userid' has logged in as the user with id '$this->relateduserid'$tenant_detail. ";
    }
