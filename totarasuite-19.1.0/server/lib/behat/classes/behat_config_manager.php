...
class behat_config_manager {
    ...
    public static function update_config_file($component = '', $testsrunner = true, $tags = '',
        ...
        // Totara: put the behat config into the test/behat directory to simplify execution.
        if (!$parallelruns) {
            file_put_contents(__DIR__ . '/../../../../test/behat/behat.yml', $contents);
        }
    }
    ...
    public final static function drop_parallel_site_links() {
        ...
        for ($i = 1; $i <= $parallelrun; $i++) {
            ...
            // Totara: make parallel runs possible on Windows
