...
* re-apply changes from TL-40293 to improve focus handling for modals
...
4/ YUI2 version 2.9.0 Tree View:
* improve a11y of tree view, cell before file name when there are no children is no longer tabbable
