...
class core_completionlib_test extends \core_phpunit\testcase {
     ...
     */
    public function local_assert_equals($expected, $actual, string $message = '', float $delta = 0.0, int $maxDepth = 10, bool $canonicalize = false, bool $ignoreCase = false): void {
    ...
    public function test_update_state() {
        $this->markTestIncomplete('TODO: TL-13942 write proper completion tests!');
    ...
    public function test_internal_get_state() {
        ...
        $this->local_assert_equals(COMPLETION_INCOMPLETE, $c->internal_get_state($cm, 123, $current));
        ...
        $cm->modname='label';
        $this->local_assert_equals(COMPLETION_COMPLETE, $c->internal_get_state($cm, 123, $current));
    ...
    public function test_count_user_data() {
        ...
        $c = new completion_info($course);
        $this->local_assert_equals(666, $c->count_user_data($cm));
    }
    ...
    public function test_get_data() {
        ...
        $this->local_assert_equals($sillyrecord, $result);
        ...
        $this->local_assert_equals((object)array(
        ...
        // Check result.
        $this->local_assert_equals($basicrecord, $result);
    }
    ...
    public function test_get_progress_all() {
        ...
        $this->local_assert_equals(array(
