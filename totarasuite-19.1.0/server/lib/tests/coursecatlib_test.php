 ...
 */
class core_coursecatlib_test extends \core_phpunit\testcase {
    ...
    public function test_get_children() {
        ...
        // Totara: test container categories.
        $container_children = coursecat::get(0)->get_children(['is_system' => 1]);
        $this->assertArrayHasKey($container1->id, $container_children);

        $container_children = coursecat::get(0)->get_children(['is_system' => 0]);
        $this->assertArrayNotHasKey($container1->id, $container_children);
    ...
    public function test_get_many() {
        ...
        $property = new ReflectionClass(\core_course\management\helper::class);
        $property->setStaticPropertyValue('expandedcategories', null);
        ...
        $property->setStaticPropertyValue('expandedcategories', null); // Clear that static property between each test.
