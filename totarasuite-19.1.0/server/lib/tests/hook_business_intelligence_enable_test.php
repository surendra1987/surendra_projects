...
class core_hook_business_intelligence_enable_test extends \core_phpunit\testcase {

    public function test_basic_operation() {
        $hook = new business_intelligence_enable('abc');

        self::assertSame('abc', $hook->pluginname);
