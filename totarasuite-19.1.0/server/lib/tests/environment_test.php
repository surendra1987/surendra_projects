 ...
 */
class core_environment_test extends \core_phpunit\testcase {
    /**
    ...
    public function test_normalize_version() {
        ...
        $this->assertSame('19.0', normalize_version('19.0'));
        $this->assertSame('19.0', normalize_version('19.0-alpha1'));
        $this->assertSame('19.0', normalize_version('19.0-beta1'));
        $this->assertSame('19.0', normalize_version('19.0-rc1'));
        $this->assertSame('15.0', normalize_version('15.0'));
        $this->assertSame('evergreen', normalize_version('evergreen'));
        $this->assertSame('evergreen', normalize_version('evergreen-dev'));
    }
    ...
    public function test_environment() {
        ...
        foreach ($environment_results as $environment_result) {
            if ($environment_result->part === 'php_setting'
                ...
                // OPCache extension is not necessary for unit testing.
                continue;
            }
            if ($environment_result->part === 'custom_check'
                ...
                // Up-to-date TLS libraries are not necessary for unit testing.
                continue;
            }
            if ($environment_result->part === 'php_extension'
                && $environment_result->info === 'sodium'
                && $environment_result->getLevel() === 'optional'
                && $environment_result->getStatus() === false
            ) {
                // Sodium extension is not necessary for unit testing.
                continue;
            }
