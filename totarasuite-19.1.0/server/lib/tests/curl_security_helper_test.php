 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_curl_security_helper_test extends \core_phpunit\testcase {
    /**
     ...
     * @return array
     */
    public static function curl_security_url_data_provider() {
     ...
     * @return array
     */
    public static function curl_security_settings_data_provider() {
     ...
     * @return array
     */
    public static function curl_security_host_data_provider() {
        return [
            // IPv4 hosts.
     ...
     * @return array
     */
    public static function curl_security_port_data_provider() {
        return [
            ["", "80\n443", true],
            [" ", "80\n443", true],
            ["-1", "80\n443", true],
