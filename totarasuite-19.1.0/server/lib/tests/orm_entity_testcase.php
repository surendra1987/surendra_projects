 ...
 * @group orm
 */
abstract class orm_entity_testcase extends \core_phpunit\testcase {
    ...
    protected function create_table() {
        ...
        $table->add_field('token', XMLDB_TYPE_CHAR, '1024');
    ...
    /**
     * Sets two master encryption keys to use for encrypted entity attribute tests.
     * Must call $this->reset_encryption_keys at the end.
     */
    protected function use_encryption_keys(): void {
        $this->setup_mock_key_manager();
        $this->use_mock_encryption_keys();
    }

    /**
     * @return void
     */
    protected function reset_encryption_keys(): void {
