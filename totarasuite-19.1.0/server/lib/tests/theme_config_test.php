 ...
 */
class core_theme_config_test extends \core_phpunit\testcase {
    /**
    ...
    public function test_is_or_inherits_from() {
        $theme = theme_config::load(theme_config::DEFAULT_THEME);
        $this->assertFalse($theme->is_or_inherits_from('ventura'));
        $this->assertTrue($theme->is_or_inherits_from('inspire'));
        $this->assertTrue($theme->is_or_inherits_from('legacy'));
    }
}
