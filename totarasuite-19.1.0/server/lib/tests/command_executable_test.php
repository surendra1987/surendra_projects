 ...
 */
class core_command_executable_test extends \core_phpunit\testcase {
    ...
    private function treat_as_web_request() {
        $iswebrequest = new ReflectionClass('\core\command\executable');
        $iswebrequest->setStaticPropertyValue('iswebrequest', true);
    }
    ...
    private function treat_as_cli() {
        $iswebrequest = new ReflectionClass('\core\command\executable');
        $iswebrequest->setStaticPropertyValue('iswebrequest', false);
    }
    ...
    private function enable_fake_pcntl($enable) {
        ...
        $iswebrequest = new ReflectionClass('\core\command\executable');
        $iswebrequest->setStaticPropertyValue('canusepcntl', $enable);
    }
