 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_markdown_test extends \core_phpunit\testcase {

    public function test_paragraphs() {
        $text = "one\n\ntwo";
        $result = "<p>one</p><p>two</p>";
        // Totara: strip newlines as we're testing the markup!
    ...
    public function test_headings() {
        $text = "Header 1\n====================\n\n## Header 2";
        $result = "<h1>Header 1</h1><h2>Header 2</h2>";
        // Totara: strip newlines as we're testing the markup!
        $actual = str_replace("\n", '', markdown_to_html($text));
        $this->assertSame($result, $actual);
    }
