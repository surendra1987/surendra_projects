...
use core\usagedata\enrolment_count_per_type;
use core_phpunit\testcase;

class core_usagedata_enrolment_count_per_type_test extends testcase {
    public function test_export(): void {
        ...
        $results = (new enrolment_count_per_type())->export();

        $this->assertEquals(3, $results['manual']);
    }
}