 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_ip_utils_test extends \core_phpunit\testcase {
    /**
     ...
     * @return array
     */
    public static function ip_address_data_provider() {
        return [
            ["127.0.0.1", true],
            ["10.1", false],
            ["0.0.0.0", true],
     ...
     * @return array
     */
    public static function ipv4_address_data_provider() {
        return [
            ["127.0.0.1", true],
            ["0.0.0.0", true],
            ["255.255.255.255", true],
     ...
     * @return array
     */
    public static function ipv4_range_data_provider() {
        return [
            ["127.0.0.1/24", true],
            ["127.0.0.20-20", true],
            ["127.0.0.20-50", true],
     ...
     * @return array
     */
    public static function ipv6_address_data_provider() {
        return [
            ["::", true],
            ["::0", true],
            ["0::", true],
     ...
     * @return array
     */
    public static function ipv6_range_data_provider() {
        return [
            ["::/128", true],
            ["::1/128", true],
     ...
     * @return array
     */
    public static function data_domain_addresses() {
        return [
            [true, 'example.com'],
     ...
     * @return array
     */
    public static function data_is_ip_in_subnet_list() {
        return [
