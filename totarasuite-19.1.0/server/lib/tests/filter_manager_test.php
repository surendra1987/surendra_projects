 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU Public License
 */
class core_filter_manager_test extends \core_phpunit\testcase {
    ...
    public function test_filter_normal() {
        ...
        $this->assertMatchesRegularExpression('~^<p><img class="icon emoticon" alt="smile" ([^>]+)></p>$~',
    ...
    public function test_one_filter_of_two_disabled() {
        ...
        $this->assertMatchesRegularExpression('~^<p><img class="icon emoticon" alt="smile" ([^>]+)> http://google.com/</p>$~',
