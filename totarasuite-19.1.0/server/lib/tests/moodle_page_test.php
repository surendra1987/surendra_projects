...
class core_moodle_page_test extends \core_phpunit\testcase {
    ...
    public function test_set_privacy_aware_title() {
        // Exercise SUT.
        $this->testpage->set_privacy_aware_title('a private title');
        // Validated.
        $this->assertSame('a private title', $this->testpage->privacy_aware_title);
    }
