...
$string['browsecohorts'] = 'Browse audiences';
...
$string['status_help'] = 'This setting determines whether users can be enrolled manually, via a link in the course administration settings, or by a user with appropriate permissions such as a trainer.';
