...
class enrol_ldap_ldap_test extends \core_phpunit\testcase {
     ...
     * @return array[]
     */
    public static function enrol_ldap_provider() {
    ...
    private function assertIsEnrolled($courseid, $userid, $roleid, $status=null) {
        global $DB;
    ...
    private function assertIsNotEnrolled($courseid, $userid) {
        $context = context_course::instance($courseid);
     ...
     */
    public static function objectclass_fetch_provider() {
        return array(
