 ...
 */
class core_enrol_totara_program_lib_test extends \core_phpunit\testcase {
    ...
    public function test_add_instance() {
        ...
        $plugin = enrol_get_plugin('totara_program');
        ...
        $new_enrol_period = DAYSECS * 3;
        $plugin->set_config('enrolperiod', $new_enrol_period);
        ...
        self::assertEquals($new_enrol_period, $enrol2->enrolperiod);
    }
}