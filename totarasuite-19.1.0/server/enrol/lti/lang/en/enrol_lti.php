...
$string['pluginname'] = 'Publish as LTI tool (Experimental)';
$string['pluginname_desc'] = 'The \'Publish as LTI tool\' plugin, together with the LTI authentication plugin, allows remote users to access selected courses and activities. In other words, Totara functions as an LTI tool provider.';
...
$string['roleinstructor'] = 'Role for trainer';
$string['roleinstructor_help'] = 'The role assigned in the tool to the remote trainer.';
$string['rolelearner'] = 'Role for learner';
$string['rolelearner_help'] = 'The role assigned in the tool to the remote learner.';
