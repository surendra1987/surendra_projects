 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_lti_helper_test extends \core_phpunit\testcase {
    ...
    public function test_update_user_profile_image() {
        ...
        $this->assertSame($CFG->wwwroot . '/pluginfile.php/' . $usercontext->id . "/user/icon/{$theme}/f2?rev=" .$this->user1->picture,
     ...
     */
    public static function set_xpath_provider() {
        return [
            "Correct structure" => [
                "parameters" => [
                    "/root" => [
    ...
    public function test_create_cartridge() {
        ...
        $this->assertStringContainsString("<blti:icon>$CFG->wwwroot/theme/image.php/_s/{$theme}/theme/1/favicon</blti:icon>", $cartridge);
