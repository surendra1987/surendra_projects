...
class core_tag_tag {
    ...
    public static function make_display_name($tag, $ashtml = true) {
        ...
        return $ashtml ? clean_string($tagname) : $tagname;
    }
     ...
     * @param    string   $join additional query to be appended as join
     * @return   array of matching objects, indexed by record id, from the table containing the type requested
     */
    public function get_tagged_items($component, $itemtype, $limitfrom = '', $limitnum = '', $subquery = '', $params = array(), $join ='') {
        global $DB;
     ...
     */
    public function count_tagged_items($component, $itemtype, $subquery = '', $params = array(), $join = '') {
        global $DB;
