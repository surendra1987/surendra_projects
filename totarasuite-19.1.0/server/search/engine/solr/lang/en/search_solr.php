...
$string['configsettings'] = 'Solr Configuration';
$string['connectionerror'] = 'The specified Solr server is not available or the specified index does not exist';
$string['connectionsettings'] = 'Connection settings';
$string['discardsearchfieldnames'] = 'Discard site default search field names';
$string['discardsearchfieldnames_help'] = 'When this setting is enabled, the default search field names will not be sent to the Solr search engine, thereby allowing Solr to specify its own search field names. This may improve the relevance of search results generated by Solr.
When disabled, default search field names are sent, thereby forcing Solr to ignore the search fields defined in the engine.';
