...
M.availability_grade.form.getNode = function(json) {
    ...
    html += '</select></span></label> <br><span class="availability-group form-group">' +
            '<label><input type="checkbox" class="form-check-input mx-3" name="min"/>' +
            ...
            '</span><input type="text" class="form-control mx-3" name="minval" title="' +
            M.util.get_string('label_min', 'availability_grade') + '"/></label>%</span><br>' +
            '<span class="availability-group form-group">' +
            '<label><input type="checkbox" class="form-check-input mx-3" name="max"/>' +
            ...
            '</span><input type="text" class="form-control mx-3" name="maxval" title="' +
