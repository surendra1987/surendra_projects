...
class question_category_object {
    ...
    /**
     * @var question_move_form Object representing form.
     */
    public $moveform;
    ...
    public function output_edit_lists() {
        ...
        echo $OUTPUT->heading_with_help(get_string('editcategories', 'question'), 'editcategories', 'question', '', '', 1);
        ...
        foreach ($this->editlists as $context => $list){
            ...
            if ($listhtml){
                ...
                echo $OUTPUT->heading(get_string('questioncatsfor', 'question', $fullcontext->get_context_name()), 2);
                echo $listhtml;
                echo $OUTPUT->box_end();
            }
        }
