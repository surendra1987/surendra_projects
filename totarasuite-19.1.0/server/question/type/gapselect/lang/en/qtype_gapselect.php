...
$string['pluginname_help'] = 'Select missing words questions require the respondent to select correct answers from dropdown menus. [[1]], [[2]], [[3]], etc. are used as placeholders in the question text, with the correct answers specified as choice answers 1, 2, 3, etc. respectively. Extra choice answers may be added to make the question harder. Choice answers may be grouped to restrict answers available in each dropdown menu.';
$string['pluginname_link'] = 'Question Types Quiz#QuestionTypesQuiz-Selectmissingwords';
