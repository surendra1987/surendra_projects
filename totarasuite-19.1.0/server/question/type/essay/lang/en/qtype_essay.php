...
$string['pluginname_help'] = 'In response to a question (that may include an image) the respondent writes an answer of a paragraph or two. The essay question will not be assigned a grade until it has been reviewed by a trainer and manually graded.';
$string['pluginname_link'] = 'Question Types Quiz#QuestionTypesQuiz-Essay';
...
$string['responseisrequired'] = 'Require the learner to enter text';
