...
$string['pluginname_link'] = 'Question Types Quiz#QuestionTypesQuiz-Multiplechoice';
...
$string['shuffleanswers_desc'] = 'Should the default for new multichoice questions be to shuffle answers?';
