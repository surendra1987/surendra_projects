...
Feature: Theme settings basic validations for tenants
  ...
  Scenario: Confirm that we can navigate to site theme settings
    ...
    And "Brand" "link" should exist in the ".tui-tabBar" "css_element"
    And "Colours" "link" should exist in the ".tui-tabBar" "css_element"
  ...
  Scenario: Confirm that all settings appear for tenant
    ...
    Then "Brand" "link" should exist in the ".tui-tabBar" "css_element"
    And "Colours" "link" should exist in the ".tui-tabBar" "css_element"
    And "Images" "link" should exist in the ".tui-tabBar" "css_element"
    And "Custom" "link" should exist in the ".tui-tabBar" "css_element"
    ...
    When I click on "Colours" "link" in the ".tui-tabBar" "css_element"
  ...
  Scenario: Edit tenant settings
    ...
    And I click on "Colours" "link" in the ".tui-tabBar" "css_element"
  ...
  Scenario: Log in as tenant domain manager and confirm that we can send test emails
    ...
    And I click on the "Custom tenant branding" tui toggle button
    And I click on "Brand" "link" in the ".tui-tabBar" "css_element"
