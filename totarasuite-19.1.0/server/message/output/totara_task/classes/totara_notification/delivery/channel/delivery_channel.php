...
namespace message_totara_task\totara_notification\delivery\channel;
...
/**
 * Class task_delivery_channel
 *
 * @package message_totara_task\totara_notification\delivery\channel
 */
class delivery_channel extends base_delivery_channel {
    ...
    public static function get_label(): string {
        return get_string('delivery_channel_label', 'message_totara_task');
    }
