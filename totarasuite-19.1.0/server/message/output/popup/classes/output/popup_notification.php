...
class popup_notification implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $string_field_formatter = new string_field_formatter(format::FORMAT_PLAIN, \context_system::instance());
        ...
        $context->subject = clean_param($string_field_formatter->format($context->subject), PARAM_TEXT);
        $context->contexturlname = clean_param($context->contexturlname, PARAM_TEXT);
        $context->shortenedsubject = shorten_text($string_field_formatter->format($context->subject), 125);
