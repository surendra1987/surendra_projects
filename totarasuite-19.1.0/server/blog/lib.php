...
function blog_get_headers($courseid=null, $groupid=null, $userid=null, $tagid=null) {
    ...
    if (!empty($entryid)) {
        ...
        $PAGE->set_privacy_aware_title("$shortname: " . get_string('userx', 'moodle', $user->id) . ": $entry->subject");
    ...
    if (!empty($userid) && empty($entryid) && ((empty($courseid) && empty($modid)) || !$CFG->useblogassociations)) {
        ...
        $PAGE->set_privacy_aware_title("$shortname: " . get_string('userx', 'moodle', $user->id) . ": " . get_string('blog', 'blog'));
        ...
        $PAGE->set_privacy_aware_title("$shortname: $cm->name: " . get_string('userx', 'moodle', $user->id) . ': ' . get_string('blogentries', 'blog'));
