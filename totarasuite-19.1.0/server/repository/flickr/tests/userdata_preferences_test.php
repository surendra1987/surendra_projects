 ...
 */
class repository_flickr_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \repository_flickr\userdata\preferences::class;
    }

    protected function get_preferences(): array {
        return [
            'flickr_' => ['abc123', '123abc'],
            'flickr_nsid' => ['abc123', '123abc']
        ];
    }
