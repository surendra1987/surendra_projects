...
if ($action === 'new') {
    ...
    if ($mform->is_cancelled()) {
        ...
        if ($result['status'] === 'success') {
            ...
            echo $OUTPUT->header();
            echo $OUTPUT->page_main_heading(get_string('register', 'repository_opensesame'));
    ...
    if ($mform->is_cancelled()) {
        ...
        if ($result['status'] === 'success') {
            ...
            echo $OUTPUT->header();
            echo $OUTPUT->page_main_heading(get_string('unregister', 'repository_opensesame'));
            if ($result['status'] === 'error') {
                $message = $result['message'];
            } else {
                $message = get_string('error');
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading(get_string('fetchall', 'repository_opensesame'));
...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading(get_string('registration', 'repository_opensesame'));
