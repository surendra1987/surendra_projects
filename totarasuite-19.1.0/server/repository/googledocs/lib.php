...
class repository_googledocs extends repository {
    ...
    */
    ...
    public static function type_config_form($mform, $classname = 'repository') {
        ...
        if (empty($a->docsurl)) {
            $oauth_info_text = get_string('oauthinfonohelplink', 'repository_googledocs', $a);
        } else {
            $oauth_info_text = get_string('oauthinfo', 'repository_googledocs', $a);
        }
        $mform->addElement('static', null, '', $oauth_info_text);
