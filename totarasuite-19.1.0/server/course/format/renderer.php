...
abstract class format_section_renderer_base extends plugin_renderer_base {
    ...
    protected function section_edit_control_menu($controls, $course, $section) {
        ...
        if (!empty($controls)) {
            ...
            $menu->set_action_label(get_string('edita', 'moodle', get_section_name($course, $section)));
    ...
    protected function section_header($section, $course, $onsectionpage, $sectionreturn=null) {
        ...
        $o .= html_writer::start_div('tw-format__headerContainer');
    ...
    protected function section_nav_selection($course, $sections, $displaysection) {
        ...
        $select->attributes['aria-label'] = get_string('jump_to_section');
