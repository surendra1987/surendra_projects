...
abstract class format_base {
    ...
    /**
     * Returns true if the course supports showing descriptions on its view page.
     *
     * This function describes whether a given course format has the capacity to display
     * an activity description. For courses without view pages, or where the view page is
     * reduced, this value should be inherited and set to false.
     *
     * @return boolean
     */
    ...
    /**
     * Check format supports incompatible activities or not.
     *
     * @return bool
     */
    ...
    /**
     * Does this format only support a single activity?
     *
     * @return string|null
     */
    public function is_single_activity(): bool {
        return false;
    }
}
