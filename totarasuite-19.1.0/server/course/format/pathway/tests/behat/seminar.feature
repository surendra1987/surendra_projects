@javascript @mod @mod_facetoface @totara @format_pathway
Feature: Course archive completions for seminar sessions in pathway
  ...
  Scenario: Set attendance for individual users in pathway
    ...
    And I click on "Course completion" "link" in the ".tui-format_pathway-courseToolbar" "css_element"
    ...
    And I click on "Show course administration" "button"
    And I click on "Reset completions" "link" in the ".tui-format_pathway-courseToolbar" "css_element"
    Then I should see "This action will affect 1 learner(s)"
  ...
  Scenario: Course completion archival of any time window in pathway
    Given the following "seminars" exist in "mod_facetoface" plugin:
      | name              | intro                           | course |
      | Test seminar name | <p>Test seminar description</p> | C1     |
    And the following "seminar events" exist in "mod_facetoface" plugin:
    ...
    And I am on "Course 1" course homepage
    And I click on "Mark as complete" "button"
    And I log out
    ...
    And I click on "Show course administration" "button"
    And I click on "Reports" "button" in the ".tui-format_pathway-courseToolbar" "css_element"
    # Use xpath as there are a number of "Course completion options in the menu
    And I click on "//div[contains(@class, 'tui-treeNode__child')]//div[contains(@class, 'tui-settingsNavigationTree__settingsItem')]//a[normalize-space(.)='Course completion']" "xpath_element"
    ...
    And I click on "Show course administration" "button"
    And I click on "Reset completions" "link" in the ".tui-format_pathway-courseToolbar" "css_element"
    Then I should see "This action will affect 9 learner(s)"
    When I press "Continue"
    Then I should see "9 users have had their progress and completion archived and reset in this course."
    ...
    Then I should see "Booked" in the "5:00 AM - 6:00 AM" "table_row"
    When I click on "Go to event" "link" in the "5:00 AM - 6:00 AM" "table_row"
    Then I should see "Not attended"
    But "Cancel" "link" should not exist
    And I log out
