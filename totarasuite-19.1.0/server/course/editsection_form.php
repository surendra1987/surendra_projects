...
class editsection_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addGroupRule('name_group', array('name' => array(array(get_string('maximumchars', '', 1024), 'maxlength', 1024))));
    ...
    function set_data($default_values) {
        ...
        // Section 0 name NULL means "leave title empty on course page", and empty string means "use default section 0 title, e.g. General".
        // For other sections, NULL or empty string both mean "use default title, eg Topic 1"
        $default_values->usedefaultname = $default_values->name === '' && !is_null($default_values->name);
    ...
    function get_data() {
        ...
        if ($data !== null) {
            ...
            // otherwise Set name as null when the name is empty string.
