...
Feature: Course category management interface performs as expected
  ...
  Scenario: Test general look of management interface
    ...
    And I should see "Course and category management" in the "#region-main h1" "css_element"
  ...
  Scenario: Test course pagination
    ...
    And I should see "5" in the ".course-listing-actions" "css_element"
    And I should see "10" in the ".course-listing-actions" "css_element"
    And I should see "20" in the ".course-listing-actions" "css_element"
    And I should see "All" in the ".course-listing-actions" "css_element"
  ...
  Scenario: Test many course pagination
    ...
    And I click on "Per page: 20" "link" in the ".course-listing-actions" "css_element"
    And I click on "100" "link" in the ".course-listing-actions" "css_element"
    And a new page should have loaded since I started watching
    And I start watching to see if a new page loads
    And I should see the "Course categories and courses" management page
