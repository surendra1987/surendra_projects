...
/**
 * @covers \core_course\local\archive_progress_helper\output\context\success_page
 */
class core_course_archive_progress_helper_output_context_success_page_test extends testcase {
