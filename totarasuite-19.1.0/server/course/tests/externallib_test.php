 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_course_externallib_test extends externallib_advanced_testcase {
    ...
    */
    ...
    public function test_update_courses() {
        ...
        $obj = new stdClass();
        $obj->duedate_op = course::DUEDATEOPERATOR_FIXED;
        $obj->duedate = 1420092000;
        $originalcourse2 = self::getDataGenerator()->create_course($obj);
        ...
        foreach ($courses as $course) {
            ...
            if ($course['id'] == $course2['id']) {
                ...
                $this->assertEquals(1420092000, $courseinfo->duedate);
