...
require_login(null, false, null, false, true); // Gotta be logged in (of course).
$PAGE->set_context(context_system::instance());
$PAGE->set_url(new moodle_url('/course/ajax/management.php'));
...
switch ($action) {
    ...
    case 'getsubcategorieshtml' :
        ...
        foreach ($subcategories as $subcat) {
            $outcome->html .= $renderer->category_listitem(
                $subcat,
                array(),
                $subcat->get_children_count(),
                null,
                [],
                $listing_index_current === 0,
