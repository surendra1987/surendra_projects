 ...
 */
class core_completion_helper_test extends \core_phpunit\testcase {
    ...
    public function test_get_course_completion_log_description() {
        ...
        $this->assertStringContainsString('6789', $description);
    ...
    public function test_load_course_completion() {
        ...
        $expectedcoursecompletion->duedate = null;
    ...
    public function test_load_course_completion_history() {
        ...
        $expectedhistorycompletion->grade = 456.00000;
        $expectedhistorycompletion->grademax = 0.00000;
        $expectedhistorycompletion->grademin = 0.00000;
     ...
     */
    public static function data_get_course_completion_errors() {
        return array(
     ...
     */
    public static function data_get_module_completion_errors() {
        return array(
     ...
     */
    public static function data_get_criteria_completion_errors() {
        return array(
