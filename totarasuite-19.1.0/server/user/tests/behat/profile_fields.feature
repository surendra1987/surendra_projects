...
"""
  ...
  Scenario: Can create and edit integer user profile fields
    Given I log in as "admin"
    And I navigate to "User profile fields" node in "Site administration > Users"
    And I set the following fields to these values:
      | datatype | integer |
    ...
    When I press "Save changes"
    Then I should see "Test number input"
    And I click on "Edit" "link" in the "Test number input" "table_row"
    And I set the following fields to these values:
      | Name | Test integer input |
    When I press "Save changes"
    Then I should see "Test integer input"
    When I click on "Delete" "link" in the "Test integer input" "table_row"
    Then I should not see "Test integer input"

  Scenario: Can create and edit decimal user profile fields
    Given I log in as "admin"
    And I navigate to "User profile fields" node in "Site administration > Users"
    And I set the following fields to these values:
      | datatype | decimal |
    ...
    And I set the following fields to these values:
      | Short name | float            |
      | Name       | Test float input |
    When I press "Save changes"
    Then I should see "Test float input"
    And I click on "Edit" "link" in the "Test float input" "table_row"
    And I set the following fields to these values:
      | Name | Test decimal input |
    When I press "Save changes"
    Then I should see "Test decimal input"
    When I click on "Delete" "link" in the "Test decimal input" "table_row"
    Then I should not see "Test decimal input"
