...
if ($user->id == -1 or ($user->id != $USER->id)) {
    if ($user->id == -1) {
        $createuser = get_string('createuser');
        $PAGE->set_title("$course->shortname: $createuser");
        echo $OUTPUT->header();
        echo $OUTPUT->page_main_heading(get_string('createuser'));
    } else {
        ...
        echo $OUTPUT->header();
        echo $OUTPUT->page_main_heading($userfullname);
    }
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading($streditmyprofile);
}
