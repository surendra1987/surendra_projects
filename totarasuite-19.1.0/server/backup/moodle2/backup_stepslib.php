...
class backup_course_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $course = new backup_nested_element('course', array('id', 'contextid'), array(
            ...
            // Totara:
            'containertype',
            'duedate', 'duedateoffsetamount', 'duedateoffsetunit',
            'is_totara_mobile_compatible',
            'exclude_from_course'
        ));
        ...
        $courserec->is_totara_mobile_compatible = $DB->record_exists('totara_mobile_compatible_courses', ['courseid' => $this->task->get_courseid()]);
        $courserec->exclude_from_course = $DB->record_exists('catalog_exclusions', ['objectid' => $this->task->get_courseid(), 'objecttype' => 'course']);
...
class backup_userscompletion_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $completion = new backup_nested_element('completion', array('id'), array(
            'userid', 'completionstate', 'progress', 'viewed', 'timemodified', 'timecompleted'));
...
class backup_users_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $anonfields = array(
            'username', 'idnumber', 'email', 'skype', 'phone1',
...
class backup_course_completion_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $coursecompletionhistory = new backup_nested_element('course_completion_history', array('id'), array(
            'courseid', 'userid', 'timecompleted', 'grade', 'grademax', 'grademin'
        ));
