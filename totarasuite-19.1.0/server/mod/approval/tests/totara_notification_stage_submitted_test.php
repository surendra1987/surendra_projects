 ...
 */
class mod_approval_totara_notification_stage_submitted_test extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        stage_submitted_activity::trigger_event($data->application1, $actor->id, []);
    ...
    public function test_get_scheduled_events(): void {
        ...
        $resolver_class_name = stage_submitted_resolver::class;
        ...
        application_activity_model::create(
            $data->application1,
            $actor1->id,
            stage_submitted_activity::class
        );
