...
use mod_approval\event\level_rejected as level_rejected_event;
 ...
 * @coversDefaultClass mod_approval\model\application\activity\level_rejected
 */
class mod_approval_application_activity_level_rejected_test extends mod_approval_testcase {
    /**
     * @covers ::get_type
     */
    public function test_get_type(): void {
        $this->assertEquals(23, level_rejected::get_type());
    }
    ...
    public function test_trigger_event(): void {
        ...
        level_rejected::trigger_event($application, $approver_user->id, []);
        ...
        $this->assertInstanceOf(level_rejected_event::class, $events[0]);
