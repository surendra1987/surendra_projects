 ...
 */
class mod_approval_totara_notification_level_started_test extends mod_approval_totara_notification_level_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        level_started_activity::trigger_event($data->application1, $actor->id, []);
