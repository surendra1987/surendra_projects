...
use mod_approval\totara_notification\resolver\stage_all_approved as stage_all_approved_resolver;
 ...
 */
class mod_approval_totara_notification_stage_all_approved_test extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $notification_generator->create_notification_preference(
            stage_all_approved_resolver::class,
            $extended_context,
            [
                'schedule_offset' => 0,
        ...
        stage_all_approved_activity::trigger_event($data->application1, $actor->id, []);
    ...
    public function test_get_scheduled_events(): void {
        ...
        $resolver_class_name = stage_all_approved_resolver::class;
        ...
        application_activity_model::create(
            $data->application1,
            $actor1->id,
            stage_all_approved_activity::class
        );
        ...
        self::assert_scheduled_events($resolver_class_name, $now - DAYSECS, $now - 1, [
            [
                ...
                'workflow_stage_id' => $data->workflow->versions->first()->stages->first()->id,
                'time_all_approved' => $now - HOURSECS
            ],
        ]);
