...
use mod_approval\model\application\activity\withdrawn as stage_withdrawn_activity;
...
use mod_approval\totara_notification\resolver\stage_withdrawn as stage_withdrawn_resolver;
 ...
 */
class mod_approval_totara_notification_stage_withdrawn_test extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        $notification_generator->create_notification_preference(
            stage_withdrawn_resolver::class,
            $extended_context,
            [
                'schedule_offset' => 0,
        ...
        stage_withdrawn_activity::trigger_event($data->application1, $actor->id, []);
    ...
    public function test_get_scheduled_events(): void {
        ...
        $resolver_class_name = stage_withdrawn_resolver::class;
        ...
        application_activity_model::create(
            $data->application1,
            $actor1->id,
            stage_withdrawn_activity::class
        );
