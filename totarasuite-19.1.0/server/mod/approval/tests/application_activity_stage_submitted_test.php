 ...
 * @coversDefaultClass mod_approval\model\application\activity\stage_submitted
 */
class mod_approval_application_activity_stage_submitted_test extends mod_approval_testcase {
    /**
     * @covers ::get_type
     */
    public function test_get_type(): void {
        $this->assertEquals(2, stage_submitted::get_type());
    }
    ...
    public function test_trigger_event(): void {
        ...
        stage_submitted::trigger_event($application, $approver_user->id, []);
        ...
        $this->assertInstanceOf(stage_submitted_event::class, $events[0]);
