...
use mod_approval\model\application\activity\stage_ended as stage_ended_activity;
...
use mod_approval\totara_notification\resolver\stage_ended as stage_ended_resolver;
 ...
 */
class mod_approval_totara_notification_stage_ended_test extends mod_approval_totara_notification_stage_base_testcase {
    ...
    public function test_custom_notification(): void {
        ...
        stage_ended_activity::trigger_event($data->application1, $actor->id, []);
    ...
    public function test_get_scheduled_events(): void {
        ...
        $resolver_class_name = stage_ended_resolver::class;
