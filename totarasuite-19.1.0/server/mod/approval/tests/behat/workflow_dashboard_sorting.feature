...
Feature: Sorting test of approval workflow dashboard
  Background:
  ...
  Scenario: mod_approval_821: Sort by Last modified
    When I set the field "Sort by" to "Last modified"
  ...
  Scenario: mod_approval_822: Sort by Workflow name
    When I set the field "Sort by" to "Workflow name"
    Then I should see the tui datatable contains:
      | Workflow name          | Type            | Assignment type | Assigned to     | Status   |
      | 11 Elven Workflow      | First Workflow  | Organisation    | Cool agency     | Draft    |
      | 12 Towelve Workflow    | First Workflow  | Organisation    | Mild agency     | Active   |
  ...
  Scenario: mod_approval_823: Sort resets pagination
