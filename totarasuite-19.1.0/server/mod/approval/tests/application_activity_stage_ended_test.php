 ...
 * @coversDefaultClass mod_approval\model\application\activity\stage_ended
 */
class mod_approval_application_activity_stage_ended_test extends mod_approval_testcase {
    /**
     * @covers ::get_type
     */
    public function test_get_type(): void {
        $this->assertEquals(64, stage_ended::get_type());
    }
    ...
    public function test_trigger_event(): void {
        ...
        stage_ended::trigger_event($application, $approver_user->id, []);
        ...
        $this->assertInstanceOf(stage_ended_event::class, $events[0]);
