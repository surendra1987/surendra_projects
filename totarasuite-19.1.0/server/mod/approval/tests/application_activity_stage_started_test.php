 ...
 * @coversDefaultClass mod_approval\model\application\activity\stage_started
 */
class mod_approval_application_activity_stage_started_test extends mod_approval_testcase {
    /**
     * @covers ::get_type
     */
    public function test_get_type(): void {
        $this->assertEquals(24, stage_started::get_type());
    }
    ...
    public function test_trigger_event(): void {
        ...
        stage_started::trigger_event($application, $approver_user->id, []);
        ...
        $this->assertInstanceOf(stage_started_event::class, $events[0]);
