...
/**
 * Manage the ordinal number of approval levels.
 */
final class level_ordinal implements ordinal {
    /**
     * @inheritDoc
     */
    public function table_name(): string {
        return workflow_stage_approval_level_entity::TABLE;
    }
    ...
    /**
     * @param workflow_stage_approval_level_model $item
     * @return integer
     */
