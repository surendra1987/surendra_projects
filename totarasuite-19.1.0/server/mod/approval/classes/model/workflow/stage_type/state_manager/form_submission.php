...
/**
 * Handles state of applications in a form_submission stage type.
 */
class form_submission extends base {
     ...
     * @inheritDoc
     */
    protected $stage_type = form_submission_stage_type::class;
    ...
    public function get_creation_state(): application_state {
        return new application_state($this->workflow_stage->id, true);
    }

    /**
     * @inheritDoc
     */
    public function on_application_start(application $application, int $actor_id): void {
