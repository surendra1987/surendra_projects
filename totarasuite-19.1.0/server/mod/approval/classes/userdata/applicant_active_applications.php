...
class applicant_active_applications extends item {
    ...
    protected static function purge(target_user $user, context $context): int {
        $collection = static::get_applicant_records($user, $context);
    ...
    public static function get_fullname_string(): array {
        return ['user_data_item_applicant_active_applications', 'mod_approval'];
    }
}
