...
/**
 * workflow_unarchive mutation.
 */
final class workflow_unarchive extends mutation_resolver {
    ...
    public static function resolve(array $args, execution_context $ec) {
        ...
        if (!$workflow->get_interactor($actor->id)->can_unarchive()) {
            throw access_denied_exception::workflow('Cannot unarchive workflow');
        }
        $workflow->unarchive();
