...
/**
 * Capability map for the view_draft_in_dashboard_application_applicant capability.
 */
class view_draft_in_dashboard_application_applicant extends capability_map_base {
    ...
    public static function get_table(): string {
        return 'approval_dashboard_draft_application_applicant';
    }
    ...
    public static function get_table_alias(): string {
        return 'dashboard_draft_applicant';
    }
}