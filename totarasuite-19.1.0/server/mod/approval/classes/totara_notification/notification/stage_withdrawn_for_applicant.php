...
use lang_string;
use mod_approval\totara_notification\resolver\stage_withdrawn;
use totara_notification\notification\built_in_notification;
use totara_notification\schedule\schedule_on_event;
use mod_approval\totara_notification\recipient\applicant;

final class stage_withdrawn_for_applicant extends built_in_notification {
    ...
    public static function get_title(): string {
        return get_string('notification:stage_withdrawn_for_applicant_title', 'mod_approval');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:stage_withdrawn_for_applicant_body', 'mod_approval');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:stage_withdrawn_for_applicant_subject', 'mod_approval');
    }
