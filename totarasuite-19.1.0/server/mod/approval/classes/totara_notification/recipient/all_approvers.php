 ...
 * Class approvers
 *
 * All the approvers involved in an application.
 *
 * @package mod_approval\totara_notification\recipient
 */
class all_approvers implements recipient {

    /**
     * @inheritDoc
     */
    public static function get_name(): string {
        return get_string('notification:recipient_all_approvers', 'mod_approval');
    }
    ...
    public static function get_user_ids(array $data): array {
        ...
        return $application->get_all_approvers()->keys();
    }
}