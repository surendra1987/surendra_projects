...
class level_rejected extends level_base implements scheduled_event_resolver {
    ...
    public static function get_notification_available_placeholder_options(): array {
        ...
        $options[] = placeholder_option::create(
            ...
            new lang_string('notification:placeholder_group_level_rejected', 'mod_approval'),
    ...
    public static function get_notification_title(): string {
        return get_string('notification:level_rejected_resolver_title', 'mod_approval');
    }
    ...
    public function get_fixed_event_time(): int {
        return $this->event_data['time_rejected'];
    }
