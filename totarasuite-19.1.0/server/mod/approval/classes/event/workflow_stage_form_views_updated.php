...
/**
 * Event triggered when the form views are updated.
 */
class workflow_stage_form_views_updated extends base {
    ...
    public static function execute(workflow_stage $workflow_stage): void {
        self::create([
            ...
            'other' => [
                ...
                'workflow_id' => $workflow_stage->workflow_version->workflow->id,
            ]
        ])->trigger();
    }
    ...
    public static function get_name(): string {
        return get_string('event_workflow_stage_form_views_updated', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_stage_form_views_updated_description',
            'mod_approval',
            [
                'userid' => $this->userid,
                'stage_id' => $this->objectid,
