...
/**
 * Event triggered when the details of a workflow is edited.
 */
class workflow_edited extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_edited', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_edited_description',
            'mod_approval',
            [
                'userid' => $this->userid,
                'workflow_id' => $this->objectid,
