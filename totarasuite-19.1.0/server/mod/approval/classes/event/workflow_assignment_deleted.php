...
/**
 * Event triggered when a workflow assignment is deleted.
 */
class workflow_assignment_deleted extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_assignment_deleted', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_assignment_deleted_description',
            'mod_approval',
            [
                'userid' => $this->userid,
