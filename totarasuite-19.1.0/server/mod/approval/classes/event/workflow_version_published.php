...
/**
 * Event triggered when a workflow version is published.
 */
class workflow_version_published extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_version_published', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_version_published_description',
            'mod_approval',
            [
                'userid' => $this->userid,
