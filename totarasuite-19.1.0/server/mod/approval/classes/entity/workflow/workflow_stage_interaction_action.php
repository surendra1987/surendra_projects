...
/**
 * Approval Workflow Stage Interaction Action entity
 *
 * Properties:
 ...
 * @property string $effect Classname of effect to execute for this action
 * @property string|null $effect_data JSON-encoded parameters for executing the effect
 ...
 */
class workflow_stage_interaction_action extends entity {

    public const TABLE = 'approval_workflow_stage_interaction_action';
