...
use approvalform_enrol\totara_notification\resolver\level_started;
use lang_string;
...
final class enrolment_level_started_for_level_approvers extends built_in_notification implements additional_criteria_notification {

    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return level_started::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification:enrolment_level_started_for_level_approvers_title', 'approvalform_enrol');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:enrolment_level_started_for_level_approvers_body', 'approvalform_enrol');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:enrolment_level_started_for_level_approvers_subject', 'approvalform_enrol');
    }
