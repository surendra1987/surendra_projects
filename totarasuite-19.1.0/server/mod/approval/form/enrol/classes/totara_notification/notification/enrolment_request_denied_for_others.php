...
final class enrolment_request_denied_for_others extends built_in_notification implements additional_criteria_notification {
    ...
    public static function get_title(): string {
        return get_string('notification:enrolment_request_denied_for_others_title', 'approvalform_enrol');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:enrolment_request_denied_for_others_body', 'approvalform_enrol');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:enrolment_request_denied_for_others_subject', 'approvalform_enrol');
    }
