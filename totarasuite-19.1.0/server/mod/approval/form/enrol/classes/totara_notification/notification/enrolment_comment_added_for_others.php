...
use approvalform_enrol\totara_notification\resolver\stage_comment_created;
use lang_string;
...
final class enrolment_comment_added_for_others extends built_in_notification {

    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return stage_comment_created::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification:enrolment_comment_added_for_others_title', 'approvalform_enrol');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:enrolment_comment_added_for_others_body', 'approvalform_enrol');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:enrolment_comment_added_for_others_subject', 'approvalform_enrol');
    }
