...
* **Embed**: The file is displayed within the page below the navigation bar together with the file description and other blocks.
...
* **Display link**: A link to the file is displayed within the page below the navigation bar together with the file description and other blocks.

Not all display options are available in all course formats and only enabled options will be available.';
...
$string['modulename_help'] = 'The file module enables a trainer to provide a file as a course resource. Where possible, the file will be displayed within the course interface; otherwise learners will be prompted to download it.
