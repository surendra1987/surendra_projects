...
class mod_wiki_wikiparser_test extends \core_phpunit\testcase {

    public function test_creole_markup() {
        $this->assertTestFiles('creole');
    }

    public function test_nwiki_markup() {
        $this->assertTestFiles('nwiki');
    }

    public function test_html_markup() {
