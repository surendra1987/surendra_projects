 ...
 * @since      Moodle 3.1
 */
class mod_wiki_externallib_test extends externallib_advanced_testcase {
    ...
    /**
     * Totara: This test case uses a ton of specific variables, rather than declare/define them all
     * we'll use a storage array for them instead.
     *
     * @param string $name
     * @return mixed|null
     */
