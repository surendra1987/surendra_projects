...
You can also use placeholders for the custom parameter values; for example, **username=$User.username**. Please refer to the documentation for a list of possible placeholders.
...
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this activity has its completion method set to require passing grade. Please set a non-zero value.';
$string['gradetopassnotset'] = 'This activity does not have a grade to pass set so you cannot use this option. Please use the require grade setting instead.';
...
$string['typename_help'] = 'The tool name is used to identify the tool provider within Totara. The name entered will be visible to trainers when adding external tools within courses.';
$string['types'] = 'Types';
