 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_chat_format_message_test extends \core_phpunit\testcase {

    const USER_CURRENT = 1;
    const USER_OTHER = 2;

    public static function chat_format_message_manually_provider() {
        $dateregexp = '\d{2}:\d{2}';
        return [
            'Beep everyone' => [
                'messagetext'   => 'beep all',
                'issystem'      => false,
                'willreturn'    => true,
            ...
            'Beep the current user' => [
                'messagetext'   => 'beep __CURRENTUSER__',
                'issystem'      => false,
                'willreturn'    => true,
            ...
            'Beep another user' => [
                'messagetext'   => 'beep __OTHERUSER__',
                'issystem'      => false,
                'willreturn'    => false,
                'expecttext'    => null,
                'refreshusers'  => null,
            ...
            'To user' => [
                'messagetext'   => 'To Bernard:I love tests',
                'issystem'      => false,
                'willreturn'    => true,
