...
class mod_lesson_renderer extends plugin_renderer_base {
    ...
    /// Header setup
        ...
        if (has_capability('mod/lesson:manage', $context)) {
            $output .= $this->output->heading_with_help($activityname, 'overview', 'lesson', '', '', 1);
            ...
            $output .= $this->output->page_main_heading($activityname);
        }
    ...
    public function add_first_page_links(lesson $lesson) {
        ...
        $output = $this->output->heading(get_string("whatdofirst", "lesson"), 2);
        $links = array();
    ...
    public function display_eol_page(lesson $lesson, $data) {
        ...
        if ($data->gradelesson) {
            ...
            $output .= $this->heading(get_string("congratulations", "lesson"), 2);
            $output .= $this->box_start('generalbox boxaligncenter');
        }
        ...
        if ($data->reviewlesson !== false) {
            $output .= html_writer::link($data->reviewlesson, get_string('reviewlesson', 'lesson'), array('class' => 'centerpadded lessonbutton standardbutton pr-3'));
        }
