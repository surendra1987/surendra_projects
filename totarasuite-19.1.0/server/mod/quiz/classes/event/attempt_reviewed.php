...
class attempt_reviewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' reviewed by the user " .
            "with id '$this->userid' for the quiz with course module id '$this->contextinstanceid'.";
    }
