 ...
 */
class mod_quiz_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \mod_quiz\userdata\preferences::class;
    }

    protected function get_preferences(): array {
        return [
            'quiz_report_pagesize' => [10, 2]
        ];
    }
