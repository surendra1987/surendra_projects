 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_responses_responses_from_steps_walkthrough_test extends mod_quiz_attempt_walkthrough_from_csv_test {

    protected const FILES = array('questions', 'steps', 'responses');
