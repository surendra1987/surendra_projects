 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_overview_report_test extends \core_phpunit\testcase {
     ...
     */
    public static function report_sql_cases() {
     ...
     * @return array
     */
    public static function get_bands_count_and_width_provider() {
        return [
            [10, [20, .5]],
            [20, [20, 1]],
            [30, [15, 2]],
