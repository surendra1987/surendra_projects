...
$string['bystudentfirstname'] = 'By learner first name';
$string['bystudentidnumber'] = 'By learner id number';
$string['bystudentlastname'] = 'By learner last name';
...
$string['grading:viewidnumber'] = 'See learner idnumbers while grading';
$string['grading:viewstudentnames'] = 'See learner names while grading';
...
$string['showstudentnames'] = 'Show learner names';
