 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_statistics_statistics_test extends \core_phpunit\testcase {
    ...
    private function qstats_q_fields($fieldname, $values, $multiplier=1) {
    ...
    private function get_fields_from_csv($line) {
        $line = trim($line);
    ...
    private function get_records_from_csv($filename) {
