 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_statistics_stats_from_steps_walkthrough_test extends mod_quiz_attempt_walkthrough_from_csv_test {

    protected const FILES = array('questions', 'steps', 'results', 'qstats', 'responsecounts');
     ...
     *
     * @param \core_phpunit\DataSet_Table[] of data read from csv file "questionsXX.csv",
     ...
     *
     * @param $qstats         \core_phpunit\DataSet_Table data from csv file.
