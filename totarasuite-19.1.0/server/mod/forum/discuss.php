...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading(format_string($forum->name));
echo $OUTPUT->heading(format_string($discussionname), 2, 'discussionname');
...
echo '<div class="discussioncontrols clearfix"><div class="controlscontainer mb-3">';
