 ...
 */
class mod_forum_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \mod_forum\userdata\preferences::class;
    }

    protected function get_preferences(): array {
        return [
            'forum_displaymode' => [0, 1, 2]
        ];
    }
