...
$string['analysis_title'] = '{$a} - analysis';
...
$string['newresponse'] = 'New Feedback response';
...
$string['show_entries_title'] = '{$a} - show responses';
...
$string['multichoice_edit_warning'] = 'Editing options for {$a} questions once there are already answers submitted may cause any potential issues with the data, like errors or missing information. We suggest deleting all existing responses before making any changes.';
