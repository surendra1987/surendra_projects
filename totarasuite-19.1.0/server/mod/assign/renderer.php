...
class mod_assign_renderer extends plugin_renderer_base {
    ...
    public function render_assign_gradingmessage(assign_gradingmessage $result) {
        ...
        $o = '';
        $o .= $this->output->heading($result->heading, 3);
    ...
    public function render_assign_submit_for_grading_page($page) {
        ...
        $o .= $this->output->heading(get_string('confirmsubmissionheading', 'assign'), 2);
        ...
        if (count($page->notifications)) {
            ...
            $o .= $this->output->heading(get_string('submissionnotready', 'assign'), 3);
    ...
    public function render_assign_header(assign_header $header) {
        ...
        $o .= $this->output->page_main_heading($heading);
    ...
    public function render_assign_grading_summary(assign_grading_summary $summary) {
        ...
        $o .= $this->output->heading(get_string('gradingsummary', 'assign'), 2);
    ...
    public function render_assign_feedback_status(assign_feedback_status $status) {
        ...
        $o .= $this->output->heading(get_string('feedback', 'assign'), 2);
    ...
    public function render_assign_submission_status_compact(assign_submission_status_compact $status) {
        ...
        $o .= $this->output->heading(get_string('submission', 'assign'), 2);
        $time = time();
    ...
    public function render_assign_submission_status(assign_submission_status $status) {
        $o = '';
        $o .= $this->output->container_start('submissionstatustable');
        $o .= $this->output->heading(get_string('submissionstatusheading', 'assign'), 2);
        $time = time();
    ...
    public function render_assign_attempt_history(assign_attempt_history $history) {
        ...
        $o .= $this->output->heading(get_string('attempthistory', 'assign'), 2);
        ...
        foreach ($history->submissions as $i => $submission) {
            ...
            $o .= $this->heading(get_string('attemptheading', 'assign', $attemptsummaryparams), 3);
     ...
     *
     * @param array $activities array of stdClasses from {@link assign_get_recent_mod_activity()}
    ...
    public function render_recent_activities(array $activities, bool $viewfullnames=true) :string {
        ...
        $output = html_writer::tag('h3', get_string('newsubmissions', 'assign') . ':', ['class' => 'sectionname']);
