...
class download extends query_resolver {
     ...
     * @return label
     */
    public static function resolve(array $args, execution_context $ec): label {
        return download_helper::get_downloadable_activity_content('label', $args['cm']);
    }
