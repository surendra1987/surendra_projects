...
$string['allowxss'] = 'Allow unsafe markup and files';
$string['allowxss_desc'] = 'If enabled all users authorised to add or update labels will be able to add unsafe markup and files to course labels.
