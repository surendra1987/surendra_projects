...
if ($showcommonelements ) {
    ...
    if ($mode == 'search') {
        echo '<input id="mod_glossary_search" type="text" name="hook" size="20" value="'.s($hook).'" alt="'.$strsearch.'" class="form-control mt-1"/> ';
    } else {
        echo '<input id="mod_glossary_search" type="text" name="hook" size="20" value="" alt="'.$strsearch.'" class="form-control mt-1"/> ';
    }
