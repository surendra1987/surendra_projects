...
if ( $hook >0 ) {
    ...
    if ( $action == "edit" ) {
        if ( $confirm ) {
            ...
            echo $OUTPUT->header();
            echo $OUTPUT->page_main_heading(format_string($glossary->name));
            echo $OUTPUT->heading(format_string(get_string("edit"). " " . get_string("category", "glossary")));
        ...
        if ( $confirm ) {
            ...
            echo $OUTPUT->header();
            echo $OUTPUT->page_main_heading(format_string($glossary->name));
            echo $OUTPUT->heading(format_string(get_string("delete"). " " . get_string("category", "glossary")));
...
<?php
    ...
    if ( $confirm ) {
        ...
        echo $OUTPUT->header();
        echo $OUTPUT->page_main_heading(format_string($glossary->name));
        echo "<h2 class=\"main\">" . get_string("add"). " " . get_string("category", "glossary"). "</h2>";
        $name="";
        require "editcategories.html";
    }
}
