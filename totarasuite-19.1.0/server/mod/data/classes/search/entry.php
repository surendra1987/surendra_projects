...
class entry extends \core_search\base_mod {
    ...
    protected function get_fields_for_entries($entry) {
        ...
        foreach ($filteredcontents as $content) {
            ...
            // Totara: $template is a nullable field, which throws deprecations if a null is used in strpos
            $content->addtemplateposition = $template !== null ? strpos($template, '[['.$content->fldname.']]') : false;
        }
