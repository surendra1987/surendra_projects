...
final class facilitator_assigned_for_facilitator extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return facilitator_assigned::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification_facilitator_assigned_for_facilitator_title', 'mod_facetoface');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_facilitator_assigned_for_facilitator_body', 'mod_facetoface');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_facilitator_assigned_for_facilitator_subject', 'mod_facetoface');
    }
