...
final class booking_confirmed_for_manager extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return booking_confirmed::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification_booking_confirmed_for_manager_title', 'mod_facetoface');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_booking_confirmed_for_manager_body', 'mod_facetoface');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_booking_confirmed_for_manager_subject', 'mod_facetoface');
    }
