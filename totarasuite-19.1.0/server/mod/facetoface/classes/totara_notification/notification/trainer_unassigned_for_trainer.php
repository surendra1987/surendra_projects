...
final class trainer_unassigned_for_trainer extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return trainer_unassigned::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification_trainer_unassigned_for_trainer_title', 'mod_facetoface');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_trainer_unassigned_for_trainer_body', 'mod_facetoface');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_trainer_unassigned_for_trainer_subject', 'mod_facetoface');
    }
