...
final class event_cancelled_for_event_roles extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return event_cancelled::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification_event_cancelled_for_event_roles_title', 'mod_facetoface');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_event_cancelled_for_event_roles_body', 'mod_facetoface');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_event_cancelled_for_event_roles_subject', 'mod_facetoface');
    }
