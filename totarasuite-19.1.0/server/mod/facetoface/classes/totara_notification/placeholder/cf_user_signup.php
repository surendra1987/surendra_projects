...
/**
 * This class represents the custom field: user sign-ups on the seminar notification object.
 */
class cf_user_signup extends single_emptiable_placeholder {
    use placeholder_instance_cache;

    /** @var ?signup_object */
    private ?signup_object $signup;
    ...
    public static function get_options(): array {
        return customfield_options::get_options('facetoface_signup');
    }
    ...
    public function do_get(string $key): string {
        ...
        $field_map = customfield_options::get_key_field_map('facetoface_signup');
