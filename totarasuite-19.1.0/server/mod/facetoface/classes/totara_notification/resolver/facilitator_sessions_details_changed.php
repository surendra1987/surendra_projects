...
class facilitator_sessions_details_changed extends seminar_resolver_base implements additional_criteria_resolver {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_facilitator_sessions_details_changed_title', 'mod_facetoface');
    }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_facilitator_sessions_details_changed',
