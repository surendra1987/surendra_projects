...
class booking_request_created extends seminar_resolver_base implements additional_criteria_resolver {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_booking_request_created_title', 'mod_facetoface');
    }
        ...
        return [
            ...
            placeholder_option::create(
                ...
                function (array $event_data): placeholder_signup {
                    return placeholder_signup::from_event_id_and_user_id($event_data['seminar_event_id'], $event_data['user_id']);
                }
            ),
            placeholder_option::create(
                'user_signup',
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_booking_request_created',
