...
use mod_facetoface\totara_notification\placeholder\cf_signup_cancellation as placeholder_signup_cancellation;
...
class booking_cancelled extends seminar_resolver_base implements additional_criteria_resolver {
    ...
    public static function get_notification_available_placeholder_options(): array {
        return [
            ...
            placeholder_option::create(
                'user_cancellation',
                placeholder_signup_cancellation::class,
                new lang_string('notification_placeholder_group_signup_cancellation', 'mod_facetoface'),
                function (array $event_data): placeholder_signup_cancellation {
                    return placeholder_signup_cancellation::from_event_id_and_user_id(
                        $event_data['seminar_event_id'],
                        $event_data['user_id']
                    );
                }
