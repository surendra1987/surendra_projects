...
use mod_facetoface\totara_notification\placeholder\event_cancellation as placeholder_event_cancellation;
use mod_facetoface\totara_notification\recipient\event_role;
...
class event_cancelled extends seminar_resolver_base implements additional_criteria_resolver {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_event_cancelled_title', 'mod_facetoface');
    }
    ...
    public static function get_notification_available_placeholder_options(): array {
        return [
            ...
            placeholder_option::create(
                'event_cancellation',
                placeholder_event_cancellation::class,
                new lang_string('notification_placeholder_event_cancellation', 'mod_facetoface'),
                function (array $event_data): placeholder_event_cancellation {
                    return placeholder_event_cancellation::from_event_id($event_data['seminar_event_id']);
                }
            ),
            placeholder_option::create(
                'course',
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_event_cancelled',
