...
class manager_reservations_cancelled extends seminar_resolver_base {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_manager_reservations_cancelled_title', 'mod_facetoface');
    }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        $course = placeholder_user::from_id($this->get_event_data()['user_id']);
        $params['user'] = $course->do_get('full_name');
        ...
        return [
            'key' => 'notification_log_manager_reservations_cancelled',
