...
class facilitator_assigned extends seminar_resolver_base implements additional_criteria_resolver {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_facilitator_assigned_title', 'mod_facetoface');
    }
    ...
    public function get_attachments(notification_preference $preference, $user): array {
        ...
        if ($this->needs_icals($preference)) {
            $attachments = self::get_facilitator_ical_attachments($this->event_data, $user, MDL_F2F_INVITE);
        }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        $user = placeholder_user::from_id($this->get_event_data()['facilitator_user_id']);
        ...
        return [
            'key' => 'notification_log_facilitator_assigned',
