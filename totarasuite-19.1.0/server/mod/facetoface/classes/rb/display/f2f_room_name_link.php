...
class f2f_room_name_link extends base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        ...
        $params['roomid'] = $extrafields->roomid;
        // Add sdid if present.
        if (isset($extrafields->sessionsdateid)) {
            $params['sdid'] = $extrafields->sessionsdateid;
        }

        return \html_writer::link(
            new \moodle_url('/mod/facetoface/reports/rooms.php', $params),
            $value
        );
    }
