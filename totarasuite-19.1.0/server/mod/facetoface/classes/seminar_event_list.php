...
final class seminar_event_list implements \Iterator, \Countable {
    ...
    /**
     * Get list of all seminar events in an specific course.
     *
     * @param int $courseid
     * @return seminar_event_list
     */
    public static function get_by_course(int $courseid): seminar_event_list {
        global $DB;
        ...
        $seminarevents = $DB->get_records_sql($sql, ['courseid' => $courseid]);
