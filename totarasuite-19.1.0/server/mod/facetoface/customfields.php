...
switch ($action) {
    case 'showlist':
        ...
        echo $OUTPUT->page_main_heading(get_string('customfieldsheading', 'facetoface'));
    ...
    case 'deletefield':
        ...
        echo $OUTPUT->header();
        echo $OUTPUT->page_main_heading(get_string('customfieldsheadingaction', 'facetoface', get_string('delete')));
        echo $facetofacerenderer->customfield_management_tabs($prefix);
    ...
    case 'editfield':
        ...
        $heading = $OUTPUT->page_main_heading(get_string('customfieldsheadingaction', 'facetoface', $datatypes[$datatype]));
