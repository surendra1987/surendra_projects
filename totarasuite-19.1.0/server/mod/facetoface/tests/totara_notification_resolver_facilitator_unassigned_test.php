...
class mod_facetoface_totara_notification_resolver_facilitator_unassigned_test extends testcase {
    ...
    public function test_resolver(bool $site_allow_legacy, bool $use_legacy): void {
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => facilitator_unassigned::class,
                ...
                'event_name' => get_string('notification_log_facilitator_unassigned', 'mod_facetoface', [
                    'resolver_title' => facilitator_unassigned::get_notification_title(),
