...
use mod_facetoface\totara_notification\resolver\signup_waitlisted;
 ...
 */
class mod_facetoface_totara_notification_resolver_signup_waitlisted_test extends testcase {
            ...
            [
                ...
                'body' => document_helper::json_encode_document(
                    document_helper::create_document_from_content_nodes([
                        paragraph::create_json_node_from_text('User signup waitlisted notification body'),
     ...
     */
    public function test_resolver_signup_waitlisted(bool $site_allow_legacy, bool $use_legacy): void {
        global $DB;
        ...
        // Call the function that the UI uses when the signup waitlist is created.
        \mod_facetoface\notice_sender::confirm_waitlist($signup, MDL_F2F_BOTH);
        ...
        self::assertStringContainsString('User signup waitlisted notification body', $message->fullmessage); // Body
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => signup_waitlisted::class,
                ...
                'event_name' => get_string('notification_log_signup_waitlisted', 'mod_facetoface', [
                    'resolver_title' => signup_waitlisted::get_notification_title(),
