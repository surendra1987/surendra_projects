 ...
 */
class mod_facetoface_totara_notification_resolver_manager_reservations_cancelled_test extends testcase {
    ...
    protected function setUp(): void {
        ...
        $this->system_custom_preference = $notification_generator->create_notification_preference(
            manager_reservations_cancelled::class,
    ...
    public function test_resolver(bool $site_allow_legacy, bool $use_legacy): void {
        ...
        self::assertEquals(2, $DB->count_records(
            notifiable_event_queue::TABLE,
            ['resolver_class_name' => manager_reservations_cancelled::class]
        ));
        self::assertEquals(0, $DB->count_records(notification_queue::TABLE));
        ...
        self::verify_notification_logs([
            [
                ...
                'event_name' => get_string('notification_log_manager_reservations_cancelled', 'mod_facetoface', [
                    'resolver_title' => manager_reservations_cancelled::get_notification_title(),
