...
/**
 * Check activity support mobile download or not.
 *
 * @param $cm The coursemodule record.
 * @return bool
 */
function scorm_support_mobile_download($cm): bool {
    global $DB;

    $scorm = $DB->get_record('scorm', ['id' => $cm->instance]);

    return $scorm->allowmobileoffline;
}