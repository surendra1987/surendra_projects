 ...
 */
class mod_scorm_webapi_resolver_type_scorm_test extends \core_phpunit\testcase {
     ...
     * @return void
     */
    public function test_resolve_completion_status(): void {
        $scorm = array_pop($this->scorms);

        // Check that each core instance of learning item gets resolved correctly.
        $value = $this->resolve('completionstatus', $scorm);
        self::assertEquals('incomplete', $value);
    }

    /**
     * @return void
     */
    public function test_resolve_downloadsize(): void {
        $scorm = array_pop($this->scorms);

        // Check that each core instance of learning item gets resolved correctly.
        $value = $this->resolve('downloadsize', $scorm);
     ...
     * @return void
     */
    public function test_resolve_attachments(): void {
        $scorm = array_pop($this->scorms);

        // Check that each core instance of learning item gets resolved correctly.
        $value = $this->resolve('attachments', $scorm);
