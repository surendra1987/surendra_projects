...
$string['allowmobileoffline'] = 'Allow offline attempts in mobile app';
$string['allowmobileoffline_desc'] = 'If enabled, direct package download will be available for mobile app users regardless of the \'Protect package downloads\' setting';
$string['allowmobileoffline_help'] = 'If enabled, a learner will be able to download this SCORM package using the mobile app to complete their attempts offline. Note: Only compatible with SCORM 1.2.';
...
$string['check_sessionkeepalive_details'] = '<p>If enabled user session is kept alive in SCORM player.</p>';
$string['check_sessionkeepalive_name'] = 'SCORM session keep alive';
$string['check_sessionkeepalive_ok'] = 'Standard session timeout is enforced in SCORM player.';
$string['check_sessionkeepalive_warning'] = 'Keeping user session alive in SCORM player may be considered to be a small security issue.';
...
$string['errornoaddnewpackage'] = 'You are not allowed to add new unknown SCORM packages';
...
$string['packagecurrent'] = 'Current package';
$string['packagedeletetrust'] = 'Delete package trust';
$string['packagedeletetrustconfirm'] = 'Do you want to remove "{$a->contenthash}" from the list of known trusted package content hashes?

This will not affect existing SCORM activities. Content hash will be added to the list again if there is a new SCORM activity created using a package with this content hash.';
...
$string['packagetrusted'] = 'Trusted package';
...
$string['protectpackagedownloads_desc'] = 'If enabled, SCORM packages can be downloaded only if the user has the course:manageactivities capability, or by mobile users if the \'Allow offline attempts in mobile app\' setting is enabled. If disabled, SCORM packages can always be downloaded.';
...
$string['scorm:addinstance'] = 'Add a new SCORM activity';
$string['scorm:addnewpackage'] = 'Upload a new unknown SCORM package';
...
$string['scorm:managetrustedpackages'] = 'Manage list of known trusted SCORM packages';
