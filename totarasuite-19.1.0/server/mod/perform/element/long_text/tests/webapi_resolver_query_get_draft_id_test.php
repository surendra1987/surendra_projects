 ...
 */
class performelement_long_text_webapi_resolver_query_get_draft_id_test extends mod_perform_weka_testcase {

    private const QUERY = 'performelement_long_text_get_draft_id';
