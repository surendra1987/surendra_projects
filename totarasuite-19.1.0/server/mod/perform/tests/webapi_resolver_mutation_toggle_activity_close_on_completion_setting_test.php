...
/**
 * @coversDefaultClass \mod_perform\webapi\resolver\mutation\toggle_activity_close_on_completion_setting
 *
 * @group perform
 *
 * @deprecated since Totara 19.0 See webapi_resolver_mutation_update_activity_workflow_settings_test instead.
 */
class mod_perform_webapi_resolver_mutation_toggle_activity_close_on_completion_setting_test extends testcase {
    private const MUTATION = 'mod_perform_toggle_activity_close_on_completion_setting';

    private const MUTATION_DEPRECATED = "The mutation 'toggle_activity_close_on_completion_setting' had been deprecated, please use mod_perform_update_activity_workflow_settings instead";
