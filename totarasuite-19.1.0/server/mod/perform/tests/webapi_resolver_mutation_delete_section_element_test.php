 ...
 * @group perform
 */
class mod_perform_webapi_resolver_mutation_delete_section_element_test extends section_element_manager_testcase{
    private const MUTATION = 'mod_perform_delete_section_element';

    use webapi_phpunit_helper;

    public function test_delete_section_element_success() {
