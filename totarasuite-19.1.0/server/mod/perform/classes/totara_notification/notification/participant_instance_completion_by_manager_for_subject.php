...
final class participant_instance_completion_by_manager_for_subject extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    ...
    public static function get_title(): string {
        return get_string('notification_participant_instance_completion_by_manager_title', 'mod_perform');
    }
