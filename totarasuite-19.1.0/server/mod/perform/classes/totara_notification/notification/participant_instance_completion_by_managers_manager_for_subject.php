...
final class participant_instance_completion_by_managers_manager_for_subject extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    ...
    public static function get_title(): string {
        return get_string('notification_participant_instance_completion_by_managers_manager_title', 'mod_perform');
    }
    ...
    public static function get_default_additional_criteria(): string {
        return '{"submitted_by":["managers_manager"]}';
    }
