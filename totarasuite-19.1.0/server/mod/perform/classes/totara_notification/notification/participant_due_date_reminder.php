...
final class participant_due_date_reminder extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_due_date_reminder_participant_body', 'mod_perform');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_due_date_reminder_participant_subject', 'mod_perform');
    }
