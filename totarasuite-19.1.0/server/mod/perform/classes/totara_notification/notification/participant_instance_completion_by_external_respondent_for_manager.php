...
final class participant_instance_completion_by_external_respondent_for_manager extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    ...
    public static function get_title(): string {
        return get_string('notification_participant_instance_completion_by_external_respondent_title', 'mod_perform');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_participant_instance_completion_by_participant_body', 'mod_perform');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_participant_instance_completion_by_participant_subject', 'mod_perform');
    }
    ...
    public static function get_default_additional_criteria(): string {
        return '{"submitted_by":["perform_external"]}';
    }
