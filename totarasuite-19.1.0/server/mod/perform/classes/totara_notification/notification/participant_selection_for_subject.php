...
final class participant_selection_for_subject extends built_in_notification {
    /**
     * @return string
     */
    ...
    public static function get_recipient_class_name(): string {
        return participant_selector_subject::class;
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_select_participant_subject_user_body', 'mod_perform');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_select_participant_subject_user_subject', 'mod_perform');
    }
