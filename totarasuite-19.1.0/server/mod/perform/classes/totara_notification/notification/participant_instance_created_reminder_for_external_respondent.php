...
final class participant_instance_created_reminder_for_external_respondent extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_instance_created_reminder_for_external_user_body', 'mod_perform');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_instance_created_reminder_for_external_user_subject', 'mod_perform');
    }
    ...
    public static function get_default_additional_criteria(): string {
        return '{"recipients":["perform_external"]}';
    }
