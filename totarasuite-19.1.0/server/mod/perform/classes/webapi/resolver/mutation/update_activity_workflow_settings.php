 ...
 * @deprecated since Totara 19.0 Use update_activity_closure_settings instead.
 */
class update_activity_workflow_settings extends mutation_resolver {
    ...
    public static function resolve(array $args, execution_context $ec) {
        debugging(
            "The mutation 'update_activity_workflow_settings' had been deprecated, please use mod_perform_update_activity_closure_settings instead",
            DEBUG_DEVELOPER
        );
