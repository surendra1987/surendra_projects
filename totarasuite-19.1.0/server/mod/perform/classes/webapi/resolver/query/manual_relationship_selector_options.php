...
/**
 * @deprecated since Totara 19.0 Use 'mod_perform_activity_controls' instead.
 *
 ...
 */
class manual_relationship_selector_options extends query_resolver {
    ...
    public static function resolve(array $args, execution_context $ec) {
        debugging(
            "The query 'mod_perform_manual_relationship_selector_options' had been deprecated, please use 'mod_perform_activity_controls' instead",
            DEBUG_DEVELOPER
        );
