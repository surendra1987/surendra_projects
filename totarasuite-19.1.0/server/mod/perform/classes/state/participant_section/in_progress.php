...
use mod_perform\state\participant_section\condition\all_answers_complete_or_manual_close_enabled;
...
class in_progress extends participant_section_progress {
    ...
    public function get_transitions(): array {
        return [
            ...
            transition::to(new complete($this->object))->with_conditions([
                all_answers_complete_or_manual_close_enabled::class
            ]),
    ...
    public function on_enter(): void {
        $this->update_latest_progression_time();
    }
