...
class personal_goal_viewed extends base {
    ...
    /**
     * Create an event when a personal goal is viewed
     *
    ...
    public static function get_name() {
        return get_string('event_goal_viewed', 'perform_goal');
    }
    ...
    public function get_description() {
        $for = ($this->relateduserid && $this->relateduserid != $this->userid)
            ...
            : '';
        return "The user with id '{$this->userid}' has viewed a personal goal with id '{$this->objectid}'{$for}";
    }
}