...
class goal_category_activated extends base {
    ...
    /**
     * Create an event when a goal_category is activated.
     *
    ...
    public static function get_name() {
        return get_string('event_goal_category_activated', 'perform_goal');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has activated the goal_category with id '{$this->objectid}'";
    }
}