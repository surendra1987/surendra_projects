...
class personal_goal_created extends base {
    ...
    /**
     * Create an event when a personal goal is created
     *
    ...
    public static function get_name() {
        return get_string('event_goal_created', 'perform_goal');
    }
    ...
    public function get_description() {
        $for = ($this->relateduserid && $this->relateduserid != $this->userid)
            ...
            : '';
        return "The user with id '{$this->userid}' has created a personal goal with id '{$this->objectid}'{$for}";
    }
}