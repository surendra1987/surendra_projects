...
/**
 * Does GDPR related processing for goal statuses changed by a subject in
 * a perform activity.
 */
class perform_goal_status_change_self extends perform_goal_status_change {
    /**
     * {@inheritdoc}
     */
    ...
    protected static function purge(target_user $user, \context $context) {
        static::goal_status_query($user->id)->delete();
