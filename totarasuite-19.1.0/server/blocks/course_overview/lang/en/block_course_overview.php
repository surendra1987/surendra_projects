...
$string['course_overview:myaddinstance'] = 'Add a new course overview block to My learning';
...
$string['forcedefaultmaxcoursesdesc'] = 'If set then user will not be able to change their personal setting';
