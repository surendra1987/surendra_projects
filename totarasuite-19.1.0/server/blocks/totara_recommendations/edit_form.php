...
class block_totara_recommendations_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        if (advanced_feature::is_enabled('programs')) {
            $block_options[block_mode_factory::BLOCK_PROGRAMS] = get_string('programs', 'totara_program');
        }
        if (advanced_feature::is_enabled('certifications')) {
            $block_options[block_mode_factory::BLOCK_CERTIFICATIONS] = get_string('certifications', 'totara_certification');
        }
