...
$string['defaultnameoptions_desc'] = 'How should the learners be identified by default?';
$string['defaultshowgroups'] = 'Default show groups';
$string['defaultshowgroups_desc'] = 'Show groups instead of learners by default (only if the activity supports groups)';
