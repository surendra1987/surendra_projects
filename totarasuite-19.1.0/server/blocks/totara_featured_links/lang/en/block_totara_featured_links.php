...
$string['align_justified'] = 'Justified';
...
$string['shape_fullwidth_no_margins'] = 'Full width (no page margins)';
...
$string['user_placeholder_group'] = 'User {$a}';
