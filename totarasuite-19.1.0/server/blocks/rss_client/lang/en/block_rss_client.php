...
$string['enableautodiscovery_help'] = 'If enabled, feeds on web pages are found automatically.';
...
$string['rss_client:myaddinstance'] = 'Add a new RSS feeds block to My learning';
