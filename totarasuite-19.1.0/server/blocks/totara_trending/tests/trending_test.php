...
use block_totara_trending\task\refresh_totara_trending_data_task;
...
/**
 * @group block_totara_trending
 */
class block_totara_trending_trending_test extends testcase {
    /**
    ...
    public function test_refresh_totara_trending_data_task(): void {
        ...
        $count = $DB->count_records(totara_trending::TABLE);
    ...
    private function execute_trending_task(): int {
        ...
        // Confirm we see nothing
        return $DB->count_records(totara_trending::TABLE);
    }
}
