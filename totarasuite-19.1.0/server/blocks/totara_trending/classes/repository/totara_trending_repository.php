...
namespace block_totara_trending\repository;

use core\orm\entity\repository;
use block_totara_trending\entity\totara_trending;
use core\orm\query\builder;
use core\orm\query\order;
use core\orm\collection as collection;
use totara_core\advanced_feature;

final class totara_trending_repository extends repository {
    ...
    public function get_cached_trending_content(int $max_count): array {
        ...
        } elseif (!empty($CFG->tenantsisolated)) {
    ...
    public function get_trending_components(array $components, int $days): array {
        ...
        return $DB->get_records_sql($sql, $params, 0, $CFG->block_totara_trending_overctr);
    }
     ...
     *
     */
    public function truncate_totara_trending(): void {
        global $DB;
