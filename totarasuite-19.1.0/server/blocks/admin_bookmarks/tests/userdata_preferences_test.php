 ...
 */
class block_admin_bookmarks_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \block_admin_bookmarks\userdata\preferences::class;
    }
