...
EOF;
    ...
    public function documentation_html($functions, $printableformat, $activatedprotocol,
        ...
        $documentationhtml = $this->output->page_main_heading(get_string('wsdocapi', 'webservice'));
...
EOF;
        ...
        // Expand all button
        $authparams['expand'] = true;
        $url = new moodle_url($parenturl, $authparams); // Required
        $documentationhtml .= $this->output->single_button($url, get_string('expandall', 'webservice'));
