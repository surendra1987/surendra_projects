...
// Check for an authorization error and handle it.
$error = optional_param('error', '', PARAM_ALPHAEXT);
$description = optional_param('error_description', '', PARAM_TEXT);

if ($error) {
    $lang_key = \core\oauth2\api::map_error_to_lang_key($error);
    print_error($lang_key, 'error', '', '', $description);
}
