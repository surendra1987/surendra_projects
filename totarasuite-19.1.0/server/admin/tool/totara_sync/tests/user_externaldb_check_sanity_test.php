 ...
 */
class tool_totara_sync_user_externaldb_check_sanity_test extends \core_phpunit\testcase {
    ...
    public function setUp(): void {
        ...
        // Causes the 36th record to fail due to truncated records.
        $this->getDataGenerator()->create_user(array('idnumber' => 'idnum036', 'totarasync' => 1));
    }
    ...
    public function test_check_sanity_sub_checks_with_null() {
        ...
        // Get truncated records.
        $badids = $element->check_user_truncated_records($synctable);
        $this->assertEquals(array(36), $badids);
        $this->assertEquals('data_exceeded_length', $DB->get_field($synctable, 'username', array('idnumber' => 'idnum036')));
