...
// Start page.
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading(get_string('maketestplan', 'tool_generator'));

// Information message.
$context = context_system::instance();
$markdownlink = '[' . tool_generator_testplan_backend::get_repourl() . '](' . tool_generator_testplan_backend::get_repourl() . ')';
echo $OUTPUT->box(format_text(get_string('testplanexplanation_v2', 'tool_generator', $markdownlink),
