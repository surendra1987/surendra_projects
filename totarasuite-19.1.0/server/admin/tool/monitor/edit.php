...
if ($mformdata = $mform->get_data()) {
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading(get_string('managerules', 'tool_monitor'));
    $mform->set_data($rule);
...
echo $OUTPUT->header();
if (!empty($ruleid)) {
    echo $OUTPUT->page_main_heading(get_string('editrule', 'tool_monitor'));
} else {
    echo $OUTPUT->page_main_heading(get_string('addrule', 'tool_monitor'));
}
$mform->set_data($rule);
$mform->display();
echo $OUTPUT->footer();
