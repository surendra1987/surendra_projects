    ...
    public function export_for_template(\renderer_base $output): array {
        $tabs = [
            'tabs' => [
                ...
                [
                    'id' => 'slowest_graphql',
                    'link' => [['link' => new \moodle_url('/admin/tool/excimer/slowest_graphql.php')]],
                    'title' => get_string('report_slowest_graphql', 'tool_excimer'),
                    'text' => get_string('tab_slowest_graphql', 'tool_excimer'),
                ],
                [
                    'id' => 'slowest_other',
