    ...
    public function on_interval(manager $manager) {
        ...
        foreach ($log as $sample) {
            ...
            if ($taskname && ($this->tasksampleset === null)) {
                ...
                // Ensure this only adds the mem usage for the initial base sample due to accuracy.
                if ($memoryusage) {
        ...
        static::$isinsideoninterval = false;
    }
