...
$string['crondelaymodule'] = 'Recently deleted resources / activities are being processed and will appear in this recycle bin soon. Try refreshing the page or come back later.'; // TOTARA TL-16427.
...
$string['deletecheckrecyclebin'] = 'It will be recoverable for a limited time from the course recycle bin.'; // TOTARA TL-16427.
