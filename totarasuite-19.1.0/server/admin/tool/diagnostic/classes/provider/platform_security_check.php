 ...
 */
class platform_security_check extends base {

    /** @var int */
    protected static $order = 130;

    /**
     * @inheritDoc
     */
    public static function get_id(): string {
        return 'platform_security_check';
    }
    ...
    public function get_content(): content {
        ...
        $content->set_data($this->get_security_check_info());
     ...
     * @return string
     */
    private function get_security_check_info(): string {
