...
#    Test for TL-20139 regression
  ...
  @javascript
#    Test for TL-44495 regression
  Scenario: Tours should be visible when targeting Inspire navigation items
    Given I log in as "admin"
    And I set the site theme to "inspire"
    And I add a new user tour with:
      | Name                | First tour |
      | Description         | My first tour |
      | Apply to URL match  | /totara/dashboard/% |
    ...
    And I add steps to the "First tour" tour:
      | targettype                  | targetvalue_selector | Title             | Content |
      | Selector                    | #uid-1-items > li:nth-child(1) | Going Home     | This is the home button. It will return you to your homepage. |
    When I am on "Dashboard" page
    And I wait "1" seconds
    Then I should see "This is the home button. It will return you to your homepage."
    And "[id^='tour-step-tool_usertours']" should be in viewport