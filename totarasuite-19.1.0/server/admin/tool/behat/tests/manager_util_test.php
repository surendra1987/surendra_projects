 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_behat_manager_util_test extends \core_phpunit\testcase {
    ...
    public function test_get_config_file_contents_with_single_run() {
        ...
        $mockbuilder->onlyMethods(array('get_theme_test_directory', 'get_list_of_themes', 'get_default_theme'));
