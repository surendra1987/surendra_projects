...
$string['errorsymlink'] = 'There is no symlink to the xhprof HTML present. Without it you cannot access the xhprof profiling reports.<br><br>Please create it by running the command:';
