...
// session to be working properly in order to edit admin account
 if (!empty($CFG->adminsetuppending)) {
    ...
    if ($adminuser->password === 'adminsetuppending') {
        ...
        complete_user_login(
            $adminuser,
            \core\login\complete_login_callback::create('admin_setup_complete_login_callback', [$adminuser->id])
        );
...
if (!has_capability('moodle/site:config', $context)) {
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading($SITE->fullname);
    echo $OUTPUT->footer();
    exit;
}
...
echo $output->admin_notifications_page($maturity, $insecuredataroot, $errorsdisplayed, $cronoverdue, $dbproblems,
                                       ...
                                       null, $cachewarnings, $eventshandlers, $themedesignermode, false, null, $activeusers, $TOTARA->release, $activeusers3mth, $croninfrequent);
