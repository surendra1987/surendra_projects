...
Please check the MySQL MAX_EXECUTION_TIME value and increase it prior to running this script, as it could take a long time to run.
...
Please be aware of the implications of a collation change. Especially
switching between *_unicode_ci and *_general_ci collations can lead to
unexpected effects in certain cases as these are different rulesets for
