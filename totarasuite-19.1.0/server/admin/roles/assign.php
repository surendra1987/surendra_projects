...
// Print heading.
echo $OUTPUT->heading_with_help($title, 'assignroles', 'core_role', '', '', 1);
...
<?php
    ...
    echo $OUTPUT->heading(get_string('notabletoassignroleshere', 'core_role'), 2);
    ...
    // Print instruction.
    echo $OUTPUT->heading(get_string('chooseroletoassign', 'core_role'), 2);
