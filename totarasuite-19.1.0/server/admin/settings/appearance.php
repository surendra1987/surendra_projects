...
preferences,moodle|/user/preferences.php|preferences',
    ...
    $temp->add(new admin_setting_configcheckbox('allowunsafemarkup', new lang_string('allowunsafemarkup', 'admin'), new lang_string('allowunsafemarkupdescription', 'admin'), 0));
    ...
    if (totara_catalog_admin_setting_catalogtype::is_totara()) {
        $choices[HOMEPAGE_TOTARA_GRID_CATALOG] = new lang_string('totaracatalogue', 'admin');
    }
    $setting = new totara_core_admin_setting_defaulthomepage(
        'defaulthomepage',
    ...
    $temp = new admin_settingpage('totaradashboardsettings', new lang_string('dashboard_settings', 'totara_dashboard'), 'totara/dashboard:manage');
    $temp->add(new admin_setting_configcheckbox(
        'totara_dashboard/show_title',
        new lang_string('show_dashboard_titles', 'totara_dashboard'),
        new lang_string('show_dashboard_titles_desc', 'totara_dashboard'),
        1
    ));
    $ADMIN->add('navigationcat', $temp, 'navigation');
    ...
    $temp->add(
        new admin_setting_configcheckbox(
            'course_heading_visible',
            new lang_string('course_heading_visible', 'admin'),
            new lang_string('course_heading_visible_desc', 'admin'),
            1
        )
    );
    ...
    } elseif ($CFG->catalogtype == 'enhanced') {
    ...
    $temp->add(new admin_setting_configcheckbox('use_legacy_course_sortorder',
            new lang_string('use_legacy_course_sortorder', 'admin'),
            new lang_string('use_legacy_course_sortorder_desc', 'admin'), 0));
