...
$page_has_required_fields = admin_any_settings_required($adminroot);
if ($page_has_required_fields) {
    echo '<div>';
    echo get_string('somefieldsrequired', 'form', $OUTPUT->flex_icon('required', ['classes' => 'form-required']));
    echo '</div>';
}
