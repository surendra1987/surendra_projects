...
$string['completion-manual'] = 'Manual completion of {$a}';
...
$string['completionondatevalue'] = 'Apply to all enrolled users on';
 ...
 */
$string['placeholder_activity_completion_date'] = 'Date';
$string['placeholder_course_completion_date'] = 'Date';
$string['placeholder_course_due_date'] = 'Due date';
$string['placeholder_group_activity_completion'] = 'Activity completion {$a}';
$string['placeholder_group_course_completion'] = 'Course completion {$a}';
