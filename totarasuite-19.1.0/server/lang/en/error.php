...
$string['cannotcreatedbnamemysql'] = 'Bad database name. Allowed characters are: basic Latin letters, digits 0-9, dollar, underscore and unicode range U+0080..U+FFFF.';
...
$string['circulardependency'] = 'There is a circular dependency between "{$a->current_node}" and "{$a->dependent_node}".';
$string['circulardependencyin'] = 'There is a circular dependency in "{$a->current_node}".';
...
$string['dbusemariadb'] = 'Incorrect database type detected, $CFG->dbtype must be set to "mariadb" instead of "mysqli" in config.php';
$string['dbusemysql'] = 'Incorrect database type detected, $CFG->dbtype must be set to "mysqli" instead of "mariadb" in config.php';
...
$string['disabledplugin'] = 'The {$a} plugin is not enabled.';
...
$string['mimetexisnotexist'] = 'Your system is not configured to run mimeTeX. You need to obtain the C source from <a href="http://www.forkosh.com/mimetex.zip">http://www.forkosh.com/mimetex.zip</a>, compile it and put the executable into your filter/tex/ directory.';
...
$string['nopermissionthemefile'] = 'You do not have permission to manage theme file';
...
$string['oauth2accessdenied'] = 'OAuth 2.0 error: You cancelled the authorisation request.';
$string['oauth2invalidclient'] = 'OAuth 2.0 error: Your authorisation failed.';
$string['oauth2invalidgrant'] = 'OAuth 2.0 error: Either the authorisation code or your password is incorrect, or it has expired.';
$string['oauth2invalidrequest'] = 'OAuth 2.0 error: The request is missing a parameter.';
$string['oauth2invalidscope'] = 'OAuth 2.0 error: The requested scope is incorrect or unknown. Please speak to your site administrator.';
$string['oauth2servererror'] = 'OAuth 2.0 error: Something went wrong on our end. Please try again later.';
$string['oauth2temporarilyunavailable'] = 'OAuth 2.0 error: The server is currently overloaded or under maintenance. Please try again later.';
$string['oauth2unauthorizedclient'] = 'OAuth 2.0 error: Your account is not authorised to perform this action.';
$string['oauth2unknownerror'] = 'OAuth 2.0 error: An unknown error occurred.';
$string['oauth2unsupportedgranttype'] = 'OAuth 2.0 error: The requested authentication method is not supported.';
$string['oauth2unsupportedresponsetype'] = 'OAuth 2.0 error: The authorisation method you are using is not supported.';
...
$string['sessionerroruser_heading'] = 'Session Expired';
...
$string['sessionstarterr'] = 'Could not start session. If you have other active requests wait for them to finish before trying again.';
