...
$string['already_loggedin'] = 'You are already signed in. Do you want to sign out and sign in as a different user?';
...
$string['apiuserdescription'] = 'Role intended for service accounts accessing the API.';
...
$string['categories_per_depth_summary'] = 'The number of categories per each depth of the category hierarchy.';
...
$string['categorymanagement'] = 'Category management';
...
$string['cipher_add_encryption_key'] = 'Add encryption key';
$string['cipher_add_encryption_key_failed'] = 'Failed adding the encryption key';
$string['cipher_add_encryption_key_queued'] = 'Queued adhoc tasks to update existing models.';
$string['cipher_add_encryption_key_success'] = 'Encryption key added';
$string['cipher_add_encryption_key_update'] = 'Run \'{$a}\' to handle updating existing records in bulk.';
$string['cipher_key_added'] = 'Encryption key added';
$string['cipher_key_added_description'] = 'A new encryption key was added';
$string['cipher_key_rollover_confirm'] = 'Are you sure you want to update these records?';
$string['cipher_key_rollover_model_queued'] = '{$a} queued';
$string['cipher_key_rollover_model_skipped'] = '{$a} skipped (no records)';
$string['cipher_key_rollover_queued'] = 'Encryption rollover job queued';
$string['cipher_key_rollover_queued_description'] = 'A job to update old encrypted records has been queued';
$string['cipher_key_rollover_skipped'] = '{$a}: skipped (no records)';
$string['cipher_key_rollover_title'] = 'Update out-of-date encrypted records';
$string['cipher_key_rollover_updating_records'] = 'Updating records';
...
$string['closebuttonerrorbanner'] = 'Dismiss error banner';
$string['closebuttoninfobanner'] = 'Dismiss info banner';
$string['closebuttonsuccessbanner'] = 'Dismiss success banner';
$string['closebuttontitle'] = 'Close';
$string['closebuttonwarningbanner'] = 'Dismiss warning banner';
...
$string['completecoursex'] = 'Complete course {$a}?';
...
$string['continue_mfa'] = 'Continue MFA';
...
$string['course_count_of_configuration_summary'] = 'A list of course settings, and for each a count of how many courses have used that setting.';
...
$string['courses_created_per_month_summary'] = 'A count of the number of courses created per month for the past 12 months.';
...
When set to “Show”, you can also exclude the course from the catalogue.';
...
$string['cronlocktimeout'] = 'A blocking task is preventing any other tasks from executing';
...
$string['day'] = 'day';
$string['days'] = 'days';
$string['db_row_counts_summary'] = 'A count of the number of records in each database table.';
...
$string['deletecoursea'] = 'Delete course {$a}';
...
$string['editor_order_summary'] = 'The preferred order of editors.';
...
$string['emaildisplaycourse'] = 'Show my email address only to participants in my courses';
$string['emaildisplayhidden'] = 'Email hidden';
$string['emaildisplayno'] = 'Hide my email address by default';
$string['emaildisplayyes'] = 'Show my email address by default';
...
$string['enable_course_category_pagination'] = 'Enable course category pagination';
$string['enable_course_category_pagination_help'] = 'Enable course category pagination, the default page size is 20. This will be enforced in Totara 20.';
$string['enable_totara_dashboard_report'] = 'Manage dashboards with enhanced controls';
$string['enable_totara_dashboard_report_help'] = 'Easier dashboard management with search, filtering, and enhanced ordering controls.';
...
$string['environment_summary'] = 'Details about the environment the Totara site is being run in, and the settings that impact how Totara runs in the environment.';
$string['error'] = 'Error';
...
$string['eventusertenantmembershipchanged'] = 'Tenant membership changed';
...
$string['forgotpasswordtitle'] = "Find your account";
$string['forgotten'] = 'Forgot username or password?';
...
* **Pathway format**: Learners work through a series of activities and resources, each displayed one at a time.
...
$string['has_pending_mfa_session'] = "There's a pending session that requires multi-factor authentication. Do you want to complete this MFA or sign in as a different user?";
$string['help'] = 'Help';
...
$string['hidecourse'] = 'Hide course {$a}';
$string['hidecategory'] = 'Hide category {$a}';
...
$string['installed_languages_summary'] = 'A list of installed languages on the site';
$string['institution'] = 'Institution';
$string['instudentview'] = 'in learner view';
$string['intelliboardapiuser'] = 'IntelliBoard API User';
$string['intelliboardapiuserdescription'] = 'Role intended for IntelliBoard integration.';
...
$string['jump'] = 'Jump';
$string['jump_to_section'] = 'Jump to section';
...
$string['logged_in_as'] = 'Logged in as {$a}';
$string['loggedinasguest'] = 'You are using a guest account';
...
$string['modules_count_summary'] = 'A list of course activity types, and for each a count of many any times each has been used.';
$string['modules_created_per_month_summary'] = 'A count of how many of each type of course activity have been created per month for the past 12 months.';
...
$string['movecoursedown'] = 'Move course {$a} down';
$string['movecoursemodule'] = 'Move resource';
$string['movecourseup'] = 'Move course {$a} up';
...
$string['no'] = 'No';
$string['no_account_options_create'] = '<CreateLink>Create an account</CreateLink>';
$string['no_account_options_create_or_guest'] = '<CreateLink>Create an account</CreateLink> or <GuestLink>continue as a guest</GuestLink>';
$string['no_account_options_guest'] = '<GuestLink>Continue as a guest</GuestLink>';
$string['noblockstoaddhere'] = 'There are no blocks that you can add to this page.';
$string['nobody'] = 'Nobody';
$string['nocategoriesyet'] = 'No categories here';
...
$string['noupgradekeywarning'] = 'Please add upgradekey to config.php file for upgrading the site.';
...
$string['plugin_usage_summary'] = 'A list of plugins by type, and for each the version that is installed.';
...
$string['removeforcepasswordchange'] = 'Remove force password change flag';
$string['removeforcepasswordchangecheckfull'] = 'Are you absolutely sure you want to remove the force a password change flag for {$a} ?';
...
$string['resourcedisplaylink'] = 'Display link';
...
$string['saveandgoback'] = 'Save and go back';
...
$string['session_handling_summary'] = 'Details on how sessions are configured for this site.';
...
$string['settings_feature_summary'] = 'A list of features and feature settings within Totara, and whether they are configured.';
...
$string['showingacategories'] = 'Showing all {$a} categories';
$string['showingacourses'] = 'Showing all {$a} courses';
$string['showingxofycategories'] = 'Showing categories {$a->start} to {$a->end} of {$a->total} categories';
...
$string['sign_in_as_another_user'] = 'Sign in as different user';
...
$string['site'] = 'Site';
$string['site_summary'] = 'Information about the site. This includes the siteidentifier and registration code used to identify the site for support.';
...
$string['trouble_signing_in'] = 'Trouble signing in?';
...
$string['upgrade_log_summary'] = 'Information on when Totara Core was last upgraded, limited to the last 30 records.';
...
$string['userdataitem-user-otherfields_help'] = 'Includes: Skype, phone, mobile phone, institution, department, address, city, country, URL, description.';
...
$string['usernamelowercase'] = 'Only lowercase letters allowed in username';
 ...
 * Totara Strings
 */
$string['approvalworkflowapprover'] = 'Workflow Approver';
$string['approvalworkflowapproverdescription'] = 'User who is able to approve an application in a workflow';
$string['approvalworkflowmanager'] = 'Workflow Manager';
$string['approvalworkflowmanagerdescription'] = 'User who is able to manage any application for the workflow';
...
$string['performanceactivitycreator'] = 'Performance Activity Creator';
$string['performanceactivitycreatordescription'] = 'User who is able to create new performance activities';
$string['performanceactivitymanager'] = 'Performance Activity Manager';
$string['performanceactivitymanagerdescription'] = 'User who is able to manage performance activities';
...
$string['userx'] = 'User {$a}';
$string['version_summary'] = 'Details of the Totara version that is being used by this site.';
 ...
 */
$string['notification_activity_completed_disabled_activity_warning'] = 'Completion tracking is disabled. To enable completion tracking go to {$a} administration: Edit settings.';
$string['notification_activity_completed_disabled_course_warning'] = 'Course completion tracking is disabled. To enable completion tracking go to Course administration: Edit settings.';
$string['notification_activity_completed_title'] = 'Learner completed activity';
$string['notification_course_completed_disabled_warning'] = 'Completion tracking is disabled. To enable completion tracking go to Course administration: Edit settings.';
$string['notification_course_completed_title'] = 'Learner completed course';
$string['notification_course_completion_placeholder_group'] = 'Course completion {$a}';
$string['notification_course_due_date_resolver_title'] = 'Course due date';
$string['notification_course_due_disabled_completion_warning'] = 'Completion tracking is disabled. To enable completion tracking go to Course administration: Edit settings.';
$string['notification_course_due_disabled_due_date_warning'] = 'Due date is disabled. To enable due date go to Course administration: Edit settings.';
$string['notification_course_enrolment_placeholder_group'] = 'Enrolment {$a}';
$string['notification_course_placeholder_group'] = 'Course {$a}';
$string['notification_course_unenrolment_title'] = 'Learner unenrolled from course';
$string['notification_group_course_activity'] = 'Course activities';
$string['notification_log_activity_completed'] = '{$a->resolver_title}: Learner "{$a->user}", activity "{$a->activity}", course "{$a->course}"';
$string['notification_log_course_completed'] = '{$a->resolver_title}: Learner "{$a->user}", course "{$a->course}"';
$string['notification_log_course_due_date'] = '{$a->resolver_title}: Learner "{$a->user}", course "{$a->course}"';
$string['notification_log_course_unenrolment'] = '{$a->resolver_title}: Learner "{$a->user}", course "{$a->course}"';
$string['notification_log_user_enrolled'] = '{$a->resolver_title}: Learner "{$a->user}", course "{$a->course}"';
$string['notification_user_enrolled_resolver_title'] = 'Learner enrolled in course';
$string['placeholder_activity_name'] = 'Name';
$string['placeholder_activity_name_linked'] = 'Name (with link)';
$string['placeholder_activity_type'] = 'Type';
$string['placeholder_course_enrolment_date'] = 'Date';
$string['placeholder_course_fullname'] = 'Full name';
$string['placeholder_course_fullname_linked'] = 'Full name (with link)';
$string['placeholder_group_course'] = 'Course {$a}';
$string['placeholder_group_course_module'] = 'Activity {$a}';
