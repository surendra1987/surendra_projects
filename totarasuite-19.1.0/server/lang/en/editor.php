...
$string['insertemoji'] = 'Insert Emoji';
...
$string['mobile_friendly_format'] = 'Mobile-friendly format';
$string['move'] = 'Move';
$string['multi'] = 'Multi';
...
$string['view_transcript_file'] = 'View transcript {$a}';
$string['width'] = 'Width';
