...
$string['disabledwarning'] = 'All web service protocols are disabled.  The "Enable legacy web services" setting can be found in Configure features.';
...
$string['enablewsdescription'] = 'Web services must be enabled in Configure features.';
