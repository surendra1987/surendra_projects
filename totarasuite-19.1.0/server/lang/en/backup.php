...
$string['autoshortname'] = 'Use course short name in automated backup filename';
$string['autoshortnamehelp'] = 'Use the course short name as part of the automated backup filename.';
...
$string['backupformatmoodle2'] = 'Totara';
...
$string['choosefilefromuserbackup_help'] = 'Backup files with anonymised user information are stored here.';
...
$string['erroruntrustedrestore'] = 'Only trusted backups can be restored.';
...
$string['restoreprogress'] = 'Restore progress';
...
$string['rootsettinghvplibraries'] = 'Include H5P libraries';
