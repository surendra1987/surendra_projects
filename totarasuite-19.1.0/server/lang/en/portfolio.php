...
$string['enableddesc'] = 'Enable users to export content such as forum posts and assignment submissions, to external portfolios or HTML pages.';
...
$string['format_mbkp'] = 'Totara backup format';
...
$string['leap2a_feedtitle'] = 'Leap2A export from Totara for {$a}';
