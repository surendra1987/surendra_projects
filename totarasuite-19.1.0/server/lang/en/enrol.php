...
$string['application:complete_request'] = 'Complete request';
$string['application:create_application'] = 'Create new application';
$string['application:view_application'] = 'View application';
...
$string['editenrolmentfor'] = 'Edit enrolment for {$a}';
$string['enrol'] = 'Enrol';
$string['enrol_user'] = 'Enrol {$a}';
...
$string['enrolment_count_per_type_summary'] = 'A list of enrolment types, and for each a count enrolments of that type.';
$string['enrolment_created_per_month_summary'] = 'Returns the number of course enrolments created per month, for the past 12 months.';
$string['enrolment_request'] = 'Enrolment request';
...
$string['foundxcohorts'] = 'Found {$a} audiences';
...
$string['noguestaccess'] = 'Guests cannot access this course.';
$string['none'] = 'None';
...
$string['pre_user_enrolment_bulk_deleted'] = 'User enrolments are about to be deleted in bulk';
$string['pre_user_enrolment_deleted'] = 'User enrolment is about to be deleted';
...
$string['select_job_assignment'] = 'Select a job assigment';
$string['select_job_assignment_help'] = 'Select the job assignment that relates to this enrolment. This might impact who can approve the request.';
...
$string['user_enrolment_application_approved'] = 'User enrolment application approved';
$string['user_enrolment_application_created'] = 'User enrolment application created';
$string['usersearch'] = 'Search ';
$string['withselectedusers'] = 'With selected users';
$string['yourapplication'] = 'your application';
$string['yourapplicationin'] = '<b>Application is in</b>: {$a}';
$string['yourapplicationpending'] = 'This enrolment is pending approval of {$a}.';
$string['yourapplicationstatus'] = '<b>Status</b>: {$a}';
