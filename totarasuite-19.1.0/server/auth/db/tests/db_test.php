...
class auth_db_db_test extends \core_phpunit\testcase {
    ...
    protected function init_auth_database() {
        ...
        switch ($DB->get_dbfamily()) {
            ...
            case 'oracle':
                set_config('type', 'oci8', 'auth_db');
                set_config('sybasequoting', '1', 'auth_db');
                break;

            case 'postgres':
                set_config('type', 'postgres9', 'auth_db');
    ...
    public function test_plugin() {
        ...
        // NOTE: It is strongly discouraged to create new tables in \core_phpunit\testcase classes,
