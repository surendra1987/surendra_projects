...
class auth_approved_external_test extends \core_phpunit\testcase {
    ...
    public function test_job_assignment_by_user_names_returns() {

        $returns = \auth_approved_external::job_assignment_by_user_names_returns();
