 ...
 */
class auth_approved_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \auth_approved\userdata\preferences::class;
    }

    protected function get_preferences(): array {
        return [
            'auth_approved_passwordupdatetime' => [time(), microtime()],
        ];
    }
