...
class auth_ldap_plugin_test extends \core_phpunit\testcase {
     ...
     * @return array[]
     */
    public static function auth_ldap_provider() {
    ...
    public function test_ldap_user_loggedin_event() {
        ...
        $property = new ReflectionProperty($ldap, 'pluginconfig');

        // Set the key for the cache flag we want to set which is used by LDAP.
        set_cache_flag($property->getValue($ldap) . '/ntlmsess', sesskey(), $user->username, AUTH_NTLMTIMEOUT);
