 ...
 * Tests util class.
 */
class auth_connect_util_test extends \core_phpunit\testcase {
    ...
    public function test_get_sso_request_url() {
    ...
    public function test_update_local_user_pictures() {
        ...
        $this->assertObjectNotHasProperty('pictures', $user1);
    ...
    public function test_update_local_users_profile_fields() {
        ...
        /** @var \auth_connect\testing\generator $connectgenerator */
