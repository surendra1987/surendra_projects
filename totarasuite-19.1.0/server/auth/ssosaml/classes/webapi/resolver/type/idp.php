...
use auth_ssosaml\webapi\formatter\idp_formatter;
use coding_exception;
use core\format;
use core\webapi\execution_context;
use core\webapi\type_resolver;

class idp extends type_resolver {
    /**
     * @param string $field
     * @param $source
     * @param array $args
    ...
    public static function resolve(string $field, $source, array $args, execution_context $ec) {
        if (!($source instanceof model)) {
            throw new coding_exception('Expected a idp model');
        }

        $formatter = new idp_formatter($source, $source->get_context());
