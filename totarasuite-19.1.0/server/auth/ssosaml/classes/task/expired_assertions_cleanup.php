 ...
 */
class expired_assertions_cleanup extends scheduled_task {

    /**
     * @inheritDoc
     */
    public function get_name() {
        return get_string('expired_assertions_cleanup_task_name', 'auth_ssosaml');
    }
    ...
    public function execute() {
        assertion_manager::cleanup_expired();
    }
}
