 ...
 *
 * @deprecated since Totara 16. Use the container_workspace_non_members query instead.
 */
class non_member_users extends query_resolver {
    /**
     * @param array $args
    ...
    public static function resolve(array $args, execution_context $ec): array {
        debugging(
            'The container_workspace_non_member_users query is deprecated; use container_workspace_non_members instead',
            DEBUG_DEVELOPER
        );
