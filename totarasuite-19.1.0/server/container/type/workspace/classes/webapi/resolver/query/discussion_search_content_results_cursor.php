 ...
 */
class discussion_search_content_results_cursor extends query_resolver {
    /**
     * @param array $args
    ...
    public static function resolve(array $args, execution_context $ec): offset_cursor_paginator {
        ...
        if (!$workspace_interactor->can_view_discussions()) {
            throw new \coding_exception("Cannot get the discussion search result cursor");
        }
        ...
        return loader::search_discussion_content($query);
    }
