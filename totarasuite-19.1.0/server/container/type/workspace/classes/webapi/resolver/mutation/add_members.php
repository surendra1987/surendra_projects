...
class add_members extends mutation_resolver {
    /**
     * @param array $args
    ...
    public static function resolve(array $args, execution_context $ec): array {
        ...
        if (user::repository()->where_in('id', $user_ids)->get()->count() !== count($user_ids)) {
            throw new moodle_exception('User ids do not exist');
        }
