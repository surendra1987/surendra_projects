...
Feature: Shared with workspace and filters
  As a user
  I want to use the filters in a workspace library
  ...
  Background:
    ...
    And the following "workspaces" exist in "container_workspace" plugin:
      | name             | summary   | owner |
      | Test Workspace 1 | Worskpace | user2 |
      | Test Workspace 2 | Worskpace | user2 |
    ...
    And the following "surveys" exist in "engage_survey" plugin:
      ...
      | Test Survey 2? | user1    | PUBLIC     | Topic2 |
    ...
    And the following is shared with workspaces:
      ...
      | engage_article  | Test Article 1  | user1  | Test Workspace 1 |
  ...
  Scenario: Filter shares by type
    ...
    Then I should see "Test Playlist 3" in the ".tui-contributionBaseContent__cards" "css_element"
    And I should not see "Test Article 1" in the ".tui-contributionBaseContent__cards" "css_element"
    And I should not see "Test Article 2" in the ".tui-contributionBaseContent__cards" "css_element"
    And I should not see "Test Article 3" in the ".tui-contributionBaseContent__cards" "css_element"
    And I should not see "Test Survey 1?" in the ".tui-contributionBaseContent__cards" "css_element"
