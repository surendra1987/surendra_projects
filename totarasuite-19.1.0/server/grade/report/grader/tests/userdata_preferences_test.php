 ...
 */
class gradereport_grader_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \gradereport_grader\userdata\preferences::class;
    }
