...
global $PAGE, $DB, $OUTPUT, $USER, $CFG;
...
$title = get_string('importxml', 'grades');
if ($data = $mform->get_data()) {
    ...
    if ($text = $mform->get_file_content('userfile')) {
        print_grade_page_head($id, 'import', 'xml', $title, false, false, true, 'importxml', 'gradeimport_xml');
        ...
        echo $OUTPUT->single_button($actionurl, get_string('importxml_link', 'gradeimport_xml'), 'get');
        echo $OUTPUT->box_end();
        echo $OUTPUT->footer();
        die;
    }
