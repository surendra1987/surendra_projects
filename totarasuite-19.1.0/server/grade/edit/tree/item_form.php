...
/// perform extra validation before submission
    function validation($data, $files) {
        ...
        if (array_key_exists('grademax', $data) && $data['grademax'] > 100000) {
            $errors['grademax'] = get_string('incorrectgrademax', 'grades');
        }
        if (array_key_exists('grademin', $data) && $data['grademin'] > 100000) {
            $errors['grademin'] = get_string('incorrectgrademin', 'grades');
        }
