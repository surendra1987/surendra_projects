...
require_once($CFG->dirroot . '/report/log/classes/table_log.php');
...
class report_log_renderable implements renderable {
    ...
    public function get_origin_options() {
        ...
        foreach (report_log_table_log::ORIGINS as $origin) {
            $ret[$origin] = get_string($origin, 'report_log');
        }
