 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_calendar_rrule_manager_test extends \core_phpunit\testcase {
    ...
    public function test_monthly_bysetpos_3_count() {
        ...
        foreach ($records as $record) {
            $this->assertContainsEquals($record->timestart, $expecteddates, $this->get_date($record->timestart) . ' is not found.');
        }
    }
