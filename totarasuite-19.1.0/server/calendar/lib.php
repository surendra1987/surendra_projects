...
/**
 * CALENDAR_EVENT_TYPE_ACTION - this is a legacy Moodle constant that must be retained for BigBlueButton plugin compatibility.
 */
...
function calendar_get_block_upcoming($events, $linkhref = NULL, $showcourselink = false) {
    ...
    for ($i = 0; $i < $lines; ++$i) {
        ...
        $content .= '<div class="event"><span class="icon c0 mr-2">'.$events[$i]->icon.'</span>';
        ...
        $content .= '<div class="date mx-1 mb-2">'.$events[$i]->time.'</div>';
