...
<template>
  <div>
    ...
    <SamplesExample>
      ...
      <Collapsible v-model:value="expanded.first" label="ABC">
      ...
      <Collapsible v-model:value="expanded.second" label="DEF">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      ...
      <Collapsible v-model:value="expanded.third" label="GHI">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Duis ut diam quam
        nulla porttitor massa id neque. Cursus risus at ultrices mi tempus
        imperdiet nulla.
    ...
    <SamplesPropCtl>
      <FormRow label="First expanded">
        <RadioGroup v-model:value="expanded.first" :horizontal="true">
          <Radio :value="true">True</Radio>
          <Radio :value="false">False</Radio>
        </RadioGroup>
      </FormRow>
      <FormRow label="Second expanded">
        <RadioGroup v-model:value="expanded.second" :horizontal="true">
          <Radio :value="true">True</Radio>
          <Radio :value="false">False</Radio>
        </RadioGroup>
      </FormRow>
      <FormRow label="Third expanded">
        <RadioGroup v-model:value="expanded.third" :horizontal="true">
          <Radio :value="true">True</Radio>
          <Radio :value="false">False</Radio>
        </RadioGroup>
      </FormRow>
      <FormRow label="Button transparent">
        <RadioGroup v-model:value="transparent" :horizontal="true">
          <Radio :value="true">True</Radio>
          <Radio :value="false">False</Radio>
        </RadioGroup>
      </FormRow>
      <FormRow label="Align to end">
        <RadioGroup v-model:value="alignEnd" :horizontal="true">
          <Radio :value="true">True</Radio>
          <Radio :value="false">False</Radio>
        </RadioGroup>
      </FormRow>
...
export default {
  ...
  :alignEnd="true"
/>
<Collapsible v-model:value="expanded.first" label="ABC">...</Collapsible>
<Collapsible v-model:value="expanded.second" label="DEF">...</Collapsible>
<Collapsible v-model:value="expanded.third" label="GHI">...</Collapsible>`,
      codeScript: `import CollapsibleGroupToggle from 'tui/components/collapsible/CollapsibleGroupToggle';
