  ...
  <div>
    ...
    <SamplesPropCtl>
      ...
      <FormRow v-slot="{ id, label }" label="Use custom confirm button text">
        <Checkbox
          :id="id"
          v-model:checked="useCustomConfirmText"
          :placeholder="label"
        />
      </FormRow>
      ...
      >
        <InputText
          :id="id"
          v-model:value="customConfirmText"
          :placeholder="label"
        />
      </FormRow>
      <FormRow v-slot="{ id, label }" label="Confirm button disabled">
        <Checkbox
          :id="id"
          v-model:checked="confirmDisabled"
          :placeholder="label"
        />
      </FormRow>
      <FormRow v-slot="{ id, label }" label="Has close button">
        <Checkbox :id="id" v-model:checked="closeButton" :placeholder="label" />
      </FormRow>
    </SamplesPropCtl>
