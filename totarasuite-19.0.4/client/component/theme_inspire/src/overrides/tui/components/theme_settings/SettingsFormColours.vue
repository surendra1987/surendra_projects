  ...
  >
    <FormRowStack spacing="large">
      <FormRow
        ...
        :label="$str('formcolours_label_primary', 'theme_inspire')"
        :is-stacked="true"
        :aria-describedby="
      ...
      <FormRow
        ...
        :label="$str('formcolours_label_useoverrides', 'theme_inspire')"
        :is-stacked="true"
        :aria-describedby="$id('formcolours-useoverrides-details')"
      >
        <FormToggleSwitch
          :aria-label="$str('formcolours_label_useoverrides', 'theme_inspire')"
      ...
      <FormFieldset v-if="colourOverridesEnabled">
        <FormRowStack spacing="large">
          <FormRow
            ...
            :label="$str('formcolours_label_buttons', 'theme_inspire')"
            :is-stacked="true"
            :aria-describedby="
              $id('formcolours-buttons-details') +
                ' ' +
                $id('formcolours-buttons-defaults')
            "
          >
            <FormColor
              ...
              :validations="v => [v.required(), v.colorValueHex()]"
            />
            <FormRowDefaults :id="$id('formcolours-buttons-defaults')">
              {{
                theme_settings.getCSSVarDefault(
                  mergedProcessedCssVariableData,
                  'btn-accent-color'
            ...
            <FormRowDetails :id="$id('formcolours-buttons-details')">
              {{ $str('formcolours_details_buttons', 'totara_tui') }}
            </FormRowDetails>
          </FormRow>

          <FormRow
            v-if="linkColorEditable"
            :label="$str('formcolours_label_links', 'theme_inspire')"
            :is-stacked="true"
            :aria-describedby="
      ...
      <FormRowStack spacing="large">
        <FormRow
          ...
          :label="$str('formcolours_label_accent', 'theme_inspire')"
          :is-stacked="true"
          :aria-describedby="
        ...
        <FormRow
          ...
          :label="$str('formcolours_label_pagetext', 'theme_inspire')"
          :is-stacked="true"
          :aria-describedby="
        ...
        <FormRow
          ...
          :label="$str('formcolours_label_footerbg', 'theme_inspire')"
          :is-stacked="true"
          :aria-describedby="
        ...
        <FormRow
          ...
          :label="$str('formcolours_label_footertext', 'theme_inspire')"
          :is-stacked="true"
          :aria-describedby="
    ...
    return {
      initialValues: {
        ...
        formcolours_field_useoverrides: {
          value: false,
          type: 'boolean',
          selectors: ['btn-accent-color', 'link-color'],
        },
        'color-primary': {
          value: null,
