  ...
  <div class="tui-layoutThreeColumn">
    ...
    >
      <div v-if="slotProps.currentBoundaryName === 'small'">
        <Grid direction="vertical" gutter-size="var(--gap-page-columns)">
          <GridItem key="1">
            <h1 class="tui-layoutThreeColumn__heading">
      ...
      <div v-if="slotProps.currentBoundaryName === 'medium'">
        <Grid direction="horizontal" gutter-size="var(--gap-page-columns)">
