...
export default {
  ...
  computed: {
    ...
    /**
     * Text to display for "rating as"
     * @returns {string|null}
     */
    ratingAsText() {
      if (!this.roleSpecified) {
        return this.$str('rating_as_a', 'pathway_manual');
      }
      if (this.roleSpecified === 'appraiser') {
        return this.$str('rating_as_appraiser', 'pathway_manual');
      }
      if (this.roleSpecified === 'manager') {
        return this.$str('rating_as_manager', 'pathway_manual');
      }
      return null;
    },
