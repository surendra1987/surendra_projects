  ...
  <div class="tui-workspaceMembersTab">
    ...
    >
      <div class="tui-workspaceMembersTab__head">
        <SortBar v-model:sort-by="sort" :options="filter.sorts">
          <template v-slot:start>
            <h2 class="tui-workspaceMembersTab__title">
        ...
        >
          <template v-slot:item="{ item, posInSet, setSize }">
            <WorkspaceMemberCard
              ...
              :can-remove-as-owner="
                canManage && item.workspace_interactor.can_owner_be_removed
              "
              :can-set-as-owner="
                canManage && item.workspace_interactor.can_be_owner
              "
              ...
              @remove-as-owner="refetchMemberList"
              @remove-member="removeMember"
              @set-as-owner="refetchMemberList"
            />
          </template>
...
export default {
  ...
  apollo: {
    ...
    member: {
      ...
      update({ cursor, members, workspace_interactor }) {
        this.canManage = workspace_interactor.can_manage;
  ...
  methods: {
    ...
    /**
     * Ownership change, reloads the member list data
     */
    async refetchMemberList() {
