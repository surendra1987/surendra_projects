...
global $CFG;
$use_legacy_login = !empty($CFG->enable_legacy_login);
...
// $THEME->resolvefaviconcallback = 'theme_legacy_resolve_favicon';
...
$THEME->layouts = array(
    ...
    'login' => array(
        'file' => $use_legacy_login ? 'default.php' : 'auth.php',
        'regions' => array(),
        'options' => array('langmenu' => true, 'nototaramenu' => true, 'nonavbar' => true),
    ),

    'pending_login' => array(
        'file' => 'pending_login.php',
        'regions' => array(),
    ),
