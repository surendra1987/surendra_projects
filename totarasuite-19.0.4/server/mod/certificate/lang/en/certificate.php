...
* **Email Certificate**: Learners can send the certificate to themselves as an attachment.

Learners who received their certificate can follow the Certificate link from the course homepage to review their certificate and its issue date.';
...
$string['printteacher_help'] = 'Use this setting if you wish to include trainer names on the certificate. Every user whose role includes the \'mod/certificate:printteacher\' capability in context of this certificate (including the course, category tree and site-level) will be included automatically. If you wish to manually select the trainer names for this certificate, follow these steps:
<ul>
<li>Ensure that the <strong>mod/certificate:printteacher</strong> capability is assigned only to Editing Trainers in this course.</li>
<li>Ensure that there are no editing trainers in this course (unless you wish to add them to every certificate in the course).</li>
<li>Go to <i>Certificate administration > Locally assigned roles</i>, then add the users you wish to include as Editing Trainers.</li>
<li>Note that the <strong>mod/certificate:printteacher</strong> capability is also assigned to the Site Manager role by default. This might lead to more names printed on the certificate, unless that capability is removed from this role.</li>
</ul>';
