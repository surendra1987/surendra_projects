 ...
 */
class scormreport_interactions_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \scormreport_interactions\userdata\preferences::class;
    }
