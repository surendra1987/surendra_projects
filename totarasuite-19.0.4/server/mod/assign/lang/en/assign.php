...
$string['gradetopassmustbeset'] = '\'Grade to pass\' cannot be zero as this assignment has its completion method set to require passing grade. Please set a non-zero value.';
$string['gradetopassnotset'] = 'This assignment does not have a grade to pass set so you cannot use this option. Please use the require grade setting instead.';
