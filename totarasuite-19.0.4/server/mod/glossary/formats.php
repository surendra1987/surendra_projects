...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading($strmodulename . ': ' . get_string("displayformats","glossary"));
...
<tr valign="top">
    ...
    <td>
    <select class="form-control" size="1" id="defaultmode" name="defaultmode">
<?php
    $sletter = '';
    $scat = '';
    $sauthor = '';
...
<tr valign="top">
    ...
    <td>
    <select class="form-control" size="1" id="defaulthook" name="defaulthook">
<?php
    $sall = '';
    $sspecial = '';
    $sallcategories = '';
...
<tr valign="top">
    ...
    <td>
    <select class="form-control" size="1" id="sortkey" name="sortkey">
<?php
    $sfname = '';
    $slname = '';
    $supdate = '';
...
<tr valign="top">
    ...
    <td>
    <select class="form-control" size="1" id="sortorder" name="sortorder">
<?php
    $sasc = '';
    $sdesc = '';
...
<tr valign="top">
    ...
    <td>
    <select class="form-control" size="1" id="showgroup" name="showgroup">
<?php
    $yselected = "";
    $nselected = "";
...
<tr>
    ...
    <td>
        ...
        ?>
    <select class="form-control" id="visibletabs" name="visibletabs[]" size="<?php echo $size ?>" multiple="multiple">
<?php
    $selected = "";
