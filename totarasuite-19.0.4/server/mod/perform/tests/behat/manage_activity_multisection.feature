...
Feature: Managing an activity with multiple sections
  ...
  Scenario: Manage activity - toggle multi-section states
    ...
    And I close the tui notification toast
    And I navigate to manage perform activity content page of "1" activity section
    Then I should see "At least one responding participant must be added in order to edit content elements." in the tui modal
    ...
    When I click on ".tui-dropdown" "css_element" in the "1" activity section
    And I click on "Merge all sections" "link" in the "1" activity section
    ...
    And I click on "Done" "button" in the ".tui-performActivitySection__saveButtons" "css_element"
    And I close the tui notification toast
    Then I should see "Section" in the ".tui-performActivitySection:nth-of-type(1) .tui-performActivitySection__title" "css_element"
    And I should see "(*Can view others' responses)"
    And I should not see "Subject"
    And I should not see "Manager"
    And I should not see "Appraiser"
  ...
  Scenario: Manage activity - Add section.
    ...
    # Reload page
    When I click on "Cancel" "button" in the ".tui-performActivitySection__saveButtons" "css_element" of the "2" activity section
    ...
    And I should see "Section" in the ".tui-performActivitySection:nth-of-type(1) .tui-performActivitySection__title" "css_element"
    And I should see "Section" in the ".tui-performActivitySection:nth-of-type(2) .tui-performActivitySection__title" "css_element"
    ...
    And I should see "Section" in the ".tui-performActivitySection:nth-of-type(1) .tui-performActivitySection__title" "css_element"
    And I should see "Section" in the ".tui-performActivitySection:nth-of-type(2) .tui-performActivitySection__title" "css_element"
    And I should not see "Section" in the ".tui-performActivitySection:nth-of-type(3) .tui-formInput" "css_element"
    When I click on "Add section" "button"
    ...
    And I should see "Section" in the ".tui-performActivitySection:nth-of-type(2) .tui-performActivitySection__title" "css_element"
    And I should not see "Section" in the ".tui-performActivitySection:nth-of-type(3) .tui-formInput" "css_element"
    And I should not see "Section" in the ".tui-performActivitySection:nth-of-type(4) .tui-formInput" "css_element"
  ...
  Scenario: Manage activity - Edit the title for sections
    ...
    Then "button.tui-btn.tui-btn--variant-primary[disabled]" "css_element" in the "1" activity section should exist
    And "button.tui-btn:not(.tui-btn--variant-primary)[disabled]" "css_element" in the "1" activity section should not exist
    When I set the title of activity section "1" to "The First Section!"
    Then "button.tui-btn.tui-btn--variant-primary[disabled]" "css_element" in the "1" activity section should not exist
    And "button.tui-btn:not(.tui-btn--variant-primary)[disabled]" "css_element" in the "1" activity section should not exist
