 ...
 * @group perform
 */
class mod_perform_webapi_resolver_mutation_update_track_schedule_open_dynamic_test extends mod_perform_webapi_resolver_mutation_update_track_schedule_base {
    ...
    public function test_correct_track_is_updated(): void {
        ...
        [$dynamic_source, $dynamic_source_input] = mod_perform_webapi_resolver_mutation_update_track_schedule_base::get_user_creation_date_dynamic_source();
