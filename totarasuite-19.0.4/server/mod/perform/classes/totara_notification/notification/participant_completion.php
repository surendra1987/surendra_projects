...
final class participant_completion extends built_in_notification {
    /**
     * @return string
     */
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_activity_completion_participant_body', 'mod_perform');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_activity_completion_participant_subject', 'mod_perform');
    }
