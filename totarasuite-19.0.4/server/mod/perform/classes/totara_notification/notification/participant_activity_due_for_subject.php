...
final class participant_activity_due_for_subject extends built_in_notification implements additional_criteria_notification {
    /**
     * @return string
     */
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_activity_due_subject_user_body', 'mod_perform');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_activity_due_subject_user_subject', 'mod_perform');
    }
