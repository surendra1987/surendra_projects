...
use mod_perform\formatter\activity\element as element_formatter;
 ...
 */
class element extends type_resolver {
     ...
     * @return mixed
     */
    public static function resolve(string $field, $element, array $args, execution_context $ec) {
        if (!$element instanceof element_model) {
