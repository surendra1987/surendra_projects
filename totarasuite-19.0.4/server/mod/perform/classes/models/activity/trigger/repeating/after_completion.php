 ...
 * respect to the completion time of the previous instance.
 */
final class after_completion extends trigger {
    /**
     * {@inheritDoc}
     */
    ...
    public function get_reference_timestamp(
        ...
        return $progress === complete::get_code()
            ? $assignment->last_instance_completed_at
            : null;
    }
}
