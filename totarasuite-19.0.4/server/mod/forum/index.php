            ...
            if ($forum->trackingtype == FORUM_TRACKING_OFF) {
                ...
                if (isset($untracked[$forum->id])) {
                    ...
                    $unreadlink .= '<a title="'.$strmarkallread.'" href="markposts.php?f='.
                                   $forum->id.'&amp;mark=read&amp;sesskey=' . sesskey() . '">' . $OUTPUT->flex_icon('check', array ('alt' => $strmarkallread)) . '</a></span>';
                } else {
...
if ($generalforums) {
    echo $OUTPUT->page_main_heading(get_string('generalforums', 'forum'));
    echo html_writer::table($generaltable);
}

if ($learningforums) {
    echo $OUTPUT->page_main_heading(get_string('learningforums', 'forum'));
