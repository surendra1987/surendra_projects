...
class mod_forum_lib_test extends \core_phpunit\testcase {
    ...
    public function test_forum_get_unmailed_posts($discussion, $timedposts, $postcount, $replycount) {
        ...
        $CFG->forum_enabletimedposts = $timedposts;
    ...
    public static function forum_get_unmailed_posts_provider() {
        return [
     ...
     * @return  array
     */
    public static function forum_discussion_is_locked_provider() {
        return [
