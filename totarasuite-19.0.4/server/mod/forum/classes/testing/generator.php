...
final class generator extends \core\testing\mod_generator {
    ...
    public function create_subscription($record = null) {
        ...
        if (empty($record['course'])) {
            throw new coding_exception('course must be present in \mod_forum\testing\generator::create_subscription() $record');
        }

        if (empty($record['forum'])) {
            throw new coding_exception('forum must be present in \mod_forum\testing\generator::create_subscription() $record');
        }

        if (empty($record['userid'])) {
            throw new coding_exception('userid must be present in \mod_forum\testing\generator::create_subscription() $record');
        }
    ...
    public function create_discussion_subscription($record = null) {
        ...
        if (empty($record['discussion'])) {
            throw new coding_exception('discussion must be present in \mod_forum\testing\generator::create_discussion_subscription() $record');
        }

        if (empty($record['forum'])) {
            throw new coding_exception('forum must be present in \mod_forum\testing\generator::create_discussion_subscription() $record');
        }

        if (empty($record['userid'])) {
            throw new coding_exception('userid must be present in \mod_forum\testing\generator::create_discussion_subscription() $record');
        }
    ...
    public function create_discussion($record = null) {
        ...
        if (empty($record['course'])) {
            throw new coding_exception('course must be present in \mod_forum\testing\generator::create_discussion() $record');
        }

        if (empty($record['forum'])) {
            throw new coding_exception('forum must be present in \mod_forum\testing\generator::create_discussion() $record');
        }

        if (empty($record['userid'])) {
            throw new coding_exception('userid must be present in \mod_forum\testing\generator::create_discussion() $record');
        }
    ...
    public function create_post($record = null) {
        ...
        if (empty($record['discussion'])) {
            throw new coding_exception('discussion must be present in \mod_forum\testing\generator::create_post() $record');
        }

        if (empty($record['userid'])) {
            throw new coding_exception('userid must be present in \mod_forum\testing\generator::create_post() $record');
        }
