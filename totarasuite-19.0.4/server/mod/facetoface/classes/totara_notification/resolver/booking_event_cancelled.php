...
class booking_event_cancelled extends seminar_resolver_base implements additional_criteria_resolver {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_booking_event_cancelled_title', 'mod_facetoface');
    }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_booking_event_cancelled',
