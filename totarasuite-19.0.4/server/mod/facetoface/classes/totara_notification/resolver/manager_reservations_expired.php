...
class manager_reservations_expired extends seminar_resolver_base {
    ...
    public static function get_notification_title(): string {
        return get_string('notification_manager_reservations_expired_title', 'mod_facetoface');
    }
    ...
    public function get_notification_log_display_string_key_and_params(): array {
        ...
        return [
            'key' => 'notification_log_manager_reservations_expired',
