...
use mod_facetoface\totara_notification\placeholder\cf_signup_cancellation as signup_cancellation_placeholder;
 ...
 */
class mod_facetoface_totara_notification_resolver_booking_cancelled_test extends testcase {
    ...
    protected function setUp(): void {
        ...
        signup_cancellation_placeholder::clear_instance_cache();
        ...
        $this->cf_ids['text'] = $cf_generator->create_text('facetoface_session', ['session']);
        $this->cf_ids['url'] = $cf_generator->create_url('facetoface_cancellation', ['url field name']);
                ...
                'body' => document_helper::json_encode_document(
                    document_helper::create_document_from_content_nodes([
                        ...
                        paragraph::create_json_node_with_content_nodes([
                            ...
                            placeholder::create_node_from_key_and_label('user_cancellation:cf_cancellationnote', 'CF User Signup Cancellation'),
                            placeholder::create_node_from_key_and_label('user_cancellation:cf_urlfieldname', 'CF User Signup Cancellation URL'),
                        ]),
                    ])
                ),
    ...
    public function test_resolver_booking_cancelled(bool $site_allow_legacy, bool $use_legacy): void {
        ...
        // Create the custom text field for the seminar sign-up
        ...
        // Create another custom text field for the seminar sign-up cancellation
        $cf_id = $DB->get_field(
            'facetoface_cancellation_info_field', 'id',  ['shortname' => 'cancellationnote']
        );
        $signup_id_substitute = new \stdClass();
        $signup_id_substitute->id = $signup->get_id(); // the ID field on the signup class is private, so we need to use a workaround
        /** @var \totara_customfield\testing\generator $cf_generator */
        ...
        self::assertStringContainsString('Lorem Ipsum', $message->fullmessage); // User Signup Cancellation
