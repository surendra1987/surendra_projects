...
class mod_facetoface_seminar_session_test extends \core_phpunit\testcase {
    /**
     ...
     * @return array
     */
    public static function provide_session_status_data(): array {
        $time = time();
        return [
            [
     ...
     * @return array
     */
    public static function provide_attendance_status_data(): array {
        $time = time();
        return [
            [
                ['start' => $time + 3600, 'finish' => $time + (3600 * 3)],
     ...
     * @return array
     */
    public static function data_provider_for_get_attendance_taking_status_sane_cases(): array {
