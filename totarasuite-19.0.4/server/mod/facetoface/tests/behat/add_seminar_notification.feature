...
Feature: Adding a new seminar's notification
  ...
  Scenario: I add the seminar and the notification to the course
    ...
    And I click on "Legacy notifications" "link" in the "Administration" "block"
    And I click on "Add" "button" in the "#region-main" "css_element"
    And I should not see "Details:" in the "#id_body_editoreditable" "css_element"
    ...
    Then I should see "Details:" in the "#id_body_editoreditable" "css_element"
