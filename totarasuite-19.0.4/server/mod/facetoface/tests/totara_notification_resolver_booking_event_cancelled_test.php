...
use mod_facetoface\totara_notification\resolver\booking_event_cancelled;
use mod_facetoface\totara_notification\resolver\event_cancelled;
use mod_facetoface\{seminar_session_list, signup, seminar, signup_status, totara_notification\placeholder\event as event_placeholder};
 ...
 */
class mod_facetoface_totara_notification_resolver_booking_event_cancelled_test extends testcase {
    ...
    protected function setUp(): void {
        ...
        $this->cf_ids['url'] = $cf_generator->create_url('facetoface_session', ['url field name']);
                ...
                'body' => document_helper::json_encode_document(
                    document_helper::create_document_from_content_nodes([
                        ...
                        paragraph::create_json_node_with_content_nodes([
                            ...
                            placeholder::create_node_from_key_and_label('event:cf_urlfieldname', 'CF Event URL'),
     ...
     */
    public function test_resolver_booking_event_cancelled(bool $site_allow_legacy, bool $use_legacy): void {
        global $DB;
        ...
        // Create custom URL for user signup cancellation
        ...
        self::assertEquals(
            1,
            $DB->count_records(notifiable_event_queue::TABLE, ['resolver_class_name' => booking_event_cancelled::class])
        );
        self::assertEquals(
            1,
            $DB->count_records(notifiable_event_queue::TABLE, ['resolver_class_name' => event_cancelled::class])
        );
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => booking_event_cancelled::class,
                ...
                'event_name' => get_string('notification_log_booking_event_cancelled', 'mod_facetoface', [
                    'resolver_title' => booking_event_cancelled::get_notification_title(),
