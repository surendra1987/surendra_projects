 ...
 */
class mod_facetoface_totara_notification_resolver_facilitator_sessions_details_changed_test extends testcase {
    ...
    protected function setUp(): void {
        ...
        $this->system_custom_preference = $notification_generator->create_notification_preference(
            facilitator_sessions_details_changed::class,
     ...
     */
    public function test_resolver_with_time_change(bool $site_allow_legacy, bool $use_legacy): void {
        global $DB;
        ...
        $dates = [
            (object)[
                ...
                'sessiontimezone' => '99',
                'timestart' => $this->start_time,
                'timefinish' => $this->start_time + 2 * HOURSECS, // Changed
                'roomids' => [],
                'assetids' => [],
                'facilitatorids' => [$this->facilitator->get_id()],
            ],
        ];
        seminar_event_helper::merge_sessions($this->seminar_event, $dates, true);
        ...
        self::assertStringContainsString('2 hours', $message->fullmessage); // Event
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => facilitator_sessions_details_changed::class,
                ...
                'event_name' => get_string('notification_log_facilitator_sessions_details_changed', 'mod_facetoface', [
                    'resolver_title' => facilitator_sessions_details_changed::get_notification_title(),
    ...
    /**
     * Test the resolver with room changes and verify the centralised notifications.
     *
     * This function tests the resolver logic for handling room, date, and asset changes in a seminar event. It verifies that
     * the centralised notifications are triggered correctly and the expected notifications are generated and sent.
     *
     * @dataProvider data_provider_test_resolver
     * @param bool $site_allow_legacy
     * @param bool $use_legacy
     ...
     */
    public function test_resolver_with_room_change(bool $site_allow_legacy, bool $use_legacy): void {
        global $DB;
        ...
        self::assertStringContainsString('123456', $message->fullmessage); // Custom Event
        self::assertStringContainsString('Seminar 1', $message->fullmessage); // Seminar
        self::assertStringContainsString('Room 1', $message->fullmessage); // Room
        self::assertEquals($this->user->id, $message->userto->id);
    ...
    /**
     * Test the resolver with asset changes and verify the centralised notifications.
     *
     * This function tests the resolver logic for handling room, date, and asset changes in a seminar event. It verifies that
     * the centralised notifications are triggered correctly and the expected notifications are generated and sent.
     *
     ...
     * @throws dml_exception|coding_exception
     */
    public function test_resolver_with_asset_change(bool $site_allow_legacy, bool $use_legacy): void {
        global $DB;
        ...
        // Create a asset to add to a session date.
        $asset = $this->getDataGenerator()->get_plugin_generator('mod_facetoface')->add_site_wide_asset(['name' => 'Asset 1']);
    ...
    /**
     * Test the resolver with room, date, and asset changes and verify the centralised notifications.
     *
     * This function tests the resolver logic for handling room, date, and asset changes in a seminar event. It verifies that
     * the centralised notifications are triggered correctly and the expected notifications are generated and sent.
     *
     ...
     * @throws dml_exception|coding_exception
     */
    public function test_resolver_with_room_date_and_asset_change(bool $site_allow_legacy, bool $use_legacy): void {
        global $DB;
        ...
        $dates = [
            (object)[
                ...
                'sessiontimezone' => '99',
                'timestart' => $this->start_time,
                'timefinish' => $this->start_time + HOURSECS * 2, // Change the time.
                'roomids' => [$room->id], // Change the room.
                'assetids' => [$asset->id], // Change the asset.
                'facilitatorids' => [$this->facilitator->get_id()],
            ],
        ];
        ...
        self::assertStringContainsString($this->user->lastname, $message->fullmessage); // Facilitator
        self::assertStringContainsString($this->course->fullname, $message->fullmessage); // Course
        self::assertStringContainsString('2 hour', $message->fullmessage); // Event
        self::assertStringContainsString('123456', $message->fullmessage); // Custom Event
        self::assertStringContainsString('Seminar 1', $message->fullmessage); // Seminar
        self::assertEquals($this->user->id, $message->userto->id);
