 ...
 */
class mod_facetoface_totara_notification_resolver_trainer_unassigned_test extends testcase {
    ...
    public function test_resolver_trainer_unassigned(bool $site_allow_legacy, bool $use_legacy): void {
        ...
        [$course, $module] = get_course_and_cm_from_instance($this->seminar_event->get_facetoface(), 'facetoface', $this->course);
        ...
        self::verify_notification_logs(
            [
                [
                    ...
                    'event_data' => [
                        "seminar_event_id" => (int)$this->seminar_event->get_id(),
