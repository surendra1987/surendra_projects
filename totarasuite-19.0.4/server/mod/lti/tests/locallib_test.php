 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_lti_locallib_test extends \core_phpunit\testcase {
    ...
    public function test_sign_parameters() {
        $this->markTestIncomplete('See comment.');
...
-----END PUBLIC KEY-----';
    ...
    */
    public function test_empty_reponse_lti_load_cartridge(): void {
        ...
        // Totara: This was actually reproducible without Windows, see TL-39670.
        \curl::mock_response('');
