...
function xmldb_lti_upgrade($oldversion) {
    ...
    if ($oldversion < 2025012301) {

        // Define field completionpass to be added to lti.
        $table = new xmldb_table('lti');
        $field = new xmldb_field('completionpass', XMLDB_TYPE_INTEGER, '1', null, null, null, '0', 'secureicon');
        ...
        // Lti savepoint reached.
        upgrade_mod_savepoint(true, 2025012301, 'lti');
    }
