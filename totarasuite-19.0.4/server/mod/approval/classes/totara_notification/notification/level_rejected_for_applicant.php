...
use mod_approval\totara_notification\resolver\level_rejected;
use totara_notification\notification\abstraction\additional_criteria_notification;
use totara_notification\notification\built_in_notification;
use totara_notification\schedule\schedule_on_event;

final class level_rejected_for_applicant extends built_in_notification implements additional_criteria_notification {
    ...
    public static function get_title(): string {
        return get_string('notification:level_rejected_for_applicant_title', 'mod_approval');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:level_rejected_for_applicant_body', 'mod_approval');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:level_rejected_for_applicant_subject', 'mod_approval');
    }
