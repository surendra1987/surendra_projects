...
class stage_ended extends stage_base implements scheduled_event_resolver {
    ...
    public static function get_notification_available_placeholder_options(): array {
        ...
        $options[] = placeholder_option::create(
            ...
            new lang_string('notification:placeholder_group_stage_ended', 'mod_approval'),
    ...
    public static function get_notification_title(): string {
        return get_string('notification:stage_ended_resolver_title', 'mod_approval');
    }
    ...
    public function get_fixed_event_time(): int {
        return $this->event_data['time_ended'];
    }
    ...
    public static function get_scheduled_events(int $min_time, int $max_time): moodle_recordset {
        return builder::table(application_activity_entity::TABLE)
            ->select(['application_id', 'workflow_stage_id', 'timestamp AS time_ended'])
            ->where('activity_type', stage_ended_activity::get_type())
