...
class stage_withdrawn extends stage_base implements scheduled_event_resolver {
    ...
    public static function get_notification_available_placeholder_options(): array {
        ...
        $options[] = placeholder_option::create(
            ...
            new lang_string('notification:placeholder_group_stage_withdrawn', 'mod_approval'),
    ...
    public static function get_notification_title(): string {
        return get_string('notification:stage_withdrawn_resolver_title', 'mod_approval');
    }
    ...
    public function get_fixed_event_time(): int {
        return $this->event_data['time_withdrawn'];
    }
