...
/**
 * Class workflow stage interaction
 *
 * @package mod_approval\formatter\workflow
 */
class workflow_stage_interaction extends entity_model_formatter {

    protected function get_map(): array {
        return [
            'id' => null,
            'workflow_stage' => null,
            'application_code' => string_field_formatter::class,
            'conditional_transitions' => null,
