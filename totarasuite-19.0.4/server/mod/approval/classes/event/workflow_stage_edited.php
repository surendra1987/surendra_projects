...
/**
 * Event triggered when a workflow stage is edited.
 */
class workflow_stage_edited extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_stage_edited', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_stage_edited_description',
            'mod_approval',
            [
                'userid' => $this->userid,
                'stage_id' => $this->objectid,
