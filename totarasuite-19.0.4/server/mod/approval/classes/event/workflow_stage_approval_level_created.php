...
/**
 * Event triggered when an approval level is created.
 */
class workflow_stage_approval_level_created extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_stage_approval_level_created', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_stage_approval_level_created_description',
            'mod_approval',
            [
                'userid' => $this->userid,
