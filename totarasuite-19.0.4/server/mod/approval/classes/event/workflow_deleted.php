...
/**
 * Event triggered when a workflow is deleted.
 */
class workflow_deleted extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_deleted', 'mod_approval');
    }
    ...
    public function get_url(): moodle_url {
        return new moodle_url(dashboard::get_url([]));
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_deleted_description',
            'mod_approval',
            [
                'userid' => $this->userid,
