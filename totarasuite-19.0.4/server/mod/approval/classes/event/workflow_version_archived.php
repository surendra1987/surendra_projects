...
/**
 * Event triggered when a workflow version is archived.
 */
class workflow_version_archived extends base {
    ...
    public static function get_name(): string {
        return get_string('event_workflow_archived', 'mod_approval');
    }
    ...
    public function get_description(): string {
        return get_string(
            'event_workflow_archived_description',
            'mod_approval',
            [
                'userid' => $this->userid,
