 ...
 * Type 18: withdrawn.
 */
class withdrawn extends activity {
    /**
     * @param application_activity $activity
     */
    protected function __construct(application_activity $activity) {
        $this->by_user('model_application_activity_type_withdrawn_desc', $activity->user);
    }
    ...
    protected static function get_label_key(): string {
        return 'model_application_activity_type_withdrawn';
    }

    public static function trigger_event(application $application, ?int $actor_id, array $activity_info): void {
        $event = stage_withdrawn_event::create_from_application($application, $actor_id);
        $event->trigger();
        ...
        notification_helper::trigger_notification(
            ...
            [
                ...
                'time_all_approved' => $event->get_data()['timecreated'],
            ],
            $application
        );
    }
