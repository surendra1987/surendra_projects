...
/**
 * Capability map for view_in_dashboard_pending_application_user.
 */
final class view_in_dashboard_pending_application_user extends role_map_base {
    ...
    public function get_capability_name(): string {
        return 'mod/approval:view_in_dashboard_pending_application_user';
    }
