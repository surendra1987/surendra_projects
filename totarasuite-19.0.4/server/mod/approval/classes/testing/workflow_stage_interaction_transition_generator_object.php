...
/**
 * Class workflow_stage_interaction_transition_generator_object
 *
 * Provides a structured interface for passing properties to the workflow generator.
 *
 * @package mod_approval\testing
 */
final class workflow_stage_interaction_transition_generator_object {
    ...
    /**
     * Workflow_stage_interaction_transition_generator_object constructor, captures required properties.
     *
     * @param int $workflow_stage_interaction_id
     * @param string $transition
     */
    public function __construct(int $workflow_stage_interaction_id, string $transition) {
