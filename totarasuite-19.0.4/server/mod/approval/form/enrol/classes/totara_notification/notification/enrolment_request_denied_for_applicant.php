...
use approvalform_enrol\totara_notification\resolver\level_rejected;
use lang_string;
...
final class enrolment_request_denied_for_applicant extends built_in_notification implements additional_criteria_notification {

    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return level_rejected::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification:enrolment_request_denied_for_applicant_title', 'approvalform_enrol');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:enrolment_request_denied_for_applicant_body', 'approvalform_enrol');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:enrolment_request_denied_for_applicant_subject', 'approvalform_enrol');
    }
