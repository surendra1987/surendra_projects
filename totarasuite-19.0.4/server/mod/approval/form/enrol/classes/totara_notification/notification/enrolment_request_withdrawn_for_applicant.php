...
use approvalform_enrol\totara_notification\resolver\stage_withdrawn;
use lang_string;
use mod_approval\totara_notification\recipient\applicant;
use totara_notification\notification\built_in_notification;
use totara_notification\schedule\schedule_on_event;

final class enrolment_request_withdrawn_for_applicant extends built_in_notification {

    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return stage_withdrawn::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification:enrolment_request_withdrawn_for_applicant_title', 'approvalform_enrol');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification:enrolment_request_withdrawn_for_applicant_body', 'approvalform_enrol');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification:enrolment_request_withdrawn_for_applicant_subject', 'approvalform_enrol');
    }
