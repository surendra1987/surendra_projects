...
$string['autosignup_help'] = 'Use this setting in combination with the seminar direct enrolment method to automatically sign up learners to the first available event for every seminar in the course. Note that if there are multiple seminars with multiple events, learners will be signed up to each seminar (taking into consideration event booking limits, scheduling conflicts and available waitlists).

We advise using this setting in courses with a single seminar, and recommend that you inform learners before they enrol in courses with multiple seminars.';
