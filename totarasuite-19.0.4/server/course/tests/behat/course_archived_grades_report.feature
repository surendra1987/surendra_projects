...
Feature: Test viewing archived course grades in the report builder.
  ...
  Scenario: Grades are archived but can be viewed via report builder
    ...
    And I press "Edit this report"
    And I follow "Columns"
    And I set the field "newcolumns" to "Grade based on current course"
    And I press "Add"
    And I press "Save changes"
    And I follow "View This Report"
    Then "Learner Three" row "Grade based on current course" column of "report_test_course_completion_including_history_report" table should contain "57.1%"
    And "Learner Four" row "Grade based on current course" column of "report_test_course_completion_including_history_report" table should contain "85.7%"
    ...
    And "Learner Two" row "Grade based on current course" column of "report_test_course_completion_including_history_report" table should contain "28.6%"
    And "Learner Three" row "Grade based on current course" column of "report_test_course_completion_including_history_report" table should contain "57.1%"
    And "Learner Four" row "Grade based on current course" column of "report_test_course_completion_including_history_report" table should contain "85.7%"
