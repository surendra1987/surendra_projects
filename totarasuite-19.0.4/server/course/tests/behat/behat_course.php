...
class behat_course extends behat_base {
    ...
    /**
     * Goes to the create course form
     *
     * TOTARA: No longer rely on admin navigation, instead to directly to URL
     * We are testing functionality of page, not how to get there.
     *
     * @Given /^I go to the course creation form$/
     * @return void
     */
    public function i_go_to_the_course_creation_form(): void {
        \behat_hooks::set_step_readonly(false);
        ...
        // The return type of the form, we could make this an arg.
        $args['returnto'] = 'category';

        $url = new moodle_url('/course/edit.php', $args);
    ...
    public function i_edit_the_section($sectionnumber) {
        ...
        // Click on un-highlight topic link.
        $this->execute('behat_general::i_click_on_in_the',
            array($stredit, "link", "#section-" . $sectionnumber . " .section_action_menu", "css_element")
        );
    ...
    public function i_should_see_the_courses_management_page($mode) {
        ...
        $this->execute("behat_general::assert_element_contains_text",
            array("Course and category management", "#region-main h1", "css_element")
        );
    ...
    /**
     * Lower the asynchronous grading thresholds
     *
     * @Given /^I lower the async regrade thresholds$/
     */
    public function i_lower_the_async_regrade_thresholds() {
        \behat_hooks::set_step_readonly(false);
