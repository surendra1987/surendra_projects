...
// Sectionid should get priority over section number
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading($string_field_formatter->format($course->fullname), sr_only: empty($CFG->course_heading_visible));
    ...
    $modnamesplural = \container_course\course_helper::get_all_modules(true, false, true, null, $course);
