    ...
    public static function get_category_listitem_actions(\coursecat $category, bool $onlyfastactions = false) {
        ...
        if ($category->can_edit()) {
            $actions['edit'] = array(
                ...
                'icon' => \core\output\flex_icon::get_icon('t/edit', 'core', array('alt' => new \lang_string('editcategorya', 'core', $category_name))),
                'string' => new \lang_string('editcategorya', 'core', $category_name)
            );
        }
        ...
        if ($category->can_change_visibility()) {
            ...
            $actions['hide'] = array(
                ...
                'icon' => \core\output\flex_icon::get_icon('t/hide', 'core', array('alt' => new \lang_string('hidecategory', 'core', $category_name))),
                'string' => new \lang_string('hidecategory', 'core', $category_name)
            );
            $actions['show'] = array(
                'primary' => true, // Totara: primary
                'url' => new \moodle_url($baseurl, array('action' => 'showcategory')),
                'icon' => \core\output\flex_icon::get_icon('t/show', 'core', array('alt' => new \lang_string('showcategorya', 'core', $category_name))),
                'string' => new \lang_string('showcategorya', 'core', $category_name)
            );
        }
        ...
        if ($category->can_change_sortorder()) {
            $actions['moveup'] = array(
                ...
                'icon' => \core\output\flex_icon::get_icon('t/up', 'core', array('alt' => new \lang_string('movecategoryup', 'core', $category_name))),
                'string' => new \lang_string('movecategoryup', 'core', $category_name)
            );
            $actions['movedown'] = array(
                'primary' => true, // Totara: primary
                'url' => new \moodle_url($baseurl, array('action' => 'movecategorydown')),
                'icon' => \core\output\flex_icon::get_icon('t/down', 'core', array('alt' => new \lang_string('movecategorydown', 'core', $category_name))),
                'string' => new \lang_string('movecategorydown', 'core', $category_name)
            );
        }
        ...
        if (!$onlyfastactions) {
            ...
            if ($category->can_delete()) { // Totara: Changed from can_delete_full() to improve performance.
                $actions['delete'] = array(
                    ...
                    'icon' => \core\output\flex_icon::get_icon('t/delete', 'core', array('alt' => new \lang_string('deletecategory', 'core', $category_name))),
                    'string' => new \lang_string('deletecategory', 'core', $category_name)
                );
            }
        }
    ...
    public static function get_course_listitem_actions(\coursecat $category, \course_in_list $course) {
        ...
        if ($course->can_edit()) {
            $actions[] = array(
                ...
                'icon' => \core\output\flex_icon::get_icon('t/edit', 'core', array('alt' => \get_string('editcourse', 'core', $course_name))),
        ...
        if ($course->can_delete()) {
            $actions[] = array(
                ...
                'icon' => \core\output\flex_icon::get_icon('t/delete', 'core', array('alt' => \get_string('deletecoursea', 'core', $course_name))),
        ...
        if ($category->can_resort_courses()) {
            $actions[] = array(
                ...
                'icon' => \core\output\flex_icon::get_icon('t/up', 'core', array('alt' => \get_string('movecourseup', 'core', $course_name))),
                'attributes' => array('data-action' => 'moveup', 'class' => 'action-moveup')
            );
            $actions[] = array(
                'url' => new \moodle_url($baseurl, array('action' => 'movecoursedown')),
                'icon' => \core\output\flex_icon::get_icon('t/down', 'core', array('alt' => \get_string('movecoursedown', 'core', $course_name))),
