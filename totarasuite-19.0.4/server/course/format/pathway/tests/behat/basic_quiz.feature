@course @format_pathway @mod_quiz
Feature: Attempt a quiz in the pathway format
  As a student
  ...
  @javascript
  Scenario: Attempt a quiz with a single unnamed section in the pathway format
  ...
  @javascript
  Scenario: Attempt a quiz with mulitple sections in the pathway format
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
    ...
    Then I should see "Section 1" in the ".qn_buttons" "css_element"
  ...
  @javascript
  Scenario: Next and previous navigation in the pathway format
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext                |
