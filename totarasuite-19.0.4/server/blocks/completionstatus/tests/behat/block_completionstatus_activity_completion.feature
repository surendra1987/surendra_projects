...
Feature: Enable Block Completion in a course using activity completion
  ...
  Scenario: Add the block to a course and check the block correctly shows the user not yet started
    ...
    And I should see "Complete all course activities: 0 of 1" in the "Course completion status" "block"
    And I should see "NO" in the "Complete all course activities: 0 of 1" "table_row"
  ...
  Scenario: Add the block to a the course and check the block correctly shows the user complete
    ...
    And I should see "Complete all course activities: 1 of 1" in the "Course completion status" "block"
    And I should see "YES" in the "Complete all course activities: 1 of 1" "table_row"
