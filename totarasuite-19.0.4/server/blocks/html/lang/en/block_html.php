...
$string['html:myaddinstance'] = 'Add a new HTML block to My learning';
...
$string['userdataitemhtml_help'] = 'This only affects HTML blocks created within a user’s personal dashboards.';
