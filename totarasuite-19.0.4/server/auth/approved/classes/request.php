...
final class request {
    ...
    public static function encode_signup_form_data(\stdClass $data) {
        ...
        if (property_exists($data, 'positionfreetext') && !is_null($data->positionfreetext)) {
        ...
        if (property_exists($data, 'organisationfreetext') && !is_null($data->organisationfreetext)) {
        ...
        if (property_exists($data, 'managerfreetext') && !is_null($data->managerfreetext)) {
