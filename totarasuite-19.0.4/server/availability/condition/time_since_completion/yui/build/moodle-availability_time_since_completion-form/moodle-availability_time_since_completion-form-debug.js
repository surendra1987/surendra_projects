YUI.add('moodle-availability_time_since_completion-form', function (Y, NAME) {
...
M.availability_time_since_completion.form.getNode = function(json) {
    ...
    html += '<span class="col-form-label pr-3"> ' + M.util.get_string('aftercompletion', 'availability_time_since_completion') + ' </span>';
