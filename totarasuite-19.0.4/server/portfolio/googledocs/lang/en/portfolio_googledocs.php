...
$string['noauthtoken'] = 'An authentication token has not been received from Google. Please ensure you are allowing Totara to access your Google account';
...
$string['oauthinfonohelplink'] = '<p>To use this plugin, you must register your site with Google, as described in the documentation.</p><p>As part of the registration process, you will need to enter the following URL as \'Authorized Redirect URIs\':</p><p>{$a->callbackurl}</p><p>Once registered, you will be provided with a client ID and secret which can be used to configure all Google Drive and Picasa plugins.</p>';
