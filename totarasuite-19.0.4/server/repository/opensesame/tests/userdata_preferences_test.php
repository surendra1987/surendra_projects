 ...
 */
class repository_opensesame_userdata_preferences_test extends core_user_userdata_plugin_preferences_testcase {

    protected function get_preferences_class(): string {
        return \repository_opensesame\userdata\preferences::class;
    }

    protected function get_preferences(): array {
        return [
            'opensesameconfirmbrowse' => ['abc123', '123abc'],
        ];
    }
