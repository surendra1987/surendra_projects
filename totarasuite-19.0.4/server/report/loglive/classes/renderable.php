...
class report_loglive_renderable implements renderable {
     ...
     *
     * This function is copied from server/report/log/classes/renderable.php
     *
     * @return int selected group.
     */
    public function get_selected_group(): int {
        global $SESSION, $USER;
        ...
        if ($selectedgroup === -1) {
            if (isset($SESSION->currentgroup[$this->course->id])) {
                ...
                if (is_array($selectedgroup) && !empty($selectedgroup)) {
