...
if (empty($readers)) {
    echo $output->header();
    echo $output->page_main_heading(get_string('nologreaderenabled', 'report_log'));
} else {
    if (!empty($chooselog)) {
        ...
        if (empty($logformat)) {
            echo $output->header();
            echo $output->page_main_heading(get_string('logs', 'core'));
        ...
        echo $output->header();
        echo $output->page_main_heading(get_string('chooselogs') .':');
        echo $output->render($reportlog);
    }
}
