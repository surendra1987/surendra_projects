...
if (empty($classname)) {
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading(get_string('message_handlers', 'tool_messageinbound'));
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->heading(get_string('editinghandler', 'tool_messageinbound', $handler->name), 1);
