...
$string['authconfirm'] = 'This action will grant permanent API access to Totara for the authenticated account. This is intended to be used as a system account for managing files owned by Totara.';
...
$string['createnewmicrosoftsmtpissuer'] = 'Create new Microsoft SMTP service';
...
$string['editsystemaccount'] = 'Edit system account: {$a}';
...
$string['issueralloweddomains_link'] = 'OAuth2';
...
$string['issuername_microsoft'] = 'Name';
$string['issuername_microsoft_help'] = 'Name of the identity issuer. This will be displayed on the log in page unless the default Microsoft branding is enabled.';
$string['issuerrequireconfirmation'] = 'Require email verification';
$string['issuerrequireconfirmation_help'] = 'Require that all users verify their email address before they can log in with OAuth. This applies to newly created accounts as part of the login process, or when an existing Totara account is connected to an OAuth login via matching email addresses.';
...
$string['no_mapping_for_internal_field_identification_warning'] = 'No mapping for internal field "{$a}" was provided. Totara may not be able to reliably identify external users.';
...
$string['oauth2systemaccount'] = 'OAuth 2 system account details';
$string['pluginname'] = 'OAuth 2 services';
$string['savechanges'] = 'Save changes';
$string['serviceshelp'] = 'Service provider setup instructions.';
$string['setsystemaccount'] = 'There was no matching account information found for this account. You may try again or label your account here.';
$string['show_default_branding_microsoft'] = 'Show default Microsoft branding';
$string['show_default_branding_microsoft_help'] = 'Default Microsoft branding is in accordance with Microsoft\'s design guidelines. It is recommended that this setting is enabled.';
...
$string['systemaccountemail'] = 'System account email';
$string['systemaccountname'] = 'System account name';
...
$string['userfieldinternalfield_help'] = 'Name of the Totara user field that should be mapped from the external field.';
