...
$linkinfo = @linkinfo(__DIR__.'/xhprof_html');
if (!($linkinfo > 0)) {
    echo $OUTPUT->notification(
        get_string('errorsymlink', 'tool_profiling').
        '<br><br>ln -s '.$CFG->libraries.'/required/totara/xhprof/xhprof_html '.__DIR__.'/xhprof_html',
        'notifyproblem'
    );
}
