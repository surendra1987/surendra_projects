 ...
 */
class tool_totara_sync_elements_test extends \core_phpunit\testcase {
    ...
    public function test_user_sync() {
        ...
        foreach (array(1, 0) as $sourceallrecords) {
            ...
            $mockbuilder->onlyMethods(array('get_source', 'get_source_sync_table', 'get_source_sync_table_clone'));
