 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_usertours_step_test extends \core_phpunit\testcase {
     ...
     * @return array
     */
    public static function step_sortorder_provider() {
        return [
                [0, 5, true, false],
                [1, 5, false, false],
                [4, 5, false, true],
     ...
     */
    public static function set_config_provider() {
        $allvalues = (object) [
                'some' => 'value',
                'another' => 42,
                'key' => [
     ...
     * @return array
     */
    public static function get_string_from_input_provider() {
        return [
            'Text'  => [
                'example',
                'example',
