 ...
 */
class tool_monitor_eventobservers_test extends \core_phpunit\testcase {
    /**
     * Set up method.
     */
...
* {eventname}';
        ...
        $this->assertStringContainsString('<h2>'.$event->get_url()->out().'</h2>', $msg->fullmessagehtml);
        $this->assertStringContainsString('<li>'.$modurl->out().'</li>', $msg->fullmessagehtml);
