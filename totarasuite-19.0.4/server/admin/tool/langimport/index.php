...
echo $OUTPUT->header();
echo $OUTPUT->page_main_heading(get_string('langimport', 'tool_langimport'));
...
if ($availablelangs = $controller->availablelangs) {
    ...
    $a = [
        'totaraversion' => totara_major_version(),
        'langdir' => $CFG->dataroot.'/lang/',
    ];
    $errormessage = get_string('remotetotaralangnotavailable', 'totara_core', $a);
