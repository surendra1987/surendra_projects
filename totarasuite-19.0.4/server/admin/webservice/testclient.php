...
if (!$function or !$protocol) {
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->heading(get_string('testclient', 'webservice'), 1);
...
if ($mform->is_cancelled()) {
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->page_main_heading(get_string('pluginname', 'webservice_'.$protocol).': '.$function);
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->heading(get_string('pluginname', 'webservice_'.$protocol).': '.$function, 1);
    $mform->display();
    echo $OUTPUT->footer();
    die;
}
