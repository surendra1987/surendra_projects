...
if (has_capability('moodle/user:create', context_system::instance())) {
    ...
    $create_user_button = $OUTPUT->single_button($url, get_string('createuser'), 'get');
}

echo $OUTPUT->page_main_heading(get_string('manageusers', 'totara_reportbuilder'), $create_user_button);
