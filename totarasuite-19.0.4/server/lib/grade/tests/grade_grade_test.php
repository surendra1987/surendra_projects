...
class core_grade_grade_grade_test extends grade_base_testcase {
    ...
    */
    ...
    public function sub_test_grade_grade_deleted_event() {
        ...
        $this->assertDebuggingCalledCount(2, ["Missing grade item id $gi->id", "Missing grade item id $gi->id"]);
        $events = $sink->get_events();
        $sink->close();
