    ...
    final class config {
        ...
        private static function establish_defines() {
            ...
            if (!defined('EXTERNAL_API')) {
                define('EXTERNAL_API', false);
            }

            if (!defined('TOTARA_MOBILE_ACCESS')) {
                define('TOTARA_MOBILE_ACCESS', false);
            }
        ...
        private static function validate_environment(\core_config $cfg) {
            ...
            if (version_compare(PHP_VERSION, '8.1.2') < 0) {
                $phpversion = PHP_VERSION;
                // Do NOT localise - lang strings would not work here and we CAN NOT move it to later place.
                echo "Totara 19 or later requires at least PHP 8.1.2 (currently using version $phpversion).\n";
