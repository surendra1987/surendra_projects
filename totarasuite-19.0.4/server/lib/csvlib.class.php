...
class csv_export_writer {
    ...
    /**
     * The option adds a byte-order mark at the beginning of the export file
     * which Excel versions needed to recognise it as UTF-8 encoded.
     *
     * @param bool $bom
     * @return void
     */
    public function set_bom(bool $bom): void {
        $this->addbom = $bom;
    }
