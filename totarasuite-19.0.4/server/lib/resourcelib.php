...
/** Display normal link on the page*/
define('RESOURCELIB_DISPLAY_LINK', 7);
 ...
 */
function resourcelib_get_displayoptions(array $enabled, $current = null): array {
    ...
    $options = [
        ...
        RESOURCELIB_DISPLAY_LINK     => get_string('resourcedisplaylink'),
