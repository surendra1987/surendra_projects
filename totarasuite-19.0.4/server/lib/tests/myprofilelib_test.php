 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class core_myprofilelib_test extends \core_phpunit\testcase {
    ...
    public function test_core_myprofile_navigation_preference_as_admin() {
        $this->setAdminUser();
        $iscurrentuser = false;
        // Totara: Login-as requires enrolment.
    ...
    public function test_core_myprofile_navigation_preference_without_permission() {
        ...
        $this->setUser($this->user2);
        $iscurrentuser = false;
        // Totara: Login-as requires enrolment of current and target user.
        $this->getDataGenerator()->enrol_user($this->user->id, $this->course->id);
    ...
    public function test_core_myprofile_navigation_contact_fields_as_admin() {
        ...
        // User contact fields.
        set_config("hiddenuserfields", "country,city,webpage,skypeid");
