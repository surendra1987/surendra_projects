 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_text_test extends \core_phpunit\testcase {
 ...
 =?utf-8?B?0Ywg0LLQuNC90LTQvtGD0Lci?=";
    ...
    public static function float_to_locale_independent_string_provider(): array {
        return [
    ...
    /**
     * @dataProvider float_to_locale_independent_string_provider
     */
    public function test_cast_float_to_locale_independent_string($float_value, $expected_result) {
        $casted_value = core_text::float2str($float_value);
        $this->assertEquals($expected_result, $casted_value);
    }
