...
/// Getter methods =============================================================
    ...
    /**
     * Get whether blocks have been loaded yet.
     *
     * @return bool
     */
    public function is_loaded() {
        return $this->birecordsbyregion !== null;
    }
...
/// Process actions from the URL ===============================================
    ...
    public function process_url_add() {
        ...
        if ($blocktype === '') {
            ...
            if (!$addableblocks) {
                ...
                echo $OUTPUT->container($OUTPUT->action_link($addpage->url, get_string('back')), 'mx-5 mb-3');
            } else {
                ...
                echo $OUTPUT->container($OUTPUT->action_link($addpage->url, get_string('cancel')), 'mx-5 mb-3');
            }
    ...
    public function process_url_delete() {
        ...
        if (!$confirmdelete) {
            ...
            $PAGE->set_heading($site->fullname);
            echo $OUTPUT->header();
            echo $OUTPUT->page_main_heading($strdeletecheck);
