...
Feature: Add media to Atto
  ...
  Scenario: Insert some media as a video with advanced settings
    ...
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'moodle-logo.webm')]][@controls='true'][@loop='true'][@data-autoplay='true']" "xpath_element" should exist
    When I click on "Save changes" "button"
    Then "//video[descendant::source[contains(@src, 'moodle-logo.webm')]][@loop][@autoplay]" "xpath_element" should exist
    When I click on "Edit" "link"
    Then "//video[descendant::source[contains(@src, 'moodle-logo.webm')]][@controls][@loop][@data-autoplay]" "xpath_element" should exist
