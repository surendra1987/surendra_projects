...
class backups extends check {
    ...
    public function get_name(): string {
        return get_string('check_backup', 'admin');
    }
    ...
    public function get_result(): result {
        ...
        if ($automatedbackupsenabled == \backup_cron_automated_helper::AUTO_BACKUP_ENABLED) {
            ...
            $summary = get_string('check_backup_comment_enable', 'admin');
        } else {
            $status = result::OK;
            $summary = get_string('check_backup_comment_disable', 'admin');
        }

        $details = get_string('check_backup_details', 'admin');
