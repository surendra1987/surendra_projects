...
abstract class check {
    ...
    public const CLASSIFICATION_SECURITY = 'security';

    /** Performance classification type */
    public const CLASSIFICATION_PERFORMANCE = 'performance';

    /** Status classification type */
    public const CLASSIFICATION_STATUS = 'status';
    ...
    /**
     * Returns true if the check should be included as a valid check.
     * @return bool
     */
    ...
    /**
     * Checks if the given classification is of a valid type.
     * @param string $classification
     * @return bool
     */
    public static function is_valid_classification(string $classification): bool {
        return in_array($classification, [
            self::CLASSIFICATION_SECURITY,
