...
class webcron extends check {
    ...
    public function get_name(): string {
        return get_string('check_webcron_name', 'admin');
    }
    ...
    public function get_result(): result {
        ...
        if (empty($croncli) && empty($cronremotepassword)) {
            ...
            $summary = get_string('check_webcron_warning', 'admin');
        } else {
            $status = result::OK;
            $summary = get_string('check_webcron_ok', 'admin');
        }
        $details = get_string('check_webcron_details', 'admin');
