 ...
 */
abstract class mod_generator extends component_generator {
    /**
    ...
    public function get_modulename() {
        $matches = null;
        if (!preg_match('/^mod_([a-z0-9]+)\\\\testing\\\\generator$/', get_class($this), $matches)) {
     ...
     * @see \core\testing\mod_generator::create_instance()
     *
