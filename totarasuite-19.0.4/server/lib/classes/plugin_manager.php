    ...
    public static function standard_plugins_list($type) {
        ...
        $standard_plugins = array(
            ...
            'block' => array(
                ...
                'course_search',
                'admin_subnav', 'admin_related_pages', 'course_navigation', 'totara_catalog'
            ),
            ...
            // Totara
            'container' => array(
                'course', 'site', 'perform', 'workspace', 'approval'
            ),
            ...
            'theme' => array(
                'base'
                // Totara:
                , 'legacy', 'ventura', 'msteams', 'inspire'
            ),
            ...
            'tool' => array(
                ...
                // Totara:
                'totara_sync', 'totara_timezonefix', 'sitepolicy', 'smtp_test', 'usagedata', 'diagnostic',
            ),
            ...
            'totara' => array(
                ...
                'reportedcontent', 'topic', 'notification', 'xapi', 'oauth2', 'useraction', 'placeholder',
            ),

            'mobile' => array(
                'currentlearning', 'findlearning', 'completedlearning',
            ),
