...
class ai extends base {
    ...
    /**
     * Returns the list of features defined by the ai plugin.
     *
     * @return feature[]
     */
    public function get_supported_features(): array {
        $features = core_component::get_namespace_classes('feature', feature::class, $this->component);
    ...
    /**
     * Get an instance of the ai plugin's feature for use by an interaction
     *
     * @param string $feature_class
     * @return feature
     * @throws coding_exception
     */
    public function get_feature_for_interaction(string $feature_class, string $interaction_class_name): feature {
    ...
    /**
     * Get the configurable settings for the ai plugin
     */
