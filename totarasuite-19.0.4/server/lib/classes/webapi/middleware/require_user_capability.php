 ...
 */
class require_user_capability implements middleware {

    /** @var string */
    protected $capability;

    /**
     * require_user_capability constructor.
     *
    ...
    public function handle(payload $payload, Closure $next): result {
        ...
        require_capability($this->capability, \context_user::instance($USER->id));
