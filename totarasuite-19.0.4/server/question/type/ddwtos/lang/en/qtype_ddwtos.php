...
$string['pluginname_help'] = 'Drag and drop into text questions require the respondent to drag words or phrases into the correct gaps in the question text. [[1]], [[2]], [[3]], etc. are used as placeholders in the question text, with the correct answers specified as choice answers 1, 2, 3, etc. respectively. Choice answers may be grouped so that all answers in a particular group are coloured the same as the gaps for them in the question text. Choice answers marked as unlimited may be used in more than one gap.';
$string['pluginname_link'] = 'Question Types Quiz#QuestionTypesQuiz-Draganddropintotext';
