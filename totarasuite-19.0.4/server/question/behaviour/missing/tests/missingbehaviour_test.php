 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_missing_missingbehaviour_test extends \core_phpunit\testcase {
    ...
    public function test_render_missing() {
        ...
        $this->assertMatchesRegularExpression('/' . preg_quote($qa->get_question()->questiontext, '/') . '/', $output);
