 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_message_search_received_test extends \core_phpunit\testcase {
    ...
    public function test_message_received_indexing_contexts() {
        ...
        $this->assertEquals(['Test1', 'Test2'], core_message_search_sent_test::recordset_to_subjects($rs));
        ...
        $this->assertEquals(['Test2'], core_message_search_sent_test::recordset_to_subjects($rs));
        $rs = $searcharea->get_document_recordset(0, \context_user::instance($user2->id));
        $this->assertEquals(['Test1'], core_message_search_sent_test::recordset_to_subjects($rs));
