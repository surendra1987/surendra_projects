...
use totara_hierarchy\entity\competency_type;
...
class user_assignment extends base {
    ...
    public static function get_url(array $params = []): moodle_url {
        return new moodle_url(self::USER_ASSIGNMENT_BASE_URL, $params);
    }

    public function action() {
        $this->set_url(self::USER_ASSIGNMENT_BASE_URL, ['user_id' => $this->user->id]);
