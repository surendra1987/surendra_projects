...
$title = '\totara_competency/pathway summary testing page';

require_login();
$context = context_system::instance();
require_capability('moodle/site:config', $context);
$PAGE->set_context($context);
$PAGE->set_url('/totara/competency/tests/fixtures/pathway_summary.php');
...
$template_data = array_merge(['type' => $type, 'key' => 'tstpw', 'sortorder' => 1], $pw->export_summary_template());

// $templatename = $pw->get_definition_template();

echo $OUTPUT->render_from_template('totara_competency/pathway_summary_test', $template_data);
echo $OUTPUT->footer();
