...
Feature: Course progress display for certifications
  ...
  Scenario: Check course progress display as user
    ...
    And I should see "0%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Certify Course')]" "xpath_element"
    And I should not see "Recertify Course"

    When I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Certify Course')]" "xpath_element"
    ...
    And I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Certify Course')]" "xpath_element"
    And I should see "Recertify Course"
    And I should see "0%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Recertify Course')]" "xpath_element"
    ...
    When I click on "Launch course" "button" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Recertify Course')]" "xpath_element"
    And I click on "Complete course" "link"
    And I click on "Yes" "button"

    Then I click on "Learn" in the totara menu
    And I click on "Certifications" "link" in the "#dp-plan-content" "css_element"
    And I click on "Test Certification" "link"
    Then I should see "You are currently certified - you do not need to work on this certification"
    And I should see "Certify Course"
    And I should see "0%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Certify Course')]" "xpath_element"
    And I should not see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Certify Course')]" "xpath_element"

    And I should see "Recertify Course"
    And I should see "100%" in the "//*[@class='tui-core_course-courseCard' and contains(., 'Recertify Course')]" "xpath_element"
