 ...
 */
class totara_certification_observer_test extends reportcache_advanced_testcase {
    ...
    public function setUp(): void {
        ...
        // Assign some users.
        $program_generator->assign_to_program($this->certif1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $this->users[1]->id, null ,true);
        $program_generator->assign_to_program($this->certif1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $this->users[2]->id, null ,true);
        $program_generator->assign_to_program($this->certif1->id, assignments::ASSIGNTYPE_INDIVIDUAL, $this->users[3]->id, null ,true);
        ...
        $program_generator->assign_to_program($this->certif2->id, assignments::ASSIGNTYPE_INDIVIDUAL, $this->users[3]->id, null ,true);
        $program_generator->assign_to_program($this->certif2->id, assignments::ASSIGNTYPE_INDIVIDUAL, $this->users[4]->id, null ,true);
        $program_generator->assign_to_program($this->certif2->id, assignments::ASSIGNTYPE_INDIVIDUAL, $this->users[5]->id, null ,true);
    }
