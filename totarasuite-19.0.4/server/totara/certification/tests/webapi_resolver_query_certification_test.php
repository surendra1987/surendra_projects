 ...
 */
class totara_certification_webapi_resolver_query_certification_test extends \core_phpunit\testcase {
     ...
     * @return []
     */
    private function create_faux_certifications(): array {
    ...
    public function test_ajax_query() {
        ...
        list($users, $certifications) = $this->create_faux_certifications();
        assign_capability('totara/program:configurecontent', CAP_ALLOW,  $CFG->defaultuserroleid, context_system::instance(), true);
