...
use totara_certification\totara_notification\resolver\unassigned as unassigned_resolver;
 ...
 */
class totara_certification_totara_notification_unassigned_test extends totara_certification_totara_notification_base {
    ...
    public function test_resolver(): void {
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => unassigned_resolver::class,
                ...
                'event_name' => get_string('notification_log_unassigned_resolver', 'totara_certification', [
                    'resolver_title' => unassigned_resolver::get_notification_title(),
