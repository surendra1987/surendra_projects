...
use totara_certification\totara_notification\resolver\extension_resolved as extension_resolved_resolver;
 ...
 */
class totara_certification_totara_notification_extension_resolved_test extends totara_certification_totara_notification_base {
    ...
    public function test_resolver() {
        ...
        $preference = $notification_generator->create_notification_preference(
            extension_resolved_resolver::class,
            $event_context,
            [
                'schedule_offset' => 0,
                ...
                'body' => document_helper::json_encode_document(
                    document_helper::create_document_from_content_nodes([
                        paragraph::create_json_node_with_content_nodes([
                            ...
                            placeholder::create_node_from_key_and_label(
                                'resolver:last_name',
                                'The person that resolved this request'
                            ),
                            placeholder::create_node_from_key_and_label(
                ...
                'additional_criteria' => '{"extensionRequestTriggers":["request_denied", "request_granted"]}',
            ]
        );
        ...
        self::assertStringContainsString('Manager1 last name', $message->fullmessage); // The resolver of this request
        self::assertStringContainsString('Request Granted', $message->fullmessage); // Status of request
        ...
        self::verify_notification_logs([
            [
                'resolver_class_name' => extension_resolved_resolver::class,
                ...
                'event_name' => get_string(
                    ...
                    [
                        'resolver_title' => extension_resolved_resolver::get_notification_title(),
