...
final class extension_denied_for_subject extends built_in_notification implements additional_criteria_notification {
    ...
    public static function get_title(): string {
        return get_string(
            'notification_extension_request_denied_for_subject_title', 'totara_certification'
        );
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string(
            'notification_extension_request_denied_for_subject_body', 'totara_certification'
        );
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string(
            'notification_extension_request_denied_for_subject_subject_line', 'totara_certification'
        );
    }
    ...
    public static function get_default_additional_criteria(): string {
        return json_encode([
            'extensionRequestTriggers' => ['request_denied'],
        ]);
    }
}