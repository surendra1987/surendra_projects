...
class rb_source_certification_completion extends rb_base_source {
    ...
    public function __construct($groupid, rb_global_restriction_set $globalrestrictionset = null) {
        ...
        $this->sourcesummary = get_string('sourcesummary', 'rb_source_certification_completion');
        $this->sourcelabel = get_string('sourcelabel', 'rb_source_certification_completion');
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions[] = new rb_column_option(
            ...
            '(SELECT CASE WHEN COUNT(pua.id) >= 1 THEN 1 ELSE 0 END
               ...
               AND pua.exceptionstatus NOT IN (' . program::PROGRAM_EXCEPTION_DISMISSED . ', ' . program::PROGRAM_EXCEPTION_RAISED . '))',
            array(
