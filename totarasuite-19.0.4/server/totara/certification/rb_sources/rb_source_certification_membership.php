...
class rb_source_certification_membership extends rb_base_source {
    ...
    public function __construct($groupid, rb_global_restriction_set $globalrestrictionset = null) {
        ...
        $this->sourcesummary = get_string('sourcesummary', 'rb_source_certification_membership');
        $this->sourcelabel = get_string('sourcelabel', 'rb_source_certification_membership');
