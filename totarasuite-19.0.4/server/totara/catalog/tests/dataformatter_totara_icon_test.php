...
use totara_catalog\dataformatter\totara_icon;
...
/**
 * Class dataformatter_totara_icon_test
 *
 ...
 */
class totara_catalog_dataformatter_totara_icon_test extends \totara_catalog\dataformatter\dataformatter_test_base {
    ...
    public function test_totara_icon() {
        ...
        $df = new totara_icon('idfield', 'altfield', TOTARA_ICON_TYPE_COURSE);
