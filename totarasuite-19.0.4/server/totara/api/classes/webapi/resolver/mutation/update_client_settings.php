...
class update_client_settings extends mutation_resolver {
    ...
    public static function resolve(array $args, execution_context $ec): client_settings {
        ...
        $possible_fields = ['client_id', 'client_rate_limit', 'default_token_expiry_time', 'response_debug'];
        $fields_in_request = array_filter($possible_fields, function($field) use ($input) {
