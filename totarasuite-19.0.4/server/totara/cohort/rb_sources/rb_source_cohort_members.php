...
class rb_source_cohort_members extends rb_base_source {
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions[] = new rb_column_option(
            ...
            "CASE
            WHEN (cohort.startdate IS NULL OR cohort.startdate = 0 OR cohort.startdate < ".time().") AND (cohort.enddate IS NULL OR cohort.enddate = 0 OR cohort.enddate > ".time().") THEN 1
            WHEN cohort.startdate > ".time()." THEN 3
            WHEN cohort.enddate < ".time()." THEN 2
            END",
            array(
