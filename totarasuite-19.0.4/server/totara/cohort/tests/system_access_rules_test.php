 ...
 *
 */
class totara_cohort_system_access_rules_test extends \core_phpunit\testcase {
    private $users;
    private $cohort = null;
    private $ruleset = 0;
    ...
    public function setUp(): void {
        ...
        for ($i = 1; $i <= 8; $i++) {
            ...
            $this->users[$i] = $this->getDataGenerator()->create_user($data);
            $this->{'users'.$sufix}[] = $this->users[$i]->id;
        }
     ...
     */
    public static function data_first_login() {
        $data = array(
     ...
     */
    public static function data_last_login() {
        $data = array(
