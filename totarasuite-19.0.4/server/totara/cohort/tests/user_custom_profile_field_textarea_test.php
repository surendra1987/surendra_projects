 ...
 */
class totara_cohort_user_custom_profile_field_textarea_test extends \core_phpunit\testcase {
     ...
     */
    public static function data_textarea_isequalto() {
        $data = array(
     ...
     * Data provider for the textarea profile field rule.
     */
    public static function data_textarea_notequalto() {
        $data = array(
            array(array('potato'), 54),
            array(array('brussels sprout'), 54),
            array(array('carrot'), 54),
     ...
     * Data provider for the textarea profile field rule.
     */
    public static function data_textarea_startswith() {
        $data = array(
            array(array('pot'), 54),
            array(array('bru'), 54),
            array(array('car'), 54),
     ...
     * Data provider for the textarea profile field rule.
     */
    public static function data_textarea_endswith() {
        $data = array(
            array(array('ato'), 54),
            array(array('out'), 54),
            array(array('rot'), 54),
     ...
     * Data provider for the textarea profile field rule.
     */
    public static function data_textarea_contains() {
        $data = array(
            array(array('potato'), 54),
            array(array('brussels sprout'), 54),
            array(array('carrot'), 54),
     ...
     * Data provider for the textarea profile field rule.
     */
    public static function data_textarea_notcontains() {
        $data = array(
            array(array('potato'), 54),
            array(array('brussels sprout'), 54),
            array(array('carrot'), 54),
