 ...
 * vendor/bin/phpunit totara_cohort_program_completion_rules_test
 *
 */
class totara_cohort_program_completion_rules_test extends reportcache_advanced_testcase {
    ...
    */
     ...
     */
    public static function data_program_completion_date() {
     ...
     */
    public static function data_program_completion_assigned_duration() {
        $data = array(
     ...
     * Program completion data:
     */
    public static function data_program_completion_started_duration() {
        $data = array(
     ...
     */
    public static function data_program_completion_list() {
        $data = array(
