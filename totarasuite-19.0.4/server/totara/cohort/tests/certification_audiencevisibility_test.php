 ...
 *
 */
class totara_cohort_certification_audiencevisibility_test extends \core_phpunit\testcase {
     ...
     */
    public static function users_audience_visibility() {
        $data = array(
            array('user' => 'user1',
    ...
    protected function create_certifications_with_availability() {
        ...
        $DB->set_field('prog', 'available', program::AVAILABILITY_TO_STUDENTS, array('id' => $this->certif8->id));
