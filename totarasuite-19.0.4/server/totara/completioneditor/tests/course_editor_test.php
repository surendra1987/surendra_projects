 ...
 */
class totara_completioneditor_course_editor_test extends \core_phpunit\testcase {
    ...
    public function test_get_current_completion_from_data() {
        ...
        $course = $this->getDataGenerator()->create_course(array(
            'enablecompletion' => 1,
            'duedate_op' => \container_course\course::DUEDATEOPERATOR_RELATIVE,
            'duedateoffsetamount' => 2,
            'duedateoffsetunit' => 3,
        ));
        ...
        $expectedcompletion->duedate = null;
        ...
        $expectedcompletion->duedate = 234 + DAYSECS * 2;
