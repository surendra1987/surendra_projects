...
use core_ai\feature\generative_prompt\response as gen_prompt_response;
use core_ai\feature\request;
use core_ai\feature\response;

class sample_feature extends generative_prompt {
    public static function get_name(): string {
        return 'sample feature';
    }

    protected function call_api(request $request): response {
        return new gen_prompt_response(['this is the result']);
    }
}
