...
$string['ai_suggest_tags'] = 'Suggest Tags';
$string['ai_suggest_tags_description'] = 'Allow tags to be suggested based on content.';
$string['ai_suggested_tags'] = 'AI-suggested tags';
$string['ai_tag_footer_label'] = 'AI-retrieved tags may not support your content. Review them before adding.';
$string['ai_tags_experimental'] = 'Experimental';
$string['all'] = 'All';
...
$string['eventtagareaupdated'] = 'Tag area updated';
...
$string['generate_tags'] = 'Generate tags';
...
$string['noresultsvisibleinpage'] = 'The user profiles on this page are not visible to you';
...
$string['regenerate_tags'] = 'Regenerate tags';
...
$string['tagarea_cohort'] = 'Audiences';
