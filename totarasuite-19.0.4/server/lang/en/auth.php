...
$string['authinstructions'] = 'Use this setting to show login instructions on the login page. Note: If you enable self registration (registerauth), and leave the instructions empty, it will show default registration instructions (which can be edited via Localisation/Language customisation (Component: auth_approved; String:loginsteps)).';
...
$string['error:cannot_enable_prohibited_auth_plugin'] = 'Cannot enable the authentication plugin \'{$a->auth}\'. {$a->reason}';
...
$string['errorpasswordblank'] = 'Password may not be blank';
...
$string['guestloginbutton'] = 'Guest login';
...
$string['instructions_deprecated'] = 'Instructions (deprecated)';
...
$string['lockedoutuserinfo'] = 'Account can be unlocked by user, administrator or automatically when resetting or changing password.';
$string['loginpageredirect'] = 'Redirect login page to single sign-on provider';
$string['loginpageredirect_help'] = "When a SSO provider is selected, users will automatically be redirected to the 
selected SSO provider when accessing the login page. For this reason, users won't be able to access the login screen for 
manual accounts or guest access. If a user needs to sign in to the site directly, the parameter ?nosso=1 can be added to the address. For 
example: https://site.example.com/login/index.php?nosso=1";
$string['loginproblems'] = 'Login problems';
$string['md5'] = 'MD5 hash';
...
$string['showguestlogin'] = 'You can hide or show the guest login link on the login page.';
