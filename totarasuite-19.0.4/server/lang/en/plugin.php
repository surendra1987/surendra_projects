...
$string['error:cannot_enable_business_intelligence_plugin'] = 'Cannot enable the business intelligence plugin \'{$a->pluginname}\'. {$a->reason}';
...
$string['type_ai'] = 'Artificial intelligence';
$string['type_ai_plural'] = 'Artificial intelligence';
$string['type_antivirus'] = 'Antivirus plugin';
$string['type_antivirus_plural'] = 'Antivirus plugins';
$string['type_approvalform'] = 'Approval Workflow Form sub-plugin';
$string['type_approvalform_plural'] = 'Approval Workflow Form sub-plugins';
...
$string['type_bi_plural'] = 'Business intelligence';
...
$string['type_container_plural'] = 'Containers';
...
$string['type_jsoneditor'] = 'JSON editor plugin';
$string['type_jsoneditor_plural'] = 'JSON editor plugins';
...
$string['type_mfa'] = 'Multifactor authentication plugin';
$string['type_mfa_plural'] = 'Multi-factor authentication plugins';
$string['type_ml'] = 'Machine learning plugin';
$string['type_ml_plural'] = 'Machine learning plugins';
$string['type_mod'] = 'Activity module';
$string['type_mod_plural'] = 'Activity modules';
$string['type_perform'] = 'Perform plugin';
$string['type_perform_plural'] = 'Perform plugins';
...
$string['type_virtualmeeting'] = 'Virtual Meeting Provider';
$string['type_virtualmeeting_plural'] = 'Virtual Meeting Providers';
