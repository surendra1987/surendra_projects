...
$string['blocksettings'] = 'General block settings';
$string['bracketfirst'] = '{$a} (first)';
$string['bracketlast'] = '{$a} (last)';
$string['common_settings'] = 'Common block settings';
...
$string['cs_customclass'] = 'Custom CSS class';
$string['cs_enable_docking'] = 'Allow block docking';
$string['cs_enable_hiding'] = 'Allow block hiding';
$string['cs_override_title'] = 'Override default block title';
$string['cs_show_border'] = 'Show border';
$string['cs_show_header'] = 'Show header';
$string['cs_title'] = 'Block title';
$string['customblocksettings'] = 'Custom block settings';
...
$string['displayconfig'] = 'Block appearance';
...
$string['type_created_per_month_summary'] = 'The number of blocks created by type, per month, for the past 12 months.';
$string['type_per_contextlevel_summary'] = 'The total number of blocks created by type, per context level';
