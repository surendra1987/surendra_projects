...
class personal_goal_status_updated extends base {
    ...
    public static function get_name() {
        return get_string('event_goal_status_updated', 'perform_goal');
    }
    ...
    public function get_description() {
        $for = ($this->relateduserid && $this->relateduserid != $this->userid)
            ...
            : '';
        return "The user with id '{$this->userid}' has updated a personal goal status to '".$this->other['status']."' with id '{$this->objectid}'{$for}";
    }
}