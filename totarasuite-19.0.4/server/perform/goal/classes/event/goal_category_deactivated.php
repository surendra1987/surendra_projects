...
class goal_category_deactivated extends base {
    ...
    /**
     * Create an event when a goal_category is deactivated.
     *
    ...
    public static function get_name() {
        return get_string('event_goal_category_deactivated', 'perform_goal');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has de-activated the goal_category with id '{$this->objectid}'";
    }
}