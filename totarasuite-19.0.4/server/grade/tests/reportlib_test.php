...
require_once($CFG->dirroot.'/grade/tests/fixtures/test_grade_report.php');

/**
 * Tests grade_report, the parent class for all grade reports.
 */
class core_grades_reportlib_test extends \core_phpunit\testcase {
    ...
    public function test_blank_hidden_total_and_adjust_bounds() {
        ...
        $report = new core_grades_test_grade_report($course->id, $gpr, $coursecontext, $student);
