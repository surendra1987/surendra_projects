...
class behat_grade extends behat_base {
    ...
    public function i_set_calculation_for_grade_item_with_idnumbers($calculation, $gradeitem, TableNode $data) {
        ...
        foreach ($datahash as $gradeitem => $idnumber) {
            ...
            $inputxpath = "//input[contains(concat(' ', normalize-space(@class), ' '), ' idnumber ')][" .
                "parent::li[contains(concat(' ', normalize-space(@class), ' '), ' item ')][text()='" . $gradeitem . "']" .
                " or " .
                "parent::li[contains(concat(' ', normalize-space(@class), ' '), ' categoryitem ') or contains(concat(' ', normalize-space(@class), ' '), ' courseitem ')]" .
